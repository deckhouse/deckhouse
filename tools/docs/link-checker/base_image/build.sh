...
TOOL_NAME="html-proofer"
TOOL_VERSION="5.0.9"

REGISTRY_PATH="registry.deckhouse.io/base_images/"
WRITE_REGISTRY="registry-write.deckhouse.io/base_images/"
BASE_IMAGE="ruby:3.1-alpine@sha256:175241582d4c028aac93e07675abfb51769363e1bd5ab541900a755dabee25a5"
...
docker build --platform linux/amd64 --build-arg DISTRO=${BASE_IMAGE} --build-arg TOOL_VERSION=${TOOL_VERSION} -t ${WRITE_REGISTRY}${IMAGE_NAME_WITH_TAG} .
