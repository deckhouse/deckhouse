...
var variablesTemplate = `// Code generated by "tools/trusted_service_accounts.go" DO NOT EDIT.
package hooks
...
func walkModules(sas *[]string, workDir string) error {
...
func main() {
	...
	var sas []string
	if err := walkModules(&sas, workDir); err != nil {
		panic(err)
	}
