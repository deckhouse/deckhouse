...
var fileToSkipRe = regexp.MustCompile(`geohash.lua$|\.github/CODEOWNERS|\.gitlab/CODEOWNERS|Dockerfile$|Makefile$|/docs/documentation/|/docs/site/|bashrc$|inputrc$|modules_menu_skip$|LICENSE$|tools/docs/spelling/.+`)
