...
var skipFiles = map[string]struct{}{
	...
	// Source of Russian descriptions for autogenerated doc-ru CRD/config (openapigen).
	"modules/030-cloud-provider-dvp/pkg/api/instanceclass/v1alpha1/instanceclass.go": {},
	"modules/030-cloud-provider-dvp/pkg/api/settings/settings.go":                    {},
}
