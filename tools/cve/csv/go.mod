module github.com/deckhouse/deckhouse/tools/cve/csv

go 1.23.2

require github.com/aquasecurity/trivy v0.58.0
...
require (
	...
	github.com/aquasecurity/trivy-db v0.0.0-20241204062910-af3503b5ef4c // indirect
