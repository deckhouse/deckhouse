...
list:
-  VPA resource configuration [example](https://deckhouse.io/products/kubernetes-platform/documentation/v1/modules/110-istio/configuration.html#parameters-controlplane-resourcesmanagement) 
