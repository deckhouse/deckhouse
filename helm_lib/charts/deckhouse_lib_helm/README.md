...
### helm_lib_envs_for_proxy
 ...
 depends on [proxy settings](/deckhouse-configure-global.html#parameters-modules-proxy) 
...
### helm_lib_module_https_copy_custom_certificate
 ...
 Renders secret with [custom certificate](/deckhouse-configure-global.html#parameters-modules-https-customcertificate) 
...
list:
-  VPA resource configuration [example](/modules/istio/configuration.html#parameters-controlplane-resourcesmanagement) 
