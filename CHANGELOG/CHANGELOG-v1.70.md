...
## Features
 ...
 - **[cni-cilium]** Added `Node-to-node` encryption mode. [#12886](https://github.com/deckhouse/deckhouse/pull/12886)
 ...
 - **[dhctl]** Added using `opentofu` instead of `terraform` for `YandexCloud`. [#12688](https://github.com/deckhouse/deckhouse/pull/12688)
