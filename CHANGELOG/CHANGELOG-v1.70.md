...
## Features
 ...
 - **[cloud-provider-aws]** Increase the leader election timeouts for the components of the CSI controller. [#13339](https://github.com/deckhouse/deckhouse/pull/13339)
 - **[cloud-provider-azure]** Increase the leader election timeouts for the components of the CSI controller. [#13339](https://github.com/deckhouse/deckhouse/pull/13339)
 - **[cloud-provider-dynamix]** Increase the leader election timeouts for the components of the CSI controller. [#13339](https://github.com/deckhouse/deckhouse/pull/13339)
 - **[cloud-provider-gcp]** Increase the leader election timeouts for the components of the CSI controller. [#13339](https://github.com/deckhouse/deckhouse/pull/13339)
 - **[cloud-provider-huaweicloud]** Increase the leader election timeouts for the components of the CSI controller. [#13339](https://github.com/deckhouse/deckhouse/pull/13339)
 - **[cloud-provider-openstack]** Increase the leader election timeouts for the components of the CSI controller. [#13339](https://github.com/deckhouse/deckhouse/pull/13339)
 - **[cloud-provider-vcd]** Increase the leader election timeouts for the components of the CSI controller. [#13339](https://github.com/deckhouse/deckhouse/pull/13339)
 - **[cloud-provider-vsphere]** Increase the leader election timeouts for the components of the CSI controller. [#13339](https://github.com/deckhouse/deckhouse/pull/13339)
 - **[cloud-provider-yandex]** Increase the leader election timeouts for the components of the CSI controller. [#13339](https://github.com/deckhouse/deckhouse/pull/13339)
 - **[cloud-provider-zvirt]** Increase the leader election timeouts for the components of the CSI controller. [#13339](https://github.com/deckhouse/deckhouse/pull/13339)
 - **[control-plane-manager]** Add settings for etcd backup. [#13193](https://github.com/deckhouse/deckhouse/pull/13193)
 - **[deckhouse]** Add opentelemetry support. [#12541](https://github.com/deckhouse/deckhouse/pull/12541)
 ...
 - **[docs]** implement deckhouse logger inside docs-builder [#12835](https://github.com/deckhouse/deckhouse/pull/12835)
    low
 - **[ingress-nginx]** Added a `IngressNginxController` parameter to configure the verbosity of ingress controller logs. [#12920](https://github.com/deckhouse/deckhouse/pull/12920)
...
## Fixes
 ...
 - **[admission-policy-engine]** Increase severity of alerts for objects that violate policies [#13497](https://github.com/deckhouse/deckhouse/pull/13497)
 - **[candi]** retry logic for 401 in bootstrap script [#13426](https://github.com/deckhouse/deckhouse/pull/13426)
 - **[candi]** Use bb-d8-node-name instead HOSTNAME variable for getting current node name in bashible step for gcp. [#13405](https://github.com/deckhouse/deckhouse/pull/13405)
 - **[candi]** Replacing Terraform with OpenTofu for Dynamix [#13402](https://github.com/deckhouse/deckhouse/pull/13402)
 - **[candi]** Replacing Terraform with OpenTofu for Zvirt [#13386](https://github.com/deckhouse/deckhouse/pull/13386)
 ...
 - **[candi]** lock the node name during node bootstrap [#12996](https://github.com/deckhouse/deckhouse/pull/12996)
 - **[candi]** bashible configure-kubelet step fix [#12722](https://github.com/deckhouse/deckhouse/pull/12722)
 - **[chrony]** chrony exporter CVE vulnerabilities fixes [#13317](https://github.com/deckhouse/deckhouse/pull/13317)
 - **[cloud-provider-aws]** cloud-controller-manager continues processing routes creation without blocking, even when errors occur. [#13350](https://github.com/deckhouse/deckhouse/pull/13350)
 ...
 - **[cni-cilium]** A hook for the EgressGateway controller to clean up stale system node labels. [#12971](https://github.com/deckhouse/deckhouse/pull/12971)
 ...
 - **[descheduler]** descheduler fix go mod tidy [#13447](https://github.com/deckhouse/deckhouse/pull/13447)
 - **[descheduler]** descheduler CVE vulnerabilities fixes [#13306](https://github.com/deckhouse/deckhouse/pull/13306)
 - **[dhctl]** use --force flag to drain master nodes. [#13423](https://github.com/deckhouse/deckhouse/pull/13423)
 - **[dhctl]** dhctl CVE vulnerabilities fixes [#13308](https://github.com/deckhouse/deckhouse/pull/13308)
 ...
 - **[dhctl]** Updating the documentation for preflight checks [#12519](https://github.com/deckhouse/deckhouse/pull/12519)
 ...
 - **[node-manager]** bashible apiserver CVE vulnerabilities fixes [#13314](https://github.com/deckhouse/deckhouse/pull/13314)
 - **[node-manager]** change mcm version to use node manager token instead mcm [#13305](https://github.com/deckhouse/deckhouse/pull/13305)
 ...
 - **[registry-packages-proxy]** registry-packages-proxy CVE vulnerabilities fixes [#13307](https://github.com/deckhouse/deckhouse/pull/13307)
 - **[runtime-audit-engine]** fixed usage lib in falco [#13475](https://github.com/deckhouse/deckhouse/pull/13475)
 - **[runtime-audit-engine]** falco CVE vulnerabilities fixes [#13318](https://github.com/deckhouse/deckhouse/pull/13318)
 ...
 - **[vertical-pod-autoscaler]** vpa cve vulnerabilities fixes [#13319](https://github.com/deckhouse/deckhouse/pull/13319)

## Chore


 - **[cloud-provider-vcd]** The VCD provider outputs logs in JSON format [#13183](https://github.com/deckhouse/deckhouse/pull/13183)
 - **[cni-cilium]** fix cve [#13406](https://github.com/deckhouse/deckhouse/pull/13406)
 - **[deckhouse]** Add module version to module source. [#13128](https://github.com/deckhouse/deckhouse/pull/13128)
 - **[deckhouse]** Add module stage column. [#13113](https://github.com/deckhouse/deckhouse/pull/13113)
 - **[dhctl]** Set additionalProperties "false" for all objects in openapi [#11832](https://github.com/deckhouse/deckhouse/pull/11832)
 - **[docs]** Refined node preparation when adding nodes [#13400](https://github.com/deckhouse/deckhouse/pull/13400)
    low
