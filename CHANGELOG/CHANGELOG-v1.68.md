...
## Fixes
 ...
 - **[prometheus]** enable WAL for the grafana SQLite database to prevent locking errors, thus fixing in-dashboard alerting. [#13068](https://github.com/deckhouse/deckhouse/pull/13068)
