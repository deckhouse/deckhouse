...
## [MALFORMED]
 ...
 - #7769 missing section, missing summary, missing type, unknown section ""
 - #7809 missing section, missing summary, missing type, unknown section ""

## Know before update


 - Application traffic redirection setup method will be deligated to a special CNI plugin. Cilium agent pods will restart, and L7-based policies will flap.
 - Deckhouse update is impossible until users migrate from the `linstor` module to `sds-drbd`.
 - The `sds-drbd` module is renamed. Please switch to [sds-replicated-volume](https://deckhouse.io/modules/sds-replicated-volume/stable/faq.html#migrating-from-sds-drbd-module-to-sds-replicated-volume) module ASAP. The `sds-drbd` module cannot be enabled but will continue to work if it was already enabled before.
...
## Features
 ...
 - **[ingress-nginx]** Add the IP address and hostname to the ingress-nginx-controller status. [#7785](https://github.com/deckhouse/deckhouse/pull/7785)
 ...
 - **[prometheus]** Equal alerts with different severity are deduplicated (only lowest severity alert is displayed in the cluster). [#7809](https://github.com/deckhouse/deckhouse/pull/7809)
    `alerts-receiver` will restart.
 - **[prometheus]** Alerts queue size changed from 100 to 500. [#7809](https://github.com/deckhouse/deckhouse/pull/7809)
    `alerts-receiver` will restart.
 - **[prometheus]** Removed `DeadMansSwitch` alert and added `MissingDeadMansSwitch` alert in the case of `DeadMansSwitch` alert does not send by cluster Prometheus. [#7809](https://github.com/deckhouse/deckhouse/pull/7809)
    `alerts-receiver` will restart.
 - **[prometheus]** Added `ClusterHasTooManyAlerts` alert to indicate queue fullness. [#7809](https://github.com/deckhouse/deckhouse/pull/7809)
    `alerts-receiver` will restart.
 ...
 - **[prometheus]** Adds separate transition deployment for Grafana v10. [#7018](https://github.com/deckhouse/deckhouse/pull/7018)
 - **[registrypackages]** Add d8 (deckhouse-cli) to registry packages. [#7792](https://github.com/deckhouse/deckhouse/pull/7792)
...
## Fixes
 ...
 - **[ingress-nginx]** Improved description of NginxIngressSslWillExpire and NginxIngressSslExpired [#7830](https://github.com/deckhouse/deckhouse/pull/7830)
 ...
 - **[prometheus]** Increasing the sapmleLimit threshold to 100000. [#7858](https://github.com/deckhouse/deckhouse/pull/7858)
