...
## Fixes
 ...
 - **[node-manager]** Fixes HIGH-severity CVEs in caps-controller-manager by updating golang.org/x/net, x/crypto, x/text and x/sys dependencies. [#23174](https://github.com/deckhouse/deckhouse/pull/23174)
 ...
 - **[operator-trivy]** Update the dependencies of the operator and report-updater images to close the reported CVEs. [#23249](https://github.com/deckhouse/deckhouse/pull/23249)
 - **[operator-trivy]** report-updater reads registry credentials the way kubelet does, including a `username`/`password` pair and a key that carries a scheme or a repository path. [#23189](https://github.com/deckhouse/deckhouse/pull/23189)
...
## Chore
 ...
 - **[ingress-nginx]** Nginx version was updated to 1.30.5 [#23094](https://github.com/deckhouse/deckhouse/pull/23094)
    All ingress-nginx controller pods will be restarted.
