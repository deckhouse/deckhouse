...
require (
	...
	github.com/flant/addon-operator v1.1.5-0.20230712150510-7383c88a9a35 // commit: 871f9192e42da6e35653f4dde81ff3f99c87e9e4
	github.com/flant/kube-client v0.26.1
	github.com/flant/shell-operator v1.3.0
