...
require (
	...
	github.com/flant/addon-operator v1.1.1-0.20221213151342-bbc9b31bd2af // branch: main
	github.com/flant/kube-client v0.25.0
	github.com/flant/shell-operator v1.1.2-0.20221213151024-35d64040ff1a // branch: main
