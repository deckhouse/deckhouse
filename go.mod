...
require (
	...
	github.com/flant/addon-operator v0.0.0-20241106145641-232bd38b6736
	github.com/flant/kube-client v0.0.0-20241106144802-74dd66e8b239
	github.com/flant/shell-operator v0.0.0-20241106145337-271b421bb06f
