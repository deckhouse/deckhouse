...
| StaticClusterConfiguration     | Конфигурация статического кластера Kubernetes | [candi/openapi/static_configuration.yaml](https://github.com/deckhouse/deckhouse/blob/master/candi/openapi/init_configuration.yaml)|
