...
* **Deckhouse** modules:
  * [**control-plane-manager**](https://deckhouse.io/products/kubernetes-platform/documentation/v1/modules/040-control-plane-manager/) — `control-plane` maintaining.
  * [**node-manager**](https://deckhouse.io/products/kubernetes-platform/documentation/v1/modules/040-node-manager/) — swiss knife to create and update cloud and bare metal nodes.
