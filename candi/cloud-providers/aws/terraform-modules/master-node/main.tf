...
data "aws_security_group" "ssh-accessible-master" {
  name = "${var.prefix}-ssh-accessible-master"
}
...
resource "aws_instance" "master" {
  ...
  vpc_security_group_ids = concat([data.aws_security_group.node.id, data.aws_security_group.ssh-accessible-master.id], var.additional_security_groups)
