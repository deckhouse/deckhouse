...
output "node_ip" {
  value = var.root_disk_size == "" ? openstack_compute_instance_v2.master[0].network[1].fixed_ip_v4: openstack_compute_instance_v2.master_with_root_disk[0].network[1].fixed_ip_v4
}
