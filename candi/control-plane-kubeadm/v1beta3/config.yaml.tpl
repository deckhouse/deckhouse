...
controllerManager:
  ...
  extraArgs:
    profiling: "false"
    terminated-pod-gc-threshold: {{ if lt $.controlPlaneManager.internal.nodesCount 100 }}"1000"{{ else if lt $.controlPlaneManager.internal.nodesCount 300 }}"3000"{{ else }}"6000"{{ end }}
    feature-gates: {{ $featureGates | quote }}
