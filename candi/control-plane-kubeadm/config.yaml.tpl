...
{{- if ne .runType "ClusterBootstrap" }}
    enable-admission-plugins: "EventRateLimit,ExtendedResourceToleration,NodeRestriction,SecurityContextDeny{{ if .apiserver.admissionPlugins }},{{ .apiserver.admissionPlugins | join "," }}{{ end }}"
