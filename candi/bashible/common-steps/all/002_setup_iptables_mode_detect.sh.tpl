...
{{ end }}
  systemctl enable iptablesDetect.service
}

bb-sync-file /opt/deckhouse/bin/iptables-mode-detect.sh - d8-service-changed << "EOF"
...
chmod +x /opt/deckhouse/bin/iptables-mode-detect.sh


bb-sync-file /etc/systemd/system/iptablesDetect.service - d8-service-changed << "EOF"
[Unit]
Description=IptablesDetect at Boot
After=network.target

[Service]
Type=oneshot
ExecStart=/opt/deckhouse/bin/iptables-mode-detect.sh
