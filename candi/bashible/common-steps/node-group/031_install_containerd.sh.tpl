...
bb-package-install "containerd:{{- index $.images.registrypackages "containerd1722" }}" "crictl:{{ index .images.registrypackages.crictl1311 }}" "toml-merge:{{ .images.registrypackages.tomlMerge01 }}"
{{- end }}
