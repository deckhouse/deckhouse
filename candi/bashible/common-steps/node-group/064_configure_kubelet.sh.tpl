...
topologyManagerScope: {{ .nodeGroup.kubelet.topologyManager.scope | default "container" }}
topologyManagerPolicy: {{ .nodeGroup.kubelet.topologyManager.policy | default "none" }}
{{- end }}
EOF
