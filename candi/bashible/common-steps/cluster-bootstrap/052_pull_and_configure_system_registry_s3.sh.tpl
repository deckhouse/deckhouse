...
# Seaweedfs certs
/opt/deckhouse/bin/cfssl gencert \
  -cn="embedded-registry-seaweedfs" \
  -ca="$registry_pki_path/ca.crt" \
  -ca-key="$registry_pki_path/ca.key" \
  -config="$registry_pki_path/profiles.json" \
  -profile="client-server" "$registry_pki_path/client-server.json" | /opt/deckhouse/bin/cfssljson -bare "${registry_pki_path}/seaweedfs"
mv "${registry_pki_path}/seaweedfs.pem" "${registry_pki_path}/seaweedfs.crt"
mv "${registry_pki_path}/seaweedfs-key.pem" "${registry_pki_path}/seaweedfs.key"
