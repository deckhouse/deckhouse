...
bb-rp-install "kubernetes-cni:{{ index .images.registrypackages (printf "kubernetesCniDebian%s" $kubernetesCniVersion) | toString }}" "kubectl:{{ index .images.registrypackages (printf "kubectlDebian%s" $kubernetesVersion) | toString }}"
...
bb-rp-install "kubelet:{{ index .images.registrypackages (printf "kubeletDebian%s" $kubernetesVersion) | toString }}"
