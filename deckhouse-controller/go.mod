...
require (
	...
	github.com/flant/addon-operator v1.0.0-beta.6.0.20200528113129-c852d3e5c83e // branch: feat_observability
	github.com/flant/shell-operator v1.0.0-beta.10.0.20200526112906-2d1bb9208462 // branch: master
