...
func Register(ctx context.Context, operator *addonoperator.AddonOperator, logger *log.Logger) error {
	...
	if err != nil {
		return fmt.Errorf("register module documentation controller: %w", err)
	}
