...
func NewDeckhouseController(
	...
	err = modulerelease.RegisterController(runtimeManager, operator.ModuleManager, loader.Installer(), dc, exts, edition, embeddedPolicy, operator.MetricStorage, logger.Named("module-release-controller"))
	if err != nil {
