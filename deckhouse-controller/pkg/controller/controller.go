...
func NewDeckhouseController(
	...
	err = modulerelease.RegisterController(runtimeManager, operator.ModuleManager, dc, exts, loader, embeddedPolicy, operator.MetricStorage, logger.Named("module-release-controller"))
	if err != nil {
