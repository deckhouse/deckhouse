...
func TestLoadConversions(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			modulePath:  "/Users/kerimov/Programming/deckhouse/modules/150-user-authn",
			expectError: false,
			expectEmpty: false,
		...
		},
		{
			...
			modulePath:  "/Users/kerimov/Programming/deckhouse/modules/110-istio",
			expectError: false,
			expectEmpty: false,
		...
		},
		{
			...
			modulePath:  "/Users/kerimov/Programming/deckhouse/modules/002-deckhouse",
			expectError: false,
			expectEmpty: true,
			expectCount: 0,
		},
