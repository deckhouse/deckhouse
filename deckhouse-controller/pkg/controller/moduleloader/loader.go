...
func (l *Loader) GetModuleExclusiveGroup(moduleName string) *string {
	exclusiveGroup := l.modules[moduleName].GetModuleDefenition().ExclusiveGroup
	if exclusiveGroup == "" {
		return nil
	}
	return &l.modules[moduleName].GetModuleDefenition().ExclusiveGroup
}
