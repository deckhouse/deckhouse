...
func (r *reconciler) handle(ctx context.Context, packageVersion *v1alpha1.ClusterApplicationPackageVersion) (ctrl.Result, error) {
	...
	r.logger.Debug("handling ClusterApplicationPackageVersion", slog.String("name", packageVersion.Name))
	return ctrl.Result{}, nil
}

func (r *reconciler) delete(ctx context.Context, packageVersion *v1alpha1.ClusterApplicationPackageVersion) (ctrl.Result, error) {
	// TODO: implement cluster application package version deletion logic
	r.logger.Debug("deleting ClusterApplicationPackageVersion", slog.String("name", packageVersion.Name))
	return ctrl.Result{}, nil
}
