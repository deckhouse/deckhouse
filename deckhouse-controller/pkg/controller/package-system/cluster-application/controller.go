...
func (r *reconciler) handle(ctx context.Context, clusterApplication *v1alpha1.ClusterApplication) (ctrl.Result, error) {
	// TODO: implement cluster application reconciliation logic
	r.logger.Debug("handling ClusterApplication", slog.String("name", clusterApplication.Name))
	return ctrl.Result{}, nil
}

func (r *reconciler) delete(ctx context.Context, clusterApplication *v1alpha1.ClusterApplication) (ctrl.Result, error) {
	// TODO: implement cluster application deletion logic
	r.logger.Debug("deleting ClusterApplication", slog.String("name", clusterApplication.Name))
	return ctrl.Result{}, nil
}
