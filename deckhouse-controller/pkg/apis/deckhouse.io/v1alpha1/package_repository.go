...
// +kubebuilder:printcolumn:name=Repository,type=string,JSONPath=.spec.registry.repo
// +kubebuilder:printcolumn:name=Packages,type=integer,JSONPath=.status.packagesCount
