...
func (in *PackageRepositoryStatus) DeepCopyInto(out *PackageRepositoryStatus) {
	*out = *in
	if in.Scan != nil {
		...
		*out = new(PackageRepositoryStatusScan)
		(*in).DeepCopyInto(*out)
	}
	if in.Packages != nil {
		in, out := &in.Packages, &out.Packages
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PackageRepositoryStatusScan) DeepCopyInto(out *PackageRepositoryStatusScan) {
	*out = *in
	if in.LastTime != nil {
		in, out := &in.LastTime, &out.LastTime
		*out = (*in).DeepCopy()
	}
	if in.LastNewVersionsTime != nil {
		in, out := &in.LastNewVersionsTime, &out.LastNewVersionsTime
		*out = (*in).DeepCopy()
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PackageRepositoryStatusScan.
func (in *PackageRepositoryStatusScan) DeepCopy() *PackageRepositoryStatusScan {
	if in == nil {
		return nil
	}
	out := new(PackageRepositoryStatusScan)
