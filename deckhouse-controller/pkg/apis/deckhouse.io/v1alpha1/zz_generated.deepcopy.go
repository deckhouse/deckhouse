...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModuleUpdatePolicySpecContainer) DeepCopyInto(out *ModuleUpdatePolicySpecContainer) {
	*out = *in
	if in.spec != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModuleUpdatePolicySpecContainer.
func (in *ModuleUpdatePolicySpecContainer) DeepCopy() *ModuleUpdatePolicySpecContainer {
	if in == nil {
		return nil
	}
	out := new(ModuleUpdatePolicySpecContainer)
	in.DeepCopyInto(out)
	return out
}
