...
func (in *ApplicationPackageStatus) DeepCopyInto(out *ApplicationPackageStatus) {
	*out = *in
	if in.Instances != nil {
		...
		*out = make(map[NamespaceName][]ApplicationPackageStatusInstance, len(*in))
		for key, val := range *in {
			var outVal []ApplicationPackageStatusInstance
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
...
func (in *PackageRepositoryOperationStatusPackages) DeepCopyInto(out *PackageRepositoryOperationStatusPackages) {
	*out = *in
	...
	if in.Failed != nil {
		...
		*out = make(map[string]PackageRepositoryOperationStatusFailedPackage, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
