...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModuleReleaseMigration) DeepCopyInto(out *ModuleReleaseMigration) {
	*out = *in
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModuleReleaseMigration.
func (in *ModuleReleaseMigration) DeepCopy() *ModuleReleaseMigration {
	if in == nil {
		return nil
	}
	out := new(ModuleReleaseMigration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ModuleReleaseStatus) DeepCopyInto(out *ModuleReleaseStatus) {
	*out = *in
	...
	if in.Migrations != nil {
		...
		*out = make([]ModuleReleaseMigration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
