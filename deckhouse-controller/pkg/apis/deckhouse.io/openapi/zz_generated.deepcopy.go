...
func (in *EnumSwitchSetting) DeepCopyInto(out *EnumSwitchSetting) {
	*out = *in
	if in.To != nil {
		in, out := &in.To, &out.To
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnumSwitchSetting.
func (in *EnumSwitchSetting) DeepCopy() *EnumSwitchSetting {
	if in == nil {
		return nil
	}
	out := new(EnumSwitchSetting)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpenAPIV3Schema) DeepCopyInto(out *OpenAPIV3Schema) {
	*out = *in
	...
	if in.XUIResourceName != nil {
		in, out := &in.XUIResourceName, &out.XUIResourceName
		*out = new(UIResourceNameSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.XEnumSwitchSettings != nil {
		in, out := &in.XEnumSwitchSettings, &out.XEnumSwitchSettings
		*out = make([]EnumSwitchSetting, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UIResourceNameSelector) DeepCopyInto(out *UIResourceNameSelector) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UIResourceNameSelector.
func (in *UIResourceNameSelector) DeepCopy() *UIResourceNameSelector {
	if in == nil {
		return nil
	}
	out := new(UIResourceNameSelector)
