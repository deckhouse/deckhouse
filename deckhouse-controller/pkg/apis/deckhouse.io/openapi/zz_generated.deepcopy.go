...
func (in *OpenAPIV3Schema) DeepCopyInto(out *OpenAPIV3Schema) {
	*out = *in
	...
	if in.XUIOrder != nil {
		in, out := &in.XUIOrder, &out.XUIOrder
		*out = new(int64)
		**out = **in
	}
	if in.XUIKind != nil {
		in, out := &in.XUIKind, &out.XUIKind
		*out = new(UIKindSelector)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in SchemaDependencies) DeepCopy() SchemaDependencies {
	...
	out := new(SchemaDependencies)
	in.DeepCopyInto(out)
	return *out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UIKindAnnotationMatch) DeepCopyInto(out *UIKindAnnotationMatch) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UIKindAnnotationMatch.
func (in *UIKindAnnotationMatch) DeepCopy() *UIKindAnnotationMatch {
	if in == nil {
		return nil
	}
	out := new(UIKindAnnotationMatch)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UIKindLabelMatch) DeepCopyInto(out *UIKindLabelMatch) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UIKindLabelMatch.
func (in *UIKindLabelMatch) DeepCopy() *UIKindLabelMatch {
	if in == nil {
		return nil
	}
	out := new(UIKindLabelMatch)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UIKindSelector) DeepCopyInto(out *UIKindSelector) {
	*out = *in
	if in.MatchLabels != nil {
		in, out := &in.MatchLabels, &out.MatchLabels
		*out = make([]UIKindLabelMatch, len(*in))
		copy(*out, *in)
	}
	if in.MatchAnnotations != nil {
		in, out := &in.MatchAnnotations, &out.MatchAnnotations
		*out = make([]UIKindAnnotationMatch, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UIKindSelector.
func (in *UIKindSelector) DeepCopy() *UIKindSelector {
	if in == nil {
		return nil
	}
	out := new(UIKindSelector)
