...
type ModuleReleaseInformer interface {
	...
	Lister() deckhouseiov1alpha1.ModuleReleaseLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DeckhouseV1alpha1().ModuleReleases().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DeckhouseV1alpha1().ModuleReleases().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DeckhouseV1alpha1().ModuleReleases().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DeckhouseV1alpha1().ModuleReleases().Watch(ctx, options)
			},
		},
		&apisdeckhouseiov1alpha1.ModuleRelease{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *moduleReleaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisdeckhouseiov1alpha1.ModuleRelease{}, f.defaultInformer)
}

func (f *moduleReleaseInformer) Lister() deckhouseiov1alpha1.ModuleReleaseLister {
	return deckhouseiov1alpha1.NewModuleReleaseLister(f.Informer().GetIndexer())
}
