...
type ModuleUpdatePolicyInformer interface {
	...
	Lister() deckhouseiov1alpha1.ModuleUpdatePolicyLister
}
...
func (f *moduleUpdatePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisdeckhouseiov1alpha1.ModuleUpdatePolicy{}, f.defaultInformer)
}

func (f *moduleUpdatePolicyInformer) Lister() deckhouseiov1alpha1.ModuleUpdatePolicyLister {
	return deckhouseiov1alpha1.NewModuleUpdatePolicyLister(f.Informer().GetIndexer())
}
