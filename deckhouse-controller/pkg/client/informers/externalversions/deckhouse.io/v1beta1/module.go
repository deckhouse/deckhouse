...
import (
	...
	apisdeckhouseiov1beta1 "github.com/deckhouse/deckhouse/deckhouse-controller/pkg/apis/deckhouse.io/v1beta1"
	...
	deckhouseiov1beta1 "github.com/deckhouse/deckhouse/deckhouse-controller/pkg/client/listers/deckhouse.io/v1beta1"
...
type ModuleInformer interface {
	...
	Lister() deckhouseiov1beta1.ModuleLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DeckhouseV1beta1().Modules().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DeckhouseV1beta1().Modules().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DeckhouseV1beta1().Modules().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DeckhouseV1beta1().Modules().Watch(ctx, options)
			},
		},
		&apisdeckhouseiov1beta1.Module{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *moduleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisdeckhouseiov1beta1.Module{}, f.defaultInformer)
}

func (f *moduleInformer) Lister() deckhouseiov1beta1.ModuleLister {
	return deckhouseiov1beta1.NewModuleLister(f.Informer().GetIndexer())
}
