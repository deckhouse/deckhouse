...
var modulesResource = schema.GroupVersionResource{Group: "deckhouse.io", Version: "v1alpha1", Resource: "modules"}

var modulesKind = schema.GroupVersionKind{Group: "deckhouse.io", Version: "v1alpha1", Kind: "Module"}
...
func (c *FakeModules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Module, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(modulesResource, name), &v1alpha1.Module{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeModules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ModuleList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(modulesResource, modulesKind, opts), &v1alpha1.ModuleList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeModules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(modulesResource, opts))
}
...
func (c *FakeModules) Create(ctx context.Context, module *v1alpha1.Module, opts v1.CreateOptions) (result *v1alpha1.Module, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(modulesResource, module), &v1alpha1.Module{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Module), err
...
func (c *FakeModules) Update(ctx context.Context, module *v1alpha1.Module, opts v1.UpdateOptions) (result *v1alpha1.Module, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(modulesResource, module), &v1alpha1.Module{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Module), err
...
func (c *FakeModules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(modulesResource, name, opts), &v1alpha1.Module{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeModules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(modulesResource, listOpts)
...
func (c *FakeModules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Module, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(modulesResource, name, pt, data, subresources...), &v1alpha1.Module{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Module), err
