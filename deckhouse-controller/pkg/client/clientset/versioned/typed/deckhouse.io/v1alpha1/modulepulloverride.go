...
// ModulePullOverridesGetter has a method to return a ModulePullOverrideInterface.
...
// modulePullOverrides implements ModulePullOverrideInterface
type modulePullOverrides struct {
	client rest.Interface
}

// newModulePullOverrides returns a ModulePullOverrides
func newModulePullOverrides(c *DeckhouseV1alpha1Client) *modulePullOverrides {
	return &modulePullOverrides{
		client: c.RESTClient(),
	}
}
...
func (c *modulePullOverrides) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ModulePullOverride, err error) {
	result = &v1alpha1.ModulePullOverride{}
	err = c.client.Get().
...
func (c *modulePullOverrides) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ModulePullOverrideList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ModulePullOverrideList{}
	err = c.client.Get().
		Resource("modulepulloverrides").
...
func (c *modulePullOverrides) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *modulePullOverrides) Create(ctx context.Context, modulePullOverride *v1alpha1.ModulePullOverride, opts v1.CreateOptions) (result *v1alpha1.ModulePullOverride, err error) {
	result = &v1alpha1.ModulePullOverride{}
	err = c.client.Post().
		Resource("modulepulloverrides").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(modulePullOverride).
		Do(ctx).
		Into(result)
	return
}
...
func (c *modulePullOverrides) Update(ctx context.Context, modulePullOverride *v1alpha1.ModulePullOverride, opts v1.UpdateOptions) (result *v1alpha1.ModulePullOverride, err error) {
	result = &v1alpha1.ModulePullOverride{}
	err = c.client.Put().
		Resource("modulepulloverrides").
		Name(modulePullOverride.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(modulePullOverride).
		Do(ctx).
		Into(result)
...
func (c *modulePullOverrides) UpdateStatus(ctx context.Context, modulePullOverride *v1alpha1.ModulePullOverride, opts v1.UpdateOptions) (result *v1alpha1.ModulePullOverride, err error) {
	result = &v1alpha1.ModulePullOverride{}
	err = c.client.Put().
		Resource("modulepulloverrides").
		Name(modulePullOverride.Name).
...
func (c *modulePullOverrides) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *modulePullOverrides) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *modulePullOverrides) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ModulePullOverride, err error) {
	result = &v1alpha1.ModulePullOverride{}
