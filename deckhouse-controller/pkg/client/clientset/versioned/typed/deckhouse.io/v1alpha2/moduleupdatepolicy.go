...
type ModuleUpdatePolicyInterface interface {
	Create(ctx context.Context, moduleUpdatePolicy *v1alpha2.ModuleUpdatePolicy, opts v1.CreateOptions) (*v1alpha2.ModuleUpdatePolicy, error)
	Update(ctx context.Context, moduleUpdatePolicy *v1alpha2.ModuleUpdatePolicy, opts v1.UpdateOptions) (*v1alpha2.ModuleUpdatePolicy, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.ModuleUpdatePolicy, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.ModuleUpdatePolicyList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.ModuleUpdatePolicy, err error)
...
func newModuleUpdatePolicies(c *DeckhouseV1alpha2Client) *moduleUpdatePolicies {
...
func (c *moduleUpdatePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.ModuleUpdatePolicy, err error) {
	result = &v1alpha2.ModuleUpdatePolicy{}
	err = c.client.Get().
...
func (c *moduleUpdatePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.ModuleUpdatePolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.ModuleUpdatePolicyList{}
	err = c.client.Get().
		Resource("moduleupdatepolicies").
...
func (c *moduleUpdatePolicies) Create(ctx context.Context, moduleUpdatePolicy *v1alpha2.ModuleUpdatePolicy, opts v1.CreateOptions) (result *v1alpha2.ModuleUpdatePolicy, err error) {
	result = &v1alpha2.ModuleUpdatePolicy{}
	err = c.client.Post().
		Resource("moduleupdatepolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *moduleUpdatePolicies) Update(ctx context.Context, moduleUpdatePolicy *v1alpha2.ModuleUpdatePolicy, opts v1.UpdateOptions) (result *v1alpha2.ModuleUpdatePolicy, err error) {
	result = &v1alpha2.ModuleUpdatePolicy{}
	err = c.client.Put().
		Resource("moduleupdatepolicies").
...
func (c *moduleUpdatePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.ModuleUpdatePolicy, err error) {
	result = &v1alpha2.ModuleUpdatePolicy{}
