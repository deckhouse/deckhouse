...
| bare metal | Не переводится обычно. "Голый металл" - жаргонизм. Состояние операционной системы, при котором она работает непосредственно на оборудовании без использования гипервизора |
