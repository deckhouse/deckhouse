...
[Читайте подробнее]({{ site.baseurl }}/modules/300-prometheus/prometheus_targets_development.html) в документации по разработке target'ов Prometheus.
...
[Читайте подробнее]({{ site.baseurl }}/modules/300-prometheus/grafana_dashboard_development.html) в документации по разработке графиков Grafana.
...
Подробнее процесс настройки описан [здесь]({{ site.baseurl }}/modules/300-prometheus/prometheus_targets_development.html).
