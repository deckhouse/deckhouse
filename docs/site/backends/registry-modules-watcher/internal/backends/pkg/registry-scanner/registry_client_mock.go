...
type ClientMock struct {
	...
	funcReleaseDigest          func(ctx context.Context, moduleName string, releaseChannel string) (s1 string, err error)
	funcReleaseDigestOrigin    string
	inspectFuncReleaseDigest   func(ctx context.Context, moduleName string, releaseChannel string)
	afterReleaseDigestCounter  uint64
	beforeReleaseDigestCounter uint64
	ReleaseDigestMock          mClientMockReleaseDigest
...
func NewClientMock(t minimock.Tester) *ClientMock {
	...
	m.ReleaseDigestMock = mClientMockReleaseDigest{mock: m}
	m.ReleaseDigestMock.callArgs = []*ClientMockReleaseDigestParams{}
...
type mClientMockReleaseDigest struct {
	optional           bool
	mock               *ClientMock
	defaultExpectation *ClientMockReleaseDigestExpectation
	expectations       []*ClientMockReleaseDigestExpectation

	callArgs []*ClientMockReleaseDigestParams
	mutex    sync.RWMutex
...
// ClientMockReleaseDigestExpectation specifies expectation struct of the Client.ReleaseDigest
type ClientMockReleaseDigestExpectation struct {
	mock               *ClientMock
	params             *ClientMockReleaseDigestParams
	paramPtrs          *ClientMockReleaseDigestParamPtrs
	expectationOrigins ClientMockReleaseDigestExpectationOrigins
	results            *ClientMockReleaseDigestResults
	returnOrigin       string
	Counter            uint64
}

// ClientMockReleaseDigestParams contains parameters of the Client.ReleaseDigest
type ClientMockReleaseDigestParams struct {
	ctx            context.Context
	moduleName     string
	releaseChannel string
}

// ClientMockReleaseDigestParamPtrs contains pointers to parameters of the Client.ReleaseDigest
type ClientMockReleaseDigestParamPtrs struct {
	ctx            *context.Context
	moduleName     *string
	releaseChannel *string
}

// ClientMockReleaseDigestResults contains results of the Client.ReleaseDigest
type ClientMockReleaseDigestResults struct {
	s1  string
	err error
}

// ClientMockReleaseDigestOrigins contains origins of expectations of the Client.ReleaseDigest
type ClientMockReleaseDigestExpectationOrigins struct {
	origin               string
	originCtx            string
	originModuleName     string
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmReleaseDigest *mClientMockReleaseDigest) Optional() *mClientMockReleaseDigest {
	mmReleaseDigest.optional = true
	return mmReleaseDigest
}

// Expect sets up expected params for Client.ReleaseDigest
func (mmReleaseDigest *mClientMockReleaseDigest) Expect(ctx context.Context, moduleName string, releaseChannel string) *mClientMockReleaseDigest {
	if mmReleaseDigest.mock.funcReleaseDigest != nil {
		mmReleaseDigest.mock.t.Fatalf("ClientMock.ReleaseDigest mock is already set by Set")
	}

	if mmReleaseDigest.defaultExpectation == nil {
		mmReleaseDigest.defaultExpectation = &ClientMockReleaseDigestExpectation{}
	}

	if mmReleaseDigest.defaultExpectation.paramPtrs != nil {
		mmReleaseDigest.mock.t.Fatalf("ClientMock.ReleaseDigest mock is already set by ExpectParams functions")
	}

	mmReleaseDigest.defaultExpectation.params = &ClientMockReleaseDigestParams{ctx, moduleName, releaseChannel}
	mmReleaseDigest.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
	for _, e := range mmReleaseDigest.expectations {
		if minimock.Equal(e.params, mmReleaseDigest.defaultExpectation.params) {
			mmReleaseDigest.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmReleaseDigest.defaultExpectation.params)
		}
	}
...
// ExpectCtxParam1 sets up expected param ctx for Client.ReleaseDigest
func (mmReleaseDigest *mClientMockReleaseDigest) ExpectCtxParam1(ctx context.Context) *mClientMockReleaseDigest {
	if mmReleaseDigest.mock.funcReleaseDigest != nil {
		mmReleaseDigest.mock.t.Fatalf("ClientMock.ReleaseDigest mock is already set by Set")
	}
	...
	if mmReleaseDigest.defaultExpectation.params != nil {
		mmReleaseDigest.mock.t.Fatalf("ClientMock.ReleaseDigest mock is already set by Expect")
	}

	if mmReleaseDigest.defaultExpectation.paramPtrs == nil {
		mmReleaseDigest.defaultExpectation.paramPtrs = &ClientMockReleaseDigestParamPtrs{}
	}
	mmReleaseDigest.defaultExpectation.paramPtrs.ctx = &ctx
	mmReleaseDigest.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)

	return mmReleaseDigest
}

// ExpectModuleNameParam2 sets up expected param moduleName for Client.ReleaseDigest
func (mmReleaseDigest *mClientMockReleaseDigest) ExpectModuleNameParam2(moduleName string) *mClientMockReleaseDigest {
	if mmReleaseDigest.mock.funcReleaseDigest != nil {
		mmReleaseDigest.mock.t.Fatalf("ClientMock.ReleaseDigest mock is already set by Set")
	}
	...
	mmReleaseDigest.defaultExpectation.paramPtrs.moduleName = &moduleName
	mmReleaseDigest.defaultExpectation.expectationOrigins.originModuleName = minimock.CallerInfo(1)

	return mmReleaseDigest
}

// ExpectReleaseChannelParam3 sets up expected param releaseChannel for Client.ReleaseDigest
func (mmReleaseDigest *mClientMockReleaseDigest) ExpectReleaseChannelParam3(releaseChannel string) *mClientMockReleaseDigest {
	if mmReleaseDigest.mock.funcReleaseDigest != nil {
		mmReleaseDigest.mock.t.Fatalf("ClientMock.ReleaseDigest mock is already set by Set")
	}
	...
	mmReleaseDigest.defaultExpectation.paramPtrs.releaseChannel = &releaseChannel
	mmReleaseDigest.defaultExpectation.expectationOrigins.originReleaseChannel = minimock.CallerInfo(1)

	return mmReleaseDigest
}

// Inspect accepts an inspector function that has same arguments as the Client.ReleaseDigest
func (mmReleaseDigest *mClientMockReleaseDigest) Inspect(f func(ctx context.Context, moduleName string, releaseChannel string)) *mClientMockReleaseDigest {
	if mmReleaseDigest.mock.inspectFuncReleaseDigest != nil {
		mmReleaseDigest.mock.t.Fatalf("Inspect function is already set for ClientMock.ReleaseDigest")
	}

	mmReleaseDigest.mock.inspectFuncReleaseDigest = f

	return mmReleaseDigest
}

// Return sets up results that will be returned by Client.ReleaseDigest
func (mmReleaseDigest *mClientMockReleaseDigest) Return(s1 string, err error) *ClientMock {
	if mmReleaseDigest.mock.funcReleaseDigest != nil {
		mmReleaseDigest.mock.t.Fatalf("ClientMock.ReleaseDigest mock is already set by Set")
	}

	if mmReleaseDigest.defaultExpectation == nil {
		mmReleaseDigest.defaultExpectation = &ClientMockReleaseDigestExpectation{mock: mmReleaseDigest.mock}
	}
	mmReleaseDigest.defaultExpectation.results = &ClientMockReleaseDigestResults{s1, err}
	mmReleaseDigest.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmReleaseDigest.mock
}

// Set uses given function f to mock the Client.ReleaseDigest method
func (mmReleaseDigest *mClientMockReleaseDigest) Set(f func(ctx context.Context, moduleName string, releaseChannel string) (s1 string, err error)) *ClientMock {
	if mmReleaseDigest.defaultExpectation != nil {
		mmReleaseDigest.mock.t.Fatalf("Default expectation is already set for the Client.ReleaseDigest method")
	}

	if len(mmReleaseDigest.expectations) > 0 {
		mmReleaseDigest.mock.t.Fatalf("Some expectations are already set for the Client.ReleaseDigest method")
	}

	mmReleaseDigest.mock.funcReleaseDigest = f
	mmReleaseDigest.mock.funcReleaseDigestOrigin = minimock.CallerInfo(1)
	return mmReleaseDigest.mock
}

// When sets expectation for the Client.ReleaseDigest which will trigger the result defined by the following
// Then helper
func (mmReleaseDigest *mClientMockReleaseDigest) When(ctx context.Context, moduleName string, releaseChannel string) *ClientMockReleaseDigestExpectation {
	if mmReleaseDigest.mock.funcReleaseDigest != nil {
		mmReleaseDigest.mock.t.Fatalf("ClientMock.ReleaseDigest mock is already set by Set")
	}

	expectation := &ClientMockReleaseDigestExpectation{
		mock:               mmReleaseDigest.mock,
		params:             &ClientMockReleaseDigestParams{ctx, moduleName, releaseChannel},
		expectationOrigins: ClientMockReleaseDigestExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	mmReleaseDigest.expectations = append(mmReleaseDigest.expectations, expectation)
	return expectation
}

// Then sets up Client.ReleaseDigest return parameters for the expectation previously defined by the When method
func (e *ClientMockReleaseDigestExpectation) Then(s1 string, err error) *ClientMock {
	e.results = &ClientMockReleaseDigestResults{s1, err}
	return e.mock
}

// Times sets number of times Client.ReleaseDigest should be invoked
func (mmReleaseDigest *mClientMockReleaseDigest) Times(n uint64) *mClientMockReleaseDigest {
	if n == 0 {
		mmReleaseDigest.mock.t.Fatalf("Times of ClientMock.ReleaseDigest mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmReleaseDigest.expectedInvocations, n)
	mmReleaseDigest.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmReleaseDigest
}

func (mmReleaseDigest *mClientMockReleaseDigest) invocationsDone() bool {
	if len(mmReleaseDigest.expectations) == 0 && mmReleaseDigest.defaultExpectation == nil && mmReleaseDigest.mock.funcReleaseDigest == nil {
		return true
	}

	totalInvocations := mm_atomic.LoadUint64(&mmReleaseDigest.mock.afterReleaseDigestCounter)
	expectedInvocations := mm_atomic.LoadUint64(&mmReleaseDigest.expectedInvocations)

	return totalInvocations > 0 && (expectedInvocations == 0 || expectedInvocations == totalInvocations)
}

// ReleaseDigest implements Client
func (mmReleaseDigest *ClientMock) ReleaseDigest(ctx context.Context, moduleName string, releaseChannel string) (s1 string, err error) {
	mm_atomic.AddUint64(&mmReleaseDigest.beforeReleaseDigestCounter, 1)
	defer mm_atomic.AddUint64(&mmReleaseDigest.afterReleaseDigestCounter, 1)

	mmReleaseDigest.t.Helper()

	if mmReleaseDigest.inspectFuncReleaseDigest != nil {
		mmReleaseDigest.inspectFuncReleaseDigest(ctx, moduleName, releaseChannel)
	}

	mm_params := ClientMockReleaseDigestParams{ctx, moduleName, releaseChannel}

	// Record call args
	mmReleaseDigest.ReleaseDigestMock.mutex.Lock()
	mmReleaseDigest.ReleaseDigestMock.callArgs = append(mmReleaseDigest.ReleaseDigestMock.callArgs, &mm_params)
	mmReleaseDigest.ReleaseDigestMock.mutex.Unlock()

	for _, e := range mmReleaseDigest.ReleaseDigestMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
	...
	if mmReleaseDigest.ReleaseDigestMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmReleaseDigest.ReleaseDigestMock.defaultExpectation.Counter, 1)
		mm_want := mmReleaseDigest.ReleaseDigestMock.defaultExpectation.params
		mm_want_ptrs := mmReleaseDigest.ReleaseDigestMock.defaultExpectation.paramPtrs

		mm_got := ClientMockReleaseDigestParams{ctx, moduleName, releaseChannel}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmReleaseDigest.t.Errorf("ClientMock.ReleaseDigest got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmReleaseDigest.ReleaseDigestMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.moduleName != nil && !minimock.Equal(*mm_want_ptrs.moduleName, mm_got.moduleName) {
				mmReleaseDigest.t.Errorf("ClientMock.ReleaseDigest got unexpected parameter moduleName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmReleaseDigest.ReleaseDigestMock.defaultExpectation.expectationOrigins.originModuleName, *mm_want_ptrs.moduleName, mm_got.moduleName, minimock.Diff(*mm_want_ptrs.moduleName, mm_got.moduleName))
			}

			if mm_want_ptrs.releaseChannel != nil && !minimock.Equal(*mm_want_ptrs.releaseChannel, mm_got.releaseChannel) {
				mmReleaseDigest.t.Errorf("ClientMock.ReleaseDigest got unexpected parameter releaseChannel, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmReleaseDigest.ReleaseDigestMock.defaultExpectation.expectationOrigins.originReleaseChannel, *mm_want_ptrs.releaseChannel, mm_got.releaseChannel, minimock.Diff(*mm_want_ptrs.releaseChannel, mm_got.releaseChannel))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmReleaseDigest.t.Errorf("ClientMock.ReleaseDigest got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmReleaseDigest.ReleaseDigestMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmReleaseDigest.ReleaseDigestMock.defaultExpectation.results
		if mm_results == nil {
			mmReleaseDigest.t.Fatal("No results are set for the ClientMock.ReleaseDigest")
		}
		return (*mm_results).s1, (*mm_results).err
	}
	if mmReleaseDigest.funcReleaseDigest != nil {
		return mmReleaseDigest.funcReleaseDigest(ctx, moduleName, releaseChannel)
	}
	mmReleaseDigest.t.Fatalf("Unexpected call to ClientMock.ReleaseDigest. %v %v %v", ctx, moduleName, releaseChannel)
	return
}

// ReleaseDigestAfterCounter returns a count of finished ClientMock.ReleaseDigest invocations
func (mmReleaseDigest *ClientMock) ReleaseDigestAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmReleaseDigest.afterReleaseDigestCounter)
}

// ReleaseDigestBeforeCounter returns a count of ClientMock.ReleaseDigest invocations
func (mmReleaseDigest *ClientMock) ReleaseDigestBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmReleaseDigest.beforeReleaseDigestCounter)
}

// Calls returns a list of arguments used in each call to ClientMock.ReleaseDigest.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmReleaseDigest *mClientMockReleaseDigest) Calls() []*ClientMockReleaseDigestParams {
	mmReleaseDigest.mutex.RLock()

	argCopy := make([]*ClientMockReleaseDigestParams, len(mmReleaseDigest.callArgs))
	copy(argCopy, mmReleaseDigest.callArgs)

	mmReleaseDigest.mutex.RUnlock()

	return argCopy
}

// MinimockReleaseDigestDone returns true if the count of the ReleaseDigest invocations corresponds
// the number of defined expectations
func (m *ClientMock) MinimockReleaseDigestDone() bool {
	if m.ReleaseDigestMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}

	for _, e := range m.ReleaseDigestMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}

	return m.ReleaseDigestMock.invocationsDone()
}

// MinimockReleaseDigestInspect logs each unmet expectation
func (m *ClientMock) MinimockReleaseDigestInspect() {
	for _, e := range m.ReleaseDigestMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.ReleaseDigest at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}

	afterReleaseDigestCounter := mm_atomic.LoadUint64(&m.afterReleaseDigestCounter)
	// if default expectation was set then invocations count should be greater than zero
	if m.ReleaseDigestMock.defaultExpectation != nil && afterReleaseDigestCounter < 1 {
		if m.ReleaseDigestMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ClientMock.ReleaseDigest at\n%s", m.ReleaseDigestMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ClientMock.ReleaseDigest at\n%s with params: %#v", m.ReleaseDigestMock.defaultExpectation.expectationOrigins.origin, *m.ReleaseDigestMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcReleaseDigest != nil && afterReleaseDigestCounter < 1 {
		m.t.Errorf("Expected call to ClientMock.ReleaseDigest at\n%s", m.funcReleaseDigestOrigin)
	}

	if !m.ReleaseDigestMock.invocationsDone() && afterReleaseDigestCounter > 0 {
		m.t.Errorf("Expected %d calls to ClientMock.ReleaseDigest at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.ReleaseDigestMock.expectedInvocations), m.ReleaseDigestMock.expectedInvocationsOrigin, afterReleaseDigestCounter)
	}
}
...
func (m *ClientMock) MinimockFinish() {
	m.finishOnce.Do(func() {
		if !m.minimockDone() {
			...
			m.MinimockReleaseDigestInspect()
