...
type ClientMock struct {
	...
	funcDigestChanged          func(ctx context.Context, imageURL string, lastKnownDigest string) (b1 bool, err error)
	funcDigestChangedOrigin    string
	inspectFuncDigestChanged   func(ctx context.Context, imageURL string, lastKnownDigest string)
...
func (mmDigestChanged *mClientMockDigestChanged) Expect(ctx context.Context, imageURL string, lastKnownDigest string) *mClientMockDigestChanged {
	...
	mmDigestChanged.defaultExpectation.params = &ClientMockDigestChangedParams{ctx, imageURL, lastKnownDigest}
...
// ExpectImageURLParam2 sets up expected param imageURL for Client.DigestChanged
func (mmDigestChanged *mClientMockDigestChanged) ExpectImageURLParam2(imageURL string) *mClientMockDigestChanged {
	if mmDigestChanged.mock.funcDigestChanged != nil {
		mmDigestChanged.mock.t.Fatalf("ClientMock.DigestChanged mock is already set by Set")
	}
	...
	mmDigestChanged.defaultExpectation.paramPtrs.imageURL = &imageURL
	mmDigestChanged.defaultExpectation.expectationOrigins.originImageURL = minimock.CallerInfo(1)

	return mmDigestChanged
}

// ExpectLastKnownDigestParam3 sets up expected param lastKnownDigest for Client.DigestChanged
func (mmDigestChanged *mClientMockDigestChanged) ExpectLastKnownDigestParam3(lastKnownDigest string) *mClientMockDigestChanged {
	if mmDigestChanged.mock.funcDigestChanged != nil {
		mmDigestChanged.mock.t.Fatalf("ClientMock.DigestChanged mock is already set by Set")
	}
	...
	mmDigestChanged.defaultExpectation.paramPtrs.lastKnownDigest = &lastKnownDigest
	mmDigestChanged.defaultExpectation.expectationOrigins.originLastKnownDigest = minimock.CallerInfo(1)

	return mmDigestChanged
}

// Inspect accepts an inspector function that has same arguments as the Client.DigestChanged
func (mmDigestChanged *mClientMockDigestChanged) Inspect(f func(ctx context.Context, imageURL string, lastKnownDigest string)) *mClientMockDigestChanged {
...
func (mmDigestChanged *mClientMockDigestChanged) Return(b1 bool, err error) *ClientMock {
	if mmDigestChanged.mock.funcDigestChanged != nil {
		mmDigestChanged.mock.t.Fatalf("ClientMock.DigestChanged mock is already set by Set")
	}
	...
	mmDigestChanged.defaultExpectation.results = &ClientMockDigestChangedResults{b1, err}
...
func (mmDigestChanged *mClientMockDigestChanged) Set(f func(ctx context.Context, imageURL string, lastKnownDigest string) (b1 bool, err error)) *ClientMock {
	if mmDigestChanged.defaultExpectation != nil {
...
// Then helper
func (mmDigestChanged *mClientMockDigestChanged) When(ctx context.Context, imageURL string, lastKnownDigest string) *ClientMockDigestChangedExpectation {
	if mmDigestChanged.mock.funcDigestChanged != nil {
		mmDigestChanged.mock.t.Fatalf("ClientMock.DigestChanged mock is already set by Set")
	}
	...
	expectation := &ClientMockDigestChangedExpectation{
		...
		params:             &ClientMockDigestChangedParams{ctx, imageURL, lastKnownDigest},
...
func (e *ClientMockDigestChangedExpectation) Then(b1 bool, err error) *ClientMock {
	e.results = &ClientMockDigestChangedResults{b1, err}
	return e.mock
}
...
func (mmDigestChanged *ClientMock) DigestChanged(ctx context.Context, imageURL string, lastKnownDigest string) (b1 bool, err error) {
	...
	if mmDigestChanged.inspectFuncDigestChanged != nil {
		mmDigestChanged.inspectFuncDigestChanged(ctx, imageURL, lastKnownDigest)
	}

	mm_params := ClientMockDigestChangedParams{ctx, imageURL, lastKnownDigest}
	...
	if mmDigestChanged.DigestChangedMock.defaultExpectation != nil {
		...
		mm_got := ClientMockDigestChangedParams{ctx, imageURL, lastKnownDigest}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.imageURL != nil && !minimock.Equal(*mm_want_ptrs.imageURL, mm_got.imageURL) {
				mmDigestChanged.t.Errorf("ClientMock.DigestChanged got unexpected parameter imageURL, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDigestChanged.DigestChangedMock.defaultExpectation.expectationOrigins.originImageURL, *mm_want_ptrs.imageURL, mm_got.imageURL, minimock.Diff(*mm_want_ptrs.imageURL, mm_got.imageURL))
			}

			if mm_want_ptrs.lastKnownDigest != nil && !minimock.Equal(*mm_want_ptrs.lastKnownDigest, mm_got.lastKnownDigest) {
				mmDigestChanged.t.Errorf("ClientMock.DigestChanged got unexpected parameter lastKnownDigest, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDigestChanged.DigestChangedMock.defaultExpectation.expectationOrigins.originLastKnownDigest, *mm_want_ptrs.lastKnownDigest, mm_got.lastKnownDigest, minimock.Diff(*mm_want_ptrs.lastKnownDigest, mm_got.lastKnownDigest))
			}
	...
	if mmDigestChanged.funcDigestChanged != nil {
		return mmDigestChanged.funcDigestChanged(ctx, imageURL, lastKnownDigest)
	}
	mmDigestChanged.t.Fatalf("Unexpected call to ClientMock.DigestChanged. %v %v %v", ctx, imageURL, lastKnownDigest)
	return
}
