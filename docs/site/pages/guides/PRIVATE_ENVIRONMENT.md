...
* In `InitConfiguration`, add registry access settings:
  ...
  ```yaml
  deckhouse:
    # Docker registry that hosts Deckhouse images (set the DP edition).
