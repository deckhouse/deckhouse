...
spec:
  ...
  settings:
    apiserver:
      ...
      # https://deckhouse.ru/modules/control-plane-manager/configuration.html#parameters-apiserver-publishapi
      publishAPI:
        ingress:
          enabled: true
          https:
