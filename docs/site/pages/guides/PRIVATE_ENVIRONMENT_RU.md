...
Доступ к внешним ресурсам осуществляется через отдельную машину, на которой разворачивается container regisdtry и прокси-сервер.

Схема закрытого окружения представлена на рисунке:

<img src="/images/gs/private-env-schema-RU.svg">

Рассмотрим все шаги подробнее.

## Подготовка окружения

Перед тем как приступить к развёртыванию кластера в закрытом 
