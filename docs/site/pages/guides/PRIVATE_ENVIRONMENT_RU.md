...
* [Ресурсы под будущие узлы кластера](./hardware-requirements.html#выбор-ресурсов-для-узлов) нужно выбрать исходя из ваших требований к будущей нагрузке в кластере. Для примера возьмём [минимально рекомендуемые](../gs/bm/step2.html#что-необходимо-для-установки) 4 ядра, 8 ГБ ОЗУ, 60 ГБ на быстром диске (400+ IOPS) для каждого из узов.
