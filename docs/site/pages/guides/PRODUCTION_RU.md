...
Для нормальной работы всех компонентов Deckhouse в конфигурации [bundle: Default](https://deckhouse.ru/products/kubernetes-platform/documentation/v1/modules/002-deckhouse/configuration.html#parameters-bundle) + некоторой полезной нагрузки при такой инсталляции потребуется не меньше:
 - 6 CPU, 12 ГБ RAM, 60 ГБ дискового пространства

Такая конфигурация позволяют дополнительно запустить до 30 подов приложений. 
Стоит обратить внимание на:
 - Характер полезной нагрузки
 - Обьем трафика поступающего в кластер
 - Кол-во метрик собираемых с приложений

С учетом полезной нагрузки мощности рекомендуется корректировать исходя из данных системы мониторинга.
### Мастер-узлы
