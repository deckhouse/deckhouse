...
{% alert %}
Настройте [резервное копирование etcd](/products/kubernetes-platform/documentation/v1/modules/040-control-plane-manager/faq.html#как-сделать-бэкап-etcd-вручную). Напишите план восстановления.
{% endalert %}
