...
Выберите [тип инлета](https://deckhouse.ru/products/kubernetes-platform/documentation/v1/modules/ingress-nginx/cr.html#ingressnginxcontroller-v1-spec-inlet) (определяет способ поступления трафика).
