...
При планировании размещения и запуска на одном узле более 100 подов к его конфигурации предъявляются дополнительные требования. Наиболее критичные требования затрагивают диск (распаковка и монтирование слоёв образа), ядро и оперативная память узла. Соблюдение приведённых в этом руководстве рекомендаций позволит добиться более предсказуемого времени запуска подов или ускорить его.
