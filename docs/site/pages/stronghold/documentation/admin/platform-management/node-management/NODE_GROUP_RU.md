...
Для управления узлами в системе используются группы узлов, которые описываются с помощью ресурсов [NodeGroup](https://deckhouse.ru/products/kubernetes-platform/documentation/v1/modules/node-manager/cr.html#nodegroup). Каждая группа узлов выполняет свои специфические задачи, например:
...
**Создание ресурса [SSHCredentials](https://deckhouse.ru/products/kubernetes-platform/documentation/v1/modules/node-manager/cr.html#sshcredentials).**
...
**Создание ресурса [StaticInstance](https://deckhouse.ru/products/kubernetes-platform/documentation/v1/modules/node-manager/cr.html#staticinstance).**
...
Подробно о всех параметрах можно прочитать в описании Custom Resource [NodeGroup](https://deckhouse.ru/products/kubernetes-platform/documentation/v1/modules/node-manager/cr.html#nodegroup).
