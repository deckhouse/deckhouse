...
1. Переведите кластер в режим с одним master-узлом:
   ...
   - В облачном кластере воспользуйтесь [инструкцией](/modules/control-plane-manager/faq.html#как-уменьшить-число-master-узлов-в-облачном-кластере).
   - В статическом кластере выведите лишние master-узлы из роли `control-plane` по [инструкции](/modules/control-plane-manager/faq.html#как-убрать-роль-master-узла-сохранив-узел), после чего удалите их из кластера.
   ...
   - В облачном кластере с настроенным режимом HA на базе двух master-узлов и arbiter-узла воспользуйтесь [инструкцией](/modules/control-plane-manager/faq.html#как-уменьшить-число-master-узлов-в-облачном-кластере) для удаления лишних master-узлов и arbiter-узла.

1. Восстановите etcd из резервной копии на единственном оставшемся master-узле. Следуйте [инструкции](#восстановление-кластера-с-одним-master-узлом) для кластера с одним master-узлом.
...
1. Переведите кластер обратно в мультимастерный режим. Используйте соответствующую инструкцию для [облачных кластеров](/modules/control-plane-manager/faq.html#как-добавить-master-узлы-в-облачном-кластере-single-master-в-multi-master) и для [статических кластеров](/modules/control-plane-manager/faq.html#как-добавить-master-узел-в-статическом-или-гибридном-кластере).
