---
title: "VM Network"
permalink: en/stronghold/documentation/admin/platform-management/network/vm-network.html
---

Each virtual machine is assigned an address from the ranges specified in the `.spec.settings.virtualMachineCIDRs` section of the ModuleConfig [virtualization parameters](https://deckhouse.io/products/stronghold/reference/mc.html#virtualization).
