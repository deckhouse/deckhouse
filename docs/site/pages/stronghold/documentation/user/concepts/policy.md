...
These parameters can be used to set minimums/maximums on TTLs set by clients when requesting that a [response be wrapped](response-wrapping.html), with a granularity of a second. These use duration format strings.
