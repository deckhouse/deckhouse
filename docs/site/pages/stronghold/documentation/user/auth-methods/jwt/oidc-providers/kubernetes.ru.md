...
* Значение URL в параметре  kube-apiserver-а `--service-account-issuer` должно содержать адрес, доступный из Stronhold. Для большинства managed сервисов Kubernetes этот адрес публичный.
...
1. Настройте необходимые роли, как описано [ниже](#creating-a-role-and-logging-in).
