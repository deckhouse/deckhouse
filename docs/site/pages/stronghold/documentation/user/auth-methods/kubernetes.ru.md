...
При запуске Stronghold в поде Kubernetes используется сервис аккаунт, повзоляющий провизводить проверку токенов приложений, запущенных в том же кластере Kubernetes, что и Stronhold
