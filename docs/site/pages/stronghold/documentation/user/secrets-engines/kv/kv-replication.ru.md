...
`-sync-period-min` - Интервал в минутах, через которое будет выполняться репликация заданного хранилища. Необязательный параметр. По умолчанию: 60 (1 час)
...
`-sync-period-min` - Интервал в минутах, через которое будет выполняться репликация заданного хранилища. Необязательный параметр.
...
`sync_period_min` - Интервал в минутах, через которое будет выполняться репликация заданного хранилища. Необязательный параметр. По умолчанию: 1 минута
...
`sync_period_min` - Интервал в минутах, через которое будет выполняться репликация заданного хранилища. Необязательный параметр
