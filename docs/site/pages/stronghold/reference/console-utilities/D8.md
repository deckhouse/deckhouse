...
permalink: en/stronghold/reference/console-utilities/d8.html
search: false
...
* `d8 stronghold` — commands for working with Stronghold.
  For example, to get the cluster status, you can run the command `d8 stronghold status`.
