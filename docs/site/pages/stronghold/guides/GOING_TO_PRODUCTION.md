...
permalink: en/stronghold/guides/production.html
...
For details on network configuration, refer to [VM Network](/products/stronghold/documentation/admin/platform-management/network/vm-network.html).
...
{% alert %}
Set up [etcd backups](https://deckhouse.io/products/stronghold/documentation/admin/platform-management/control-plane-settings/etcd.html).
Write up a recovery plan.
{% endalert %}

We strongly recommend that you set up [etcd backups](https://deckhouse.io/products/stronghold/documentation/admin/platform-management/control-plane-settings/etcd.html).
