...
permalink: ru/stronghold/guides/production.html
...
Подробнее про настройку сети: [управление сетью](/products/stronghold/documentation/admin/platform-management/network/vm-network.html)
...
{% alert %}
Настройте [резервное копирование etcd](https://deckhouse.ru/products/stronghold/documentation/admin/platform-management/control-plane-settings/etcd.html#резервное-копирование-etcd). Напишите план восстановления.
{% endalert %}

Обязательно настройте [резервное копирование данных etcd](https://deckhouse.ru/products/stronghold/documentation/admin/platform-management/control-plane-settings/etcd.html#резервное-копирование-etcd). Это будет ваш последний шанс на восстановление кластера в случае самых неожиданных событий. Храните резервные копии как можно *дальше* от кластера.
