...
Информация по описанию политики перенаправления прикладного трафика (`EgressGatewayPolicy`) доступна в документации для пользователя: [управление трафиком](./USER_TRAFFIC.md/)
