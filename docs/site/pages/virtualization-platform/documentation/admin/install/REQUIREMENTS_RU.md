...
- Для [программно-определяемых хранилищ](../platform-management/storage/sds/) необходимо использование дополнительных дисков для создания LVM VG. Требования к хранилищам указано в разделе с описанием конкретного хранилища.
