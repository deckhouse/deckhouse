...
- [ModuleConfig](https://deckhouse.ru/products/virtualization-platform/reference/cr/moduleconfig.html) — набор ресурсов, содержащих параметры конфигурации встроенных модулей платформы.
...
1. Общие проверки:
   - Значения параметров [PublicDomainTemplate](https://deckhouse.ru/products/virtualization-platform/reference/mc.html#global-parameters-modules-publicdomaintemplate) и [clusterDomain](http://deckhouse.ru/products/virtualization-platform/reference/cr/clusterdomain.html) не совпадают.
