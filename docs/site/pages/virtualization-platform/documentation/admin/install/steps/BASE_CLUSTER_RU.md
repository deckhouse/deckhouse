...
1. Общие проверки:
   - Значения параметров [PublicDomainTemplate](/products/virtualization-platform/reference/mc.html#global-parameters-modules-publicdomaintemplate) и [clusterDomain](/products/virtualization-platform/reference/cr/clusterconfiguration.html#clusterconfiguration-clusterdomain) не совпадают.
