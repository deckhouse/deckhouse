...
- [ModuleConfig](https://deckhouse.io/products/virtualization-platform/reference/cr/moduleconfig.html) — a set of resources containing configuration parameters for the platform's built-in modules.
...
1. General checks:
   - The values of the parameters [PublicDomainTemplate](https://deckhouse.io/products/virtualization-platform/reference/mc.html#global-parameters-modules-publicdomaintemplate) and [clusterDomain](http://deckhouse.ru/products/virtualization-platform/reference/cr/clusterdomain.html) do not match.
