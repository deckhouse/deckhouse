...
permalink: ru/virtualization-platform/documentation/admin/update-channels.html
lang: ru
---
...
Порядок настройки каналов обновлений описан в документе ["Обновление платформы"](./update/update.html)
