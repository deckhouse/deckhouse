...
- **Отсутствует заказ узлов.** Непосредственное выделение ресурсов (серверов bare metal) выполняется вручную. Дальнейшая настройка ресурсов (подключение узла к кластеру, настройка мониторинга и т.п.) выполняется либо полностью автоматически, аналогично облачным узлам, либо с небольшим объёмом ручных действий.
