...
Узлы в группе имеют общие метаданные и параметры и настраиваются автоматически в соответствии с параметрами группы. Платформа также следит за количеством узлов в группе и обновляет ПО на узлах.
