...
{% alert level="warning" %}
Обратите внимание на особенности настройки комбинированного доступа и совместного использования RoleBinding и ClusterAuthorizationRule (CAR) для одного и того же пользователя. Подробнее — в документации модуля [`user-authz`](/modules/user-authz/#rolebinding-car).
{% endalert %}
