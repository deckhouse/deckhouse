...
When using `DexProvider`, specify `https://dex.<publicDomainTemplate>/`, where [`publicDomainTemplate`](../../../../reference/cr/publicdomaintemplate.html) is the cluster DNS name template configured in the `global` module.
