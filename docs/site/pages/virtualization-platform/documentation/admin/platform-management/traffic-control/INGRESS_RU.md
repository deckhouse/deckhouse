...
### Балансировщик L2LoadBalancer

{% alert level="warning" %} Функция доступна только в Enterprise Edition {% endalert %}

1. Для создания контроллера на bare metal с балансировщиком L2LoadBalancer сначала нужно включить модуль l2-load-balancer:
...
2. Затем нужно создать ресурс `L2LoadBalancer`:
...
3. После этого можно создать NGINX Ingress контроллер:
