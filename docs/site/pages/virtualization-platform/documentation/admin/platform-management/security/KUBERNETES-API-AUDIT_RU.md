...
В Deckhouse Virtualization Platform (DVP) по умолчанию разворачивается встроенная политика аудита, которая может быть дополнена пользовательскими правилами.
