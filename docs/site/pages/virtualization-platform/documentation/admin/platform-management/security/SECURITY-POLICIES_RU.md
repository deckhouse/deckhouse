...
Неймспейс с лейблом `heritage: deckhouse` считается системным, даже если назван иначе: платформа ставит этот лейбл на создаваемые ею неймспейсы, и политика, написанная для прикладных неймспейсов, до него не доходит.
...
Префиксы `d8-system-default-`, `d8-system-excluded-` и `d8-pod-security-` зарезервированы: политика, имя которой начинается с одного из них, отклоняется при создании.
