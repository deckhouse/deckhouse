...
Лейблы неймспейса на это не влияют:
модуль, ужесточающий проверки в собственном неймспейсе, поднимает там Pod Security Standards,
а к политике, написанной для прикладной нагрузки, это отношения не имеет.

Поэтому политика с `enforcementAction: Deny`, которая доходит до системных неймспейсов,
разворачивается в два ограничения Gatekeeper,
...
Префиксы `d8-system-default-`, `d8-system-excluded-` и `d8-pod-security-` зарезервированы:
