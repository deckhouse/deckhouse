...
Политики применяются к ним иначе, чем к неймспейсам ваших приложений, и это поведение не настраивается.
...
Ресурсы OperationPolicy и SecurityPolicy действуют в системных неймспейсах также в режиме `warn`.
Политика с `enforcementAction: Deny` блокирует запуск нагрузки в неймспейсах ваших приложений,
...
там такая политика сохраняет собственное действие.
