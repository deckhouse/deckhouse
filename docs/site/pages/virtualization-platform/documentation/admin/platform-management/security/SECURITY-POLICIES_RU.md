...
Управляющие ими лейблы и сама нагрузка принадлежат владеющему неймспейсом модулю, и Deckhouse возвращает их к заявленному состоянию при следующем применении конфигурации.
...
По той же причине имя политики ограничено 234 символами: имена производных ограничений должны укладываться в 253 символа, отведённые имени объекта Kubernetes.
