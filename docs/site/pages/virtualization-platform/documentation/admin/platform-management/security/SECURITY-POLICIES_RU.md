...
При таком разделении появляются дополнительные констрейнты с именами `d8ape-system-warn-<политика>`
и `d8ape-system-enforce-<политика>`, которые видны в отчётах безопасности и в Grafana рядом с исходным.
