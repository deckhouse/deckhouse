...
permalink: ru/virtualization-platform/documentation/admin/platform-management/security/events/runtime-audit.html
lang: ru
---

Deckhouse Virtualization Platform (DVP) предоставляет встроенные средства поиска угроз безопасности
...
Подробности об архитектуре реализации аудита можно найти [в разделе Архитектура](/products/virtualization-platform/documentation/architecture/security/runtime-audit.html).
