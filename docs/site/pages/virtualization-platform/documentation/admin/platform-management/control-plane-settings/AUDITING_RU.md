...
Отключить сбор логов по базовым политикам можно установив флаг [basicAuditPolicyEnabled](https://deckhouse.ru/products/virtualization-platform/reference/mc.html#control-plane-manager-parameters-apiserver-basicauditpolicyenabled) в `false`.
...
1. Включите параметр [auditPolicyEnabled](https://deckhouse.ru/products/virtualization-platform/reference/mc.html#control-plane-manager-parameters-apiserver-auditpolicyenabled) в настройках модуля:
