...
Для создания StorageClass необходимо использовать ресурсы [HuaweiStorageClass](/products/kubernetes-platform/documentation/v1/modules/csi-huawei/cr.html#huaweistorageclass) и [HuaweiStorageConnection](/products/kubernetes-platform/documentation/v1/modules/csi-huawei/cr.html#huaweistorageconnection). Пример команд для создания таких ресурсов:
