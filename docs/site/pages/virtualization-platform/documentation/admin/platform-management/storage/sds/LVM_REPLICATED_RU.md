...
Подробности о возможностях конфигурации ресурса `ReplicatedStoragePool` описаны в разделе [«Справка»](../../../../reference/cr.html#replicatedstoragespool).
...
Подробности о возможностях конфигурации ресурса `ReplicatedStorageClass` описаны в разделе [«Справка»](../../../../reference/cr.html#replicatedstoragesclass).
