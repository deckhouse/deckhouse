...
1. Display the available [LocalStorageClass](/products/kubernetes-platform/modules/sds-local-volume/stable/cr.html#localstorageclass) resources:

   ```shell
   d8 k get lsc
   ```

1. Check each of them for the list of used [LVMVolumeGroup](/products/kubernetes-platform/modules/sds-node-configurator/stable/cr.html#lvmvolumegroup) resources.

   If you want to list all [LocalStorageClass](/products/kubernetes-platform/modules/sds-local-volume/stable/cr.html#localstorageclass) resources at once, run the command:

   ```shell
   d8 k get lsc -oyaml
   ```

   Example [LocalStorageClass](/products/kubernetes-platform/modules/sds-local-volume/stable/cr.html#localstorageclass) resource:
   ...
   Pay attention to the `spec.lvm.lvmVolumeGroups` field. It specifies the used [LVMVolumeGroup](/products/kubernetes-platform/modules/sds-node-configurator/stable/cr.html#lvmvolumegroup) resources.

1. Display the list of existing [LVMVolumeGroup](/products/kubernetes-platform/modules/sds-node-configurator/stable/cr.html#lvmvolumegroup) resources.

   ```shell
   d8 k get lvg
   ```

   Example [LVMVolumeGroup](/products/kubernetes-platform/modules/sds-node-configurator/stable/cr.html#lvmvolumegroup) output:
