...
{% alert level="warning" %}
Рекомендуется создать как минимум один ресурс [VirtualMachineClass](../../../../reference/cr.html#virtualmachineclass) в кластере с типом Discovery сразу после настройки всех узлов и добавления их в кластер. Это обеспечит виртуальным машинам использование универсального процессора с максимальными характеристиками, соответствующими CPU узлов кластера. Такой подход позволит виртуальным машинам использовать все возможности процессоров и при необходимости беспрепятственно мигрировать между узлами кластера.
{% endalert %}
...
Пример конфигурации ресурса [VirtualMachineClass](../../../../reference/cr.html#virtualmachineclass):
...
Далее приведены фрагменты конфигураций [VirtualMachineClass](../../../../reference/cr.html#virtualmachineclass) для решения различных задач:
...
далее указать в спецификации ресурса [VirtualMachineClass](../../../../reference/cr.html#virtualmachineclass):
