...
[`VirtualMachineClass`](../../../reference/cr/virtualmachineclass.html) является обязательным параметром в конфигурации виртуальной машины. Пример того, как указать класс виртуальной машины в спецификации:
