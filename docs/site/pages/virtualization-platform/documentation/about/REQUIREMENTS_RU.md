...
- Максимальное количество виртуальных машин: 50 000.
...
Для операционных систем семейства Windows поддерживается автоматическая установка с использованием файла [autounattend](https://learn.microsoft.com/ru-ru/windows-hardware/manufacture/desktop/windows-setup-automation-overview).
...
- только master-узлы, для запуска компонентов плоскости управления и рабочей нагрузки;
