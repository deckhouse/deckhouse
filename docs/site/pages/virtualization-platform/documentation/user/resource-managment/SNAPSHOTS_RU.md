...
Параметры `nameReplacements` и `customization` настраиваются в блоке `.spec.clone` (подробности — в [общем описании](#создание-клона-вм) выше).
...
Параметры `nameReplacements` и `customization` настраиваются в блоке `.spec.createVirtualMachine` (подробности — в [общем описании](#создание-клона-вм) выше).
