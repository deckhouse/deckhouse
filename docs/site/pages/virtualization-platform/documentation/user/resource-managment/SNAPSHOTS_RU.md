...
Если целостность и консистентность неважна снимок можно выполнить на работающей виртуальной машине и без "заморозки" файловой системы, для этого в спецификации ресурса [VirtualDiskSnapshot](../../../reference/cr.html#virtualdisksnapshot) добавить:
...
После создания [VirtualDiskSnapshot](../../../reference/cr.html#virtualdisksnapshot) может находиться в следующих состояниях (фазах):
...
Для создания снимков виртуальных машин используется ресурс [VirtualMachineSnapshot](../../../reference/cr.html#virtualmachinesnapshot).
