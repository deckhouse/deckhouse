...
Перед подключением USB-устройства к виртуальной машине его необходимо сделать доступным в конкретном неймспейсе. Для этого задайте параметр `.spec.assignedNamespace` ресурса [NodeUSBDevice](/modules/virtualization/cr.html#nodeusbdevice):
