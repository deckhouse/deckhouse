...
1. Создайте виртуальную машину:
   ...
   - [Параметры ресурсов](/products/virtualization-platform/reference/cr/).
...
С полным описанием параметров конфигурации виртуальных машин можно ознакомиться по [в документации конфигурации](/products/virtualization-platform/reference/cr/virtualmachine.html).
