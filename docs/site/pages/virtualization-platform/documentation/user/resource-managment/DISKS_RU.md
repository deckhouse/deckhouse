...
Диски в виртуальных машинах (ресурс [VirtualDisk](../../../reference/cr.html#virtualdisk)) необходимы для записи и хранения данных. Они обеспечивают полноценное функционирование приложений и операционных систем. Структура этих дисков включает хранилище, предоставляемое платформой.
