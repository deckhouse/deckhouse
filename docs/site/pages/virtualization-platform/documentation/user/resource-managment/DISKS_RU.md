...
Диски в виртуальных машинах (ресурс [VirtualDisk](../../../reference/cr.html#virtualdisk) необходимы для записи и хранения данных, обеспечивая полноценное функционирование приложений и операционных систем. Под "капотом" этих дисков используется хранилище, предоставляемое платформой.
...
![](../../../../../../../../docs/site/images/virtualization-platform/vd-immediate.ru.png)
...
![](../../../../../../../../docs/site/images/virtualization-platform/vd-wffc.ru.png)
