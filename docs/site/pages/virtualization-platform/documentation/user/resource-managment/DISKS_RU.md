...
Диски в виртуальных машинах (ресурсы [VirtualDisk](../../reference/cr.html#virtualdisk)) необходимы для записи и хранения данных. Они обеспечивают полноценное функционирование приложений и операционных систем. Структура этих дисков включает хранилище, предоставляемое платформой.
...
После создания ресурс [VirtualDisk](../../reference/cr.html#virtualdisk) может находиться в следующих состояниях:
...
Диск можно создавать и заполнять данными из ранее созданных образов [ClusterVirtualImage](../../reference/cr.html#clustervirtualimage) и [VirtualImage](../../reference/cr.html#virtualimage).
