...
permalink: en/virtualization-platform/documentation/user/security/scanning.html
---

Deckhouse Virtualization Platform (DVP) follows the [CIS Kubernetes Benchmark](https://www.cisecurity.org/benchmark/kubernetes) recommendations,
ensuring security both at the component level and across the platform as a whole.

To continuously monitor CIS compliance, DVP automatically runs checks in every cluster.
...
DVP provides a built-in tool for automated container image vulnerability scanning based on [Trivy](https://github.com/aquasecurity/trivy).
...
DVP uses a set of custom resources developed by the [Aqua Security Trivy Operator](https://aquasecurity.github.io/trivy-operator/) project
