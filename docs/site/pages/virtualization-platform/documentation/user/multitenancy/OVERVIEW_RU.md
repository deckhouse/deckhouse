...
Платформа предусматривает возможность исключения ресурсов (requests, limits) пода или PVC из подсчёта в квоте проекта. Например, служебные поды или PVC могут занимать ресурсы, учитывать которые не обязательно.
