...
If the Kubernetes version in the [kubernetesVersion](/products/kubernetes-platform/documentation/v1/installing/configuration.html#clusterconfiguration-kubernetesversion) parameter is set explicitly,
...
- We recommend setting up a dedicated [storageClass](/products/kubernetes-platform/documentation/v1/deckhouse-configure-global.html#parameters-storageclass) on fast disks for the Deckhouse components.
...
Note that fast disks are recommended for the Deckhouse components (the [storageClass](/products/kubernetes-platform/documentation/v1/deckhouse-configure-global.html#parameters-storageclass) global parameter).
