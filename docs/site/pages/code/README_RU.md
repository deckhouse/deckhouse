...
- [Функциональные характеристики](../documentation/functional_specifications/) — раздел описывает ключевые возможности Deckhouse Code, необходимые для управления процессами разработки, взаимодействия команд, обеспечения безопасности и интеграции с внешними системами. В этом разделе представлены основные функции инструмента с указанием их назначения и результатов использования.
