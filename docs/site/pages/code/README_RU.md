...
- [Инструкция по установке и настройке модуля](https://deckhouse.ru/products/kubernetes-platform/modules/code/stable/) — раздел содержит информацию по требованиям, порядку установки и конфигурированию платформы.
