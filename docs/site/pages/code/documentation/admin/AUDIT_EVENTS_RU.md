...
- Цель - Сущность которая была изменена. Проект, Пользователь, Защищенная ветка, токен, CI переменная и т.д.
...
События аудита содержит дату, время, ip адрес пользователя, учетную запись пользователя а также всю информацию для идентификации в какой области произошли изменения, какой объект был изменен и что именно было изменено.
...
| Название                          | Сообщение в системе                                        | Назначение                                                                                   | Аудируемые атрибуты |
|-------------------------------|---------------------------------------------------|----------------------------------------------------------------------------------------------|------------|
