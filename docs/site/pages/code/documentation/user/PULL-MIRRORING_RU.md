...
Чтобы ограничить зеркалирование только защищёнными ветками, после импорта включите параметр «Зеркалировать только защищённые ветки» на странице проекта «Настройки» → «Репозиторий» → «Зеркалирование репозиториев».
