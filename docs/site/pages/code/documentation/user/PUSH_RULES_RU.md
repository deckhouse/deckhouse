...
- ***В сообщении коммита должен присутствовать DCO (Сертификат происхождения разработчика)***  
  ...
  Коммиты должны содержать строку DCO «Signed-off-by», включая merge-коммиты и squash-коммиты. При включении этого правила в веб-интерфейсе будет недоступна опция отката merge request, поскольку автоматически сгенерированное сообщение коммита не содержит подписи DCO.
