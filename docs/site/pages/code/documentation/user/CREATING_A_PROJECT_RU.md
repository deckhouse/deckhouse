...
1. Выберите один из доступных способов создания:
   ...
   - Импортировать проект — перенос существующего проекта из другой системы. При использовании способа «Репозиторий по URL» можно установить флажок «Зеркалировать репозиторий», чтобы новый проект автоматически синхронизировался с исходным репозиторием в режиме [pull-зеркалирования](/products/code/documentation/user/pull-mirroring.html).
