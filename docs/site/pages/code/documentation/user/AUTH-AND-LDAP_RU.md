...
**Почему?** Ruby-код синхронизации читает атрибуты членства напрямую, без обхода вложенных групп. Ожидается, что все необходимые DN пользователей будут присутствовать в атрибутах членства группы.
