...
### Можно ли создавать локальные учётные записи при включённой синхронизации с LDAP?

Да, можно создавать локальные учётные записи даже при включённой синхронизации с LDAP. Чтобы такие пользователи могли войти через веб-интерфейс, должна быть включена настройка [«Разрешить аутентификацию по паролю и passkey для веб-интерфейса»](https://docs.gitlab.com/administration/settings/sign_in_restrictions/#password-and-passkey-authentication).
