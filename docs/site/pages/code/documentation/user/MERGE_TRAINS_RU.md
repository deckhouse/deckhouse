...
1. В разделе «Параметры слияния» установите флажок «Включить пайплайны для результатов слияний».
...
- на странице пайплайна цепочки слияния перейдите по ссылке «View merge train details» в заголовке страницы;
...
При включении обязательного слияния настройка «Сливать немедленно без перезапуска цепочки слияния» автоматически отключается и становится недоступна. После отключения обязательного слияния её предыдущее значение восстанавливается.
...
- в настройках проекта включены пайплайны для результатов слияний и цепочки слияния;
