...
![Настройка «Отключить проверки одобрения Code Owners»](/images/code/disable_code_owners_checks_ru.png)

При отключении проверки CODEOWNERS пропускаются во всём проекте:

- запросы на слияние не блокируются из-за отсутствующих апрувов от владельцев кода;
...
![Настройка «Автоматически назначать владельцев кода проверяющими»](/images/code/assign_code_owners_reviewers_ru.png)
