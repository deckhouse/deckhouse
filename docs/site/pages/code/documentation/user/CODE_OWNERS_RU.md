...
- является прямым или унаследованым участником группы, которая напрямую приглашена в проект.
- является прямым но не унаследованым участником группы которая приглашена в группу проекта
- является прямым но не унаследованым участником группы которая приглашена в предка группы проекта

Если подытожить, то подходят все пользователи которые отображаются на странцие участников проекта с ролью developer или выше.
