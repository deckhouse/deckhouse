...
![Отключить проверки одобрения Code Owners](/images/code/disable_code_owners_checks_ru.png)
...
![Автоматически назначать владельцев кода проверяющими](/images/code/assign_code_owners_reviewers_ru.png)
