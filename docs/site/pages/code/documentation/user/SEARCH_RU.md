...
Параметры REST API, фильтры и формат ответа описаны в справочнике [API поиска](/code/documentation/user/search-api.html).
...
Доступ к содержимому файлов, задач, комментариев и других сущностей определяется текущими настройками доступа в проекте, группе и на уровне инстанса.
