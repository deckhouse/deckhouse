...
- [Запроса на слияние](#правила-для-запроса-на-слияние) (доступно для роли **Developer**). Чтобы определить правила для запроса на слияние, на странице создания или редактирования MR раскройте секцию **«Правила апрува»**.
