Set up SSH access between the machine used for the **Deckhouse Platform {% if page.revision == 'ee' %}Enterprise Edition{% else %}Community Edition{% endif %}** installation and the cluster's prospective master node.
