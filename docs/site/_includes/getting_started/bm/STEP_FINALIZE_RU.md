...
Для реальных условий (производственные и тестовые среды) <a href="/documentation/latest/modules/040-node-manager/faq.html#как-добавить-статичный-узел-в-кластер">добавьте узлы</a> в кластер и ознакомьтесь с модулем <a href="/documentation/latest/modules/040-node-manager/">Управление узлами</a>
