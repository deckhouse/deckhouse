...
For real-world conditions (production and test environments), you need to add additional nodes to the cluster according to <a href="/en/documentation/latest/modules/040-node-manager/faq.html#how-do-i-add-a-static-node-to-a-cluster">the documentation</a>.
