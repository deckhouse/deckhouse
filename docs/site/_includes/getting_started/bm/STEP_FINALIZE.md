...
For real-world conditions (production and test environments), you need to <a href="/documentation/latest/modules/040-node-manager/faq.html#how-do-i-add-a-static-node-to-a-cluster">add nodes</a> to the cluster and familiarize yourself with <a href="/documentation/latest/modules/040-node-manager/">the Node Management</a> module.
