...
Under this placement strategy, virtual machines access the Internet using a NAT Gateway with a shared (and single) source IP. All nodes created by dhctl can optionally get a public IP (ElasticIP).
