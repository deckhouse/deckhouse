...
<script type="text/javascript" src='{% javascript_asset_tag dvp-getting-started-access %}[_assets/js/dvp/getting-started-access.js]{% endjavascript_asset_tag %}'></script>
