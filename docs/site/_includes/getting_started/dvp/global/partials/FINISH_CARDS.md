...
🚀 <span class="cards-item__title-text">Your first virtual machine</span>
</h3>
<div class="cards-item__text" markdown="1">
Create a virtual machine in your cluster.

Follow the [virtual machine creation guide](/products/virtualization-platform/documentation/user/resource-management/virtual-machines.html) — section "Quick start on creating a VM".
</div>
</div>
