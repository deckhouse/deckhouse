...
🚀 <span class="cards-item__title-text">Первая виртуальная машина</span>
</h3>
<div class="cards-item__text" markdown="1">
Создайте виртуальную машину в установленном кластере.

Следуйте [инструкции по созданию виртуальной машины](/products/virtualization-platform/documentation/user/resource-management/virtual-machines.html) — раздел «Быстрый старт по созданию ВМ».
</div>
</div>
