...
Придумайте пароль для пользователя внутри виртуальной машины и сгенерируйте его хеш:
...
- `passwd` — содержит в кавычках хеш пароля `test-user`, замените на свой хеш.
