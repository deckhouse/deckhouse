...
<div class="gs-installer__image">
{%- if page.platform_code == 'yandex' %}
<img src="/images/gs/installer/ya-cloud-settings.png" alt="Как выглядит окно настройки узлов..." style="width: 100%;">
{%- endif %}
{%- if page.platform_code == 'dvp-provider' %}
<img src="/images/gs/installer/dvp-cloud-settings.png" alt="Как выглядит окно настройки узлов..." style="width: 100%;">
{%- endif %}
{%- if page.platform_code == 'openstack' %}
<img src="/images/gs/installer/openstack-cloud-settings.png" alt="Как выглядит окно настройки узлов..." style="width: 100%;">
{%- endif %}
{%- if page.platform_code == 'openstack_selectel' %}
<img src="/images/gs/installer/selectel-cloud-settings.png" alt="Как выглядит окно настройки узлов..." style="width: 100%;">
{%- endif %}
{%- if page.platform_code == 'openstack_vk' %}
<img src="/images/gs/installer/vk-cloud-settings.png" alt="Как выглядит окно настройки узлов..." style="width: 100%;">
{%- endif %}
{%- if page.platform_code == 'vsphere' %}
<img src="/images/gs/installer/vsphere-cloud-settings.png" alt="Как выглядит окно настройки узлов..." style="width: 100%;">
{%- endif %}
{%- if page.platform_code == 'vcd' %}
<img src="/images/gs/installer/vcd-cloud-settings.png" alt="Как выглядит окно настройки узлов..." style="width: 100%;">
{%- endif %}
{%- if page.platform_code == 'zvirt' %}
<img src="/images/gs/installer/zvirt-cloud-settings.png" alt="Как выглядит окно настройки узлов..." style="width: 100%;">
{%- endif %}
</div>
