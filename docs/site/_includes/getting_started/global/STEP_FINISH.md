...
<div markdown="1">
Deckhouse supports [various](https://early.deckhouse.io/en/documentation/v1/modules/150-user-authn/usage.html)
...
<div class="cards-item__text" markdown="1">
You have to create a [DexAuthenticator](https://early.deckhouse.io/en/documentation/v1/modules/150-user-authn/cr.html#dexauthenticator) object to enable external authentication for any Ingress resource.
</div>
</div>
