...
Платформа Deckhouse Platform, развернутая в кластере kind, пригодна для ознакомления с остальными возможностями, которые понадобятся для полноценных production-окружений. Далее — информация о таких возможностях.
