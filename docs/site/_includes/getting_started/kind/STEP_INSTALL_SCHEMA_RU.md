[kind](https://kind.sigs.k8s.io/) позволяет быстро получить кластер Kubernetes на локальной машине. Такой кластер можно использовать для целей ознакомления, тестирования, разработки.   
