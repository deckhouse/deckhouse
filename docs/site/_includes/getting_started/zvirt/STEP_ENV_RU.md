...
Для корректной работы Deckhouse Platform с облаком zVirt требуется версия zVirt `4.0`-`4.4`.

Чтобы развернуть Deckhouse Platform на zVirt, необходимо выполнить предварительные настройки в системе виртуализации:
