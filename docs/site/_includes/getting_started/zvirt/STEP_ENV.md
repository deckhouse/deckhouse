...
For Deckhouse Platform to work correctly with the zVirt cloud, you need zVirt version `4.0`-`4.4`.

To deploy Deckhouse Platform on zVirt, you need to perform preconfigurations in the virtualization system:
