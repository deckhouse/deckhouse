...
Access to the documentation is restricted via the basic authentication mechanism (additional authentication options are provided in the [user-auth](../../products/kubernetes-platform/documentation/v1/modules/150-user-authn/) module):
- Login — `admin`
