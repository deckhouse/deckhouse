...
Подключение дополнительных сетей к виртуальной машине описано в разделе [«Дополнительные сетевые интерфейсы»](user/network/virtualization/vm-additional-interfaces.html#дополнительные-сетевые-интерфейсы).
