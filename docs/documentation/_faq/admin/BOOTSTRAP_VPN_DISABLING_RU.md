...
Если на компьютере, с которого выполняется bootstrap кластера, включен VPN, контейнер с установщиком (включая графический инсталлятор) может потерять доступ к сетевому стеку хоста. Из-за этого, например, веб-интерфейс графического инсталлятора может не открываться в браузере.
