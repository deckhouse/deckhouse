...
Также вы можете проверить состояние релизов DP в кластере, используя следующую команду:
...
- Если под находится в статусе `Running`, но в колонке `READY` указано `0/1`, это означает, что обновление еще не завершено. Если так продолжается более 20–30 минут, это может говорить о наличии проблем в работе DP. Необходима диагностика.
- Если под не находится в статусе `Running`, это может говорить о наличии проблем в работе DP. Необходима диагностика.
...
- Соберите отладочную информацию и свяжитесь с [технической поддержкой DP](/tech-support/).
