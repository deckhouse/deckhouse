---
title: Что делать, если DP не получает обновления из настроенного канала?
subsystems:
  - deckhouse
lang: ru
---

- Проверьте, что настроен [нужный канал обновлений](../admin/configuration/update/configuration.html#проверка-текущего-канала-обновлений).
...
#### Пример настроек DNS, которые могут привести к ошибкам в разрешении IP-адреса хранилища образов DP
