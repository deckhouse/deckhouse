---
title: Что делать при наличии проблем с обновлением DP?
subsystems:
  - deckhouse
lang: ru
---

#### Обновление Deckhouse Platform не проходит, один или несколько подов Deckhouse в нерабочем состоянии

Если обновление Deckhouse Platform не проходит, один или несколько подов Deckhouse в неймспейсе `d8-system` находятся в нерабочем состоянии, выполните следующие действия:
...
#### Обновление DP находится в статусе Release is suspended
