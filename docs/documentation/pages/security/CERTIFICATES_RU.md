...
permalink: ru/security/certificates.html
description: "Управление TLS-сертификатами в Deckhouse Platform Certified Security Edition с интеграцией Let's Encrypt, HashiCorp Vault и Venafi. Автоматическое обновление, мониторинг и управление жизненным циклом сертификатов."
lang: ru
