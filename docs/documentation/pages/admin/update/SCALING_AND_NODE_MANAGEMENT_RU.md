...
CloudEphemeral: Автоматически создаваемые и удаляемые узлы в облаке.

CloudPermanent: Узлы, управляемые через Terraform.

CloudStatic: Статические узлы в облаке с поддержкой CSI.

Static: Физические серверы или виртуальные машины вне облака.
...
пораспихивать из FAQ по всему разделу