...
- порты модулей платформы из диапазона 4200–4299, перечисленные в [списке сетевого взаимодействия компонентов платформы](/products/kubernetes-platform/documentation/v1/reference/network_interaction.html);
