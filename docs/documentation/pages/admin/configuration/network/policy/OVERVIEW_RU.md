...
* Включен режим туннелирования трафика между подами ([настройки](../../reference/mc/cni-cilium/#parameters-tunnelmode) для CNI Cilium, [настройки](../../reference/mc/cni-flannel/#parameters-podnetworkmode) для CNI Flannel).
