...
Choose this option when you need advanced traffic management in a service mesh (for example, canary routing or mTLS). Module reference: [`istio`](/modules/istio/).
