...
| Cross-namespace references | An Ingress, its backend Service, and its TLS Secret generally reside in the same namespace | Controlled cross-namespace references are supported through [ReferenceGrant](https://gateway-api.sigs.k8s.io/reference/api-types/referencegrant/)                                                                                                               |
