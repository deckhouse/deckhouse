...
Служебные домены (веб-интерфейсы компонентов DP и модулей по `publicDomainTemplate`) и домены приложений (маршруты разработчиков приложения) настраиваются по-разному. Подробности — в разделе [«Публикация служебных доменов»](alb/alb-gateway-api.html#публикация-служебных-доменов).
...
| Развитие | Режим сопровождения: upstream-проект Ingress NGINX не развивает новые возможности, обновления безопасности поставляет DP                                                                                                                                                                                                                                | Активно развивается                                                                                                                                                                   |
| Минимальная версия DP | Доступен во всех поддерживаемых версиях                                                                                                                                                                                                                                                                                                                  | 1.76                                                                                                                                                                                  |
| Редакции DP | Все редакции                                                                                                                                                                                                                                                                                                                                             | Все редакции                                                                                                                                                                          |
