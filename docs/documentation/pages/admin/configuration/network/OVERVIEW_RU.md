...
С помощью [сетевых политик](./policy/configuration.html) в DKP определяются правила, регулирующие поток трафика между подами, узлами, namespace и внешними системами. Сетевые политики обеспечивают изоляцию подов, защиту от атак внутри кластера, контроль доступа к внешним сервисам и фильтрацию входящих и исходящих соединений.
