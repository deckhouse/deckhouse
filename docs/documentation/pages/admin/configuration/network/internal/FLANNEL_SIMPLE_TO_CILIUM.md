...
{% alert level="info" %}
This guide is applicable to Deckhouse Platform version 1.75 and earlier.

For DP version 1.76 and later, use the [Switching CNI in the cluster](/products/kubernetes-platform/guides/cni-migration.html) guide.
{% endalert %}
