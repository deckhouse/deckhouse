...
Подробная информация о проблемах, которые позволяет решить кеширующий DNS-сервер и о принципе его работы — в разделе [кеширующий DNS-сервер в кластере](../../../../architecture/network/dns-caching.html).
