...
В Deckhouse Kubernetes Platform реализована возможность декларативно управлять дополнительными сетями для прикладных нагрузок (поды, виртуальные машины). При этом:
