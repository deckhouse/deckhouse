...
Один из классов можно назначить классом по умолчанию. Модуль подставит его имя в параметр [`.spec.virtualMachineClassName`](/modules/virtualization/cr.html#virtualmachine-v1alpha2-spec-virtualmachineclassname), если владелец проекта не указал класс сам.
