---
title: "Виртуальный процессор и размещение ВМ"
permalink: ru/admin/configuration/virtualization/vm-classes-cpu.html
description: "Типы виртуального процессора в VirtualMachineClass, автоматический подбор инструкций через vCPU Discovery и правила размещения машин класса по узлам."
search: виртуальный процессор, vCPU Discovery, тип CPU, размещение по узлам
lang: ru
---

Класс виртуальной машины задаёт, какой процессор увидит гостевая система и на каких узлах запустится машина этого класса.
