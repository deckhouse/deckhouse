...
В DKP реализована сквозная аутентификация, которая охватывает как интерфейсы взаимодействия, реализованные в рамках DKP, так и пользовательские приложения.
...
- Использовать локальную аутентификацию и [интегрироваться](#интеграция) со следующими внешними системами аутентификации:
  - [GitHub](todo);
  - [GitLab](todo);
