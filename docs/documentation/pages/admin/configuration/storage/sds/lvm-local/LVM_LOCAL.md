...
description: "Configure local LVM-based storage in Deckhouse Platform. High-performance local storage setup for test environments and EDGE clusters with reduced network latency."
---
