...
description: "Настройка локального хранилища на основе LVM в Deckhouse Platform. Высокопроизводительное локальное хранилище для тестовых сред и EDGE-кластеров с уменьшенными сетевыми задержками."
lang: ru
---
