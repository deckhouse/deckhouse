...
description: "Configure replicated storage based on DRBD in Deckhouse Platform. High availability storage with LINSTOR backend for fault tolerance and data replication across nodes."
---
