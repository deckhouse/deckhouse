...
description: "Настройка реплицируемого хранилища на основе DRBD в Deckhouse Platform. Высокодоступное хранилище с бэкендом LINSTOR для отказоустойчивости и репликации данных между узлами."
lang: ru
---
