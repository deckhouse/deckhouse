...
Подробнее с разметкой и рекомендуемыми объемами дисков можно ознакомиться [в разделе «Разметка и объем дисков»](/products/kubernetes-platform/guides/fs-requirements.html).
