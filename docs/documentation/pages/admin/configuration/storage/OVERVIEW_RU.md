...
description: "Настройка решений хранения данных в Deckhouse Platform включая SDS, внешние хранилища, снапшоты и поддерживаемые типы хранилищ."
lang: ru
search: storage overview, storage management, управление хранилищем, хранение данных
---

Надёжное хранение данных — одна из ключевых задач при развёртывании и эксплуатации кластеров Kubernetes. В Deckhouse Platform этот вопрос решается за счёт гибкой поддержки программно-определяемых и внешних хранилищ, а также удобных инструментов автоматизации и управления.
...
Подробнее с разметкой и рекомендуемыми объемами дисков можно ознакомиться [в руководстве «Разметка и объем дисков»](/products/kubernetes-platform/guides/fs-requirements.html).

## Поддерживаемые типы хранилищ

Deckhouse Platform предлагает широкий спектр решений, которые условно делятся на две большие группы.
