...
description: "Настройка поддерживаемых типов хранилищ в Deckhouse Platform. Конфигурация StorageClass, управление хранилищами и настройка различных типов хранилищ."
lang: ru
