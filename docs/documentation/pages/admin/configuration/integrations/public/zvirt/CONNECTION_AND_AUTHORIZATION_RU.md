...
Для корректной работы Deckhouse Kubernetes Platform с облаком zVirt необходимо:
...
1. Не добавляйте сетевые интерфейсы — они будут созданы автоматически при заказе узла Deckhouse Kubernetes Platform.
