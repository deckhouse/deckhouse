...
При создании кластера Deckhouse Kubernetes Platform (DKP) создаёт Network Security Group (NSG) с именем префикса кластера и привязывает её к подсети узлов.
