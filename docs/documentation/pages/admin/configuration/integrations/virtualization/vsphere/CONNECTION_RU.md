...
permalink: ru/admin/integrations/virtualization/vmware/сonnection-and-authorization.html
lang: ru
---

Для управления ресурсами в vSphere с помощью Deckhouse Kubernetes Platform необходимо настроить в системе следующие ресурсы:
