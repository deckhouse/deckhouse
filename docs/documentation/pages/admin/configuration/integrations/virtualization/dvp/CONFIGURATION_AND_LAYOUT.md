...
The DVP cloud provider configuration consists of four resources:
...
To modify the provider settings in a running cluster, edit the ModuleConfig:
...
Example of a configuration with multiple parameters:
