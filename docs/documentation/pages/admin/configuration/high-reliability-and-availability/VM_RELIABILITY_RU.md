...
Нагрузка на узлы меняется со временем, а узлы иногда выходят из строя. DP выравнивает размещение виртуальных машин (ВМ) по узлам и перезапускает машины отказавшего узла, а метрики помогают понять, почему машина работает медленно.
