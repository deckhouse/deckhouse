...
Создайте ресурс [Descheduler](/modules/descheduler/cr.html#descheduler) и включите в нём нужные стратегии. Параметры стратегий описаны в разделе [«Вытеснение подов»](../app-scaling/pod-eviction/scheduler.html).
