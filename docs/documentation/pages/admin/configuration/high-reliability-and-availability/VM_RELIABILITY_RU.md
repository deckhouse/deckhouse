...
Настройки перебалансировки DP задаёт сам: при включённом модуле `descheduler` он создаёт ресурс [Descheduler](/modules/descheduler/cr.html#descheduler) с именем `virtualization` и отбирает в нём только те машины, которые можно перенести живой миграцией. Как устроены стратегии вытеснения, описано в разделе [«Вытеснение подов»](../app-scaling/pod-eviction/scheduler.html).
