...
Control plane monitoring is performed by the [`control-plane-manager`](/modules/control-plane-manager/) module, which organizes secure metrics collection and provides a basic set of monitoring rules for the following cluster components:
