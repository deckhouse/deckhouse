...
Если необходимо настроить собственные правила расчета метрик, без предлагаемых DKP ресурсов `Cluster*Metric` и `*Metric`, можно воспользоваться ресурсом [CustomPrometheusRules](../../../reference/cr/customprometheusrules/).
