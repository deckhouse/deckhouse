...
description: "Настройка Vertical Pod Autoscaler (VPA) в Deckhouse Platform. Автоматическое управление ресурсами контейнеров и оптимизация на основе метрик использования для повышения эффективности."
lang: ru
---
...
Подробнее о режимах работы VPA, его компонентах и ограничениях можно почитать в [разделе «Архитектура»](../../../architecture/kubernetes-and-scheduling/vpa.html).
