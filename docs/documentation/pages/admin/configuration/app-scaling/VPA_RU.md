...
- Автоматическое изменение запросов ресурсов (Auto, Recreate):
...
- Простая генерация рекомендаций без изменения ресурсов (Initial, Off):
