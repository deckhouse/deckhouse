...
1. Используйте классические или namespace-scoped дополнительные метрики. Варианты cluster-wide или внешние рассматривайте при большом количестве одинаковых сервисов или внешних SaaS/облачных сервисах.
