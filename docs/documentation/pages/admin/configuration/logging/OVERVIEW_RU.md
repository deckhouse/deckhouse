...
description: "Настройка логирования в Deckhouse Platform с функциями встроенного сбора, доставки и хранения логов. Централизованное решение для логирования, мониторинга и устранения проблем в кластере."
lang: ru
---

Deckhouse Platform (DP) предоставляет встроенные средства для сбора,
доставки и кратковременного хранения логов.

Возможности DP в области логирования:
