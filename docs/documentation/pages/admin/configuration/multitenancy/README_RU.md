...
* для администраторов платформы:
  ...
  * **управление доступом к ресурсам** — администраторы могут контролировать, какие кластерные ресурсы (напр. `StorageClass`, `ClusterIssuer`, `ClusterRole`, `LoadBalancerClass`) каждый проект может использовать, и задавать дефолты для проекта. См. [раздел грантов в руководстве по использованию](usage_ru.html#выдача-кластерных-ресурсов-проектам).
