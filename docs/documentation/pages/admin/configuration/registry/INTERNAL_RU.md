...
В DKP реализованы следующие режимы работы с внутренним хранилищем образов:
...
Работа с внутренним хранилищем образов имеет ряд ограничений и особенностей, касающихся установки, условий работы и переключения режимов.
...
Для использования внутреннего хранилища образов контейнеров в DKP необходимо соблюдение следующих условий:
