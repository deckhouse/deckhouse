...
В разделе [«Восстановление подключения к Registry»](../registry/restore-token.html) описан процесс восстановление загрузки образов Deckhouse при истекшем лицензионном токене.
