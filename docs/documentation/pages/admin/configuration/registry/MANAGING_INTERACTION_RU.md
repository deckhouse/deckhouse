...
Для управления настройками взаимодействия DKP c хранилищем образов контейнеров необходимо соблюдение следующих условий:
...
- Кластер полностью управляется DKP. В Managed Kubernetes кластерах управление настройками взаимодействия с хранилищем образов с помощью модуля `registry` работать не будет.
