...
Настройка взаимодействия с хранилищем образов имеет ряд ограничений и особенностей, касающихся установки кластера, условий использования модуля `registry` для настройки взаимодействия с хранилищем и переключения режимов взаимодействия с хранилищем.
...
Для управления настройками взаимодействия DKP с хранилищем образов контейнеров необходимо соблюдение следующих условий:
