...
- **Автоматический режим** — кластер обновляется сразу после появления новой версии [на используемом канале обновлений](../../../architecture/updating.html#каналы-обновлений). Доступно два варианта настройки:
  - `AutoPatch` — устанавливаются только обновления патч-версий в рамках текущей минорной версии;
...
Чтобы DKP обновлялся в пределах текущей минорной версии (устанавливались только патч-версии), используйте режим `AutoPatch`.
