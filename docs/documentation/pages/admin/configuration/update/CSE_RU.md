---
title: "Переключение на CSE"
permalink: ru/admin/configuration/update/switching-cse.html
lang: ru
---

Эта инструкция описывает шаги, необходимые для смены Deckhouse Kubernetes Platform **Enterprise Edition** (DKP EE) в работающем кластере на Deckhouse Kubernetes Platform **Certified Security Edition** (DKP CSE).

Переключение может быть выполнено одним из следующих способов:
