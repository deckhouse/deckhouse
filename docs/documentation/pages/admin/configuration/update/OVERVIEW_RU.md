...
description: "Управление обновлениями платформы Deckhouse Platform. Безопасные обновления, уведомления и управление конфигурацией для платформы и компонентов кластера."
lang: ru
...
Откат на одну минорную версию назад возможен только для [версии Kubernetes (control plane)](../platform-scaling/control-plane/updating-and-versioning.html), а не для версии DP.
{% endalert %}
...
- [Получение Changelog](../../../architecture/updating.html#получение-истории-изменений-changelog) — каждая версия DP сопровождается списком изменений, который доступен как в кластере, так и в уведомлении о новом релизе.
...
С обновлением DP в закрытом окружении можно ознакомиться подробнее [в руководстве «Обновление DP в закрытом окружении»](/products/kubernetes-platform/guides/airgapped-update.html).
