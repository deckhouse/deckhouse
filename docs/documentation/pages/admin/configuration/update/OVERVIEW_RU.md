...
Откат на одну минорную версию назад возможен только для [версии Kubernetes (control plane)](../platform-scaling/control-plane/updating-and-versioning.html), а не для версии DKP.
{% endalert %}
...
С обновлением DKP в закрытом окружении можно ознакомиться подробнее [в руководстве «Обновление DKP в закрытом окружении»](/products/kubernetes-platform/guides/airgapped-update.html).
