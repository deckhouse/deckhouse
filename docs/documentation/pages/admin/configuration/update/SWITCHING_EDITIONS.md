...
This instruction describes the steps necessary to change the edition of Deckhouse Kubernetes Platform in an existing cluster. The guide covers switching between the following editions: CE, BE, SE, SE+, and EE.

Switching DKP between CE, BE, SE, SE+, and EE editions can be done in one of the following ways:
