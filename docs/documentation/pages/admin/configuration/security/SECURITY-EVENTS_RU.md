...
description: "Настройка сбора, обработки и доставки событий безопасности в Deckhouse Platform. Единый контур событий безопасности из логов приложений и инфраструктурных компонентов Kubernetes."
lang: ru
---

Deckhouse Platform (DP) предоставляет средства для декларативного сбора, обработки,
...
Для работы модуля `security-events-manager` требуются следующие модули DP:
