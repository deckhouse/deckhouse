...
Для получения информации о том, как просматривать результаты сканирования, откройте [раздел «Сканирование контейнерных образов на уязвимости»](../../../user/security/scanning.html).
