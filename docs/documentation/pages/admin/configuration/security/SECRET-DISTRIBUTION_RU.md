---
title: Автоматическое распространение секретов по неймспейсам
permalink: ru/admin/configuration/security/secret-distribution.html
description: "Настройка автоматического распространения секретов по неймспейсам в Deckhouse Platform. Репликация секретов, интеграция с CI/CD и автоматизация безопасного управления секретами."
lang: ru
---

Deckhouse Platform (DP) позволяет автоматически распространять секреты во все неймспейсы кластера.
