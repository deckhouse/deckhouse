...
Чтобы проверить корректность правил RBAC, используйте CLI-утилиту `argocd`. Чтобы определить, может ли конкретный пользователь, группа или роль выполнить определённое действие, используйте команду:
