...
1. не видно никаких изменений (настройки не применяются),
1. при попытке входа в веб-интерфейс платформы (Console) с любым типом авторизации возникает ошибка `500 Internal Server Error` без подробного описания.
