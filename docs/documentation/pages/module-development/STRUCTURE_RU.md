...
- `stage: string` — [cтадия жизненного цикла модуля](../versioning/#стадия-жизненного-цикла-модуля). Допустимые значения: `Experimental`, `Preview`, `General Availability`, `Deprecated`.
