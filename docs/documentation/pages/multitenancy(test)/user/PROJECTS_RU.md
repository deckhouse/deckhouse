...
[Проекты](../concepts/glossary.html#проекты) похожи на [пространства имён](../concepts/glossary.html#пространство-имён) в Kubernetes, но имеют больше возможностей. Пространства имен используются для логического разделения ресурсов в Kubernetes, и, например, не ограничивают сетевое взаимодействие или потребление ресурсов подами. Такие особенности не удовлетворяют современные требования к разработке.
...
## Управление доступом проекту и проектному пространству имён

### Предоставление доступа к проекту

### Предоставление доступа к проектному пространству имён
