...
В данном разделе рассматриваются типичные сценарии использования [проектов](glossary.html#проекты).

Создание проектов и шаблонов проектов описаны в [разделе "Администрирование"](../admin/projects.html).
