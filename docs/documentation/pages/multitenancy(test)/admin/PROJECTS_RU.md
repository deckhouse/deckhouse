...
В данном разделе описаны процессы работы администратора с [проектами](../concepts/glossary.html#проекты).
...
В Deckhouse доступны следующие шаблоны проектов:
...
Для создания [проекта](../concepts/glossary.html#проекты) используются следующие ресурсы:
...
Процесс редактирования [проекта](../concepts/glossary.html#проекты) в веб-интерфейсе Deckhouse выглядит следующим образом:
...
Процесс удаления [проекта](../concepts/glossary.html#проекты) в веб-интерфейсе Deckhouse выглядит следующим образом:
...
DKP поддерживает совместимость с Kubernetes, расширяя механизм пространства имён при использовании [проектов](concepts.html#проекты), и позволяет автоматически мигрировать существующие пространства имён в проекты.
...
Платформа Deckhouse может автоматически создавать новые [проекты](../concepts/glossary.html#проекты) из существующих [пространств имён](../concepts/glossary.html#пространство-имён). Для этого пометьте необходимое пространство имён аннотацией `projects.deckhouse.io/adopt`. Например:
