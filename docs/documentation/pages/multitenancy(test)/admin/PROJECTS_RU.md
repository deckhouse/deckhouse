...
DKP может автоматически создавать новые [проекты](../concepts/glossary.html#проекты) из существующих [пространств имён](../concepts/glossary.html#пространство-имён). Для этого пометьте необходимое пространство имён аннотацией `projects.deckhouse.io/adopt`. Например:
