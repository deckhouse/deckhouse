...
В данном разделе описаны процессы работы с [шаблонами проектов](#шаблоны-проектов), основные [преимущества](#преимущества) и [ограничения](#ограничения) их использования в Deckhouse, а также [типичные сценарии применения](#типичные-сценарии-применения).
