...
Ролевая модель (RBAC) — механизм контроля доступа к ресурсам внутри [проекта](#проект).

### Роль

Роль (Role) — набор прав, предоставляемых пользователю в рамках [проекта](#проект).
