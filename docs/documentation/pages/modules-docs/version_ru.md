...
Для версионирования модулей используется семантическое версионирование [`semver`][semver]. Какую версию поднимать, выбирается следующим образом:
...
При выходе новой версии _CustomResourceDefinition_ (CRD):
