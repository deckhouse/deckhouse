...
* **Сборка**: создание артефакта модуля во время сборки и загрузка его в container registry. В разделе [**Сборка модуля**](module-anatomy/registry/) разбирается, где хранятся образы в registry и какие образы доступны.
