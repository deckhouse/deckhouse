...
Для версионирования модулей используется [`semver`][semver]. Выберите из следующих версий:

**Patch-версия** — исправление дефекта (бага).

**Minor-версия** — добавление новой функции.

**Major-версия** — добавление функции, которая кардинально меняет возможности модуля. Масштабное изменение интерфейса. Завершение крупного этапа работы.
