...
Глобальные настройки Deckhouse хранятся в ресурсе `ModuleConfig/global`. Их можно рассматривать как специальный [модуль](./#настройка-модуля) `global`, который нельзя отключить.
