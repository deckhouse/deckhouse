...
- [InitConfiguration](configuration.html#initconfiguration) — начальные параметры [конфигурации Deckhouse](../#конфигурация-deckhouse). С этой конфигурацией Deckhouse запустится после установки.
  ...
  Внимание! Параметр `configOverrides` устарел и будет удален в версии Deckhouse 1.55. Используйте набор [ModuleConfig](../DECKHOUSE_CONFIGURE_RU.md) для установки параметров встроенных модулей Deckhouse.
  Для остальных модулей используйте [файл ресурсов установки](#файл-ресурсов-установки).
...
- `ModuleConfig` — набор ресурсов, содержащих параметры [конфигурации Deckhouse](../DECKHOUSE_CONFIGURE_RU.md).
...
Внимание! В файле ресурсов установки нельзя использовать [ModuleConfig](../DECKHOUSE_CONFIGURE_RU.md) для встроенных модулей. Для конфигурирования встроенных модулей используйте [файл конфигурации](#файл-конфигурации-установки).
