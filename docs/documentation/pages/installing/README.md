...
{% alert level="info" %}
When installing the Enterprise Edition of Deckhouse from the official container registry `registry.deckhouse.io`, you must first authenticate using a license key:
