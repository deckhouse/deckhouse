...
1. Скачайте образы Deckhouse в выделенную директорию, используя команду `dhctl mirror`.
   ...
   Начиная с версии 1.59, `dhctl mirror` поддерживает разделение пакета образов на фрагменты произвольного размера вместо упаковки всех образов в один tar-файл.
