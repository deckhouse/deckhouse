...
Так же, стоит избегать использования **CloudEphemeral** нод. В противном случае может произойти ситуация, когда целевой ноды нет в кластере и заказ её по какой-то причине невозможен.
