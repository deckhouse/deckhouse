...
1. Запустите установщик Deckhouse версии 1.58.6 или выше.
   ...
   Обратите внимание, что в контейнер установщика монтируется директория с файловой системы хоста, в которую будут загружены образы Deckhouse и сгенерированы манифесты [DeckhouseReleases](https://deckhouse.ru/documentation/v1/modules/002-deckhouse/cr.html#deckhouserelease).
