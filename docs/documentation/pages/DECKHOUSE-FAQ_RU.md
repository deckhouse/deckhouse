...
1. После загрузки образов в изолированный приватный registry, воспользуйтесь [инструкцией](deckhouse-faq.html#как-создать-кластер-и-запустить-deckhouse-без-использования-каналов-обновлений) для правильной настройки конфигурации установщика и ресурса `InitConfiguration`.
