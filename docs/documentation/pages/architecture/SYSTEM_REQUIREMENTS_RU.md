...
* **В существующем кластере Kubernetes**. Установщик разворачивает DP и интегрирует его с текущей инфраструктурой. Для оценки ресурсов существующего кластера, необходимых для функционирования платформы, можно воспользоваться руководствами для bare-metal серверов, упомянутыми выше. Кластер Kubernetes, в котором устанавливается DP, должен быть версии из [списка поддерживаемых](/products/kubernetes-platform/documentation/v1/reference/supported_versions.html#kubernetes).
