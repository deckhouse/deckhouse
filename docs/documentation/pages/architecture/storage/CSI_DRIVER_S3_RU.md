...
description: Архитектура CSI-драйвера для работы с томами на основе S3-хранилища в Deckhouse Kubernetes Platform.
---
...
![Архитектура CSI-драйвера (rbd)](../../../images/architecture/storage/c4-l2-csi-driver-s3.ru.png)
