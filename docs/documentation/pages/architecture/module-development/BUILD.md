...
permalink: en/architecture/module-development/build/
---
...
Module artifacts will be uploaded to `ghcr.io/<OWNER>/modules/`, which will serve as [module source](/reference/api/cr.html#modulesource).
