...
1. Create a [ModuleSource](/reference/api/cr.html#modulesource) resource in the cluster (specify the container registry address and authentication string).
...
1. Create a [ModuleUpdatePolicy](/reference/api/cr.html#moduleupdatepolicy) resource that defines the module update policy.
...
1. Confirm that the new [ModuleRelease](/reference/api/cr.html#modulerelease) objects have been created for the module:
