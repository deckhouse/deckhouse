...
- `critical` — *Булевый.* Помечает модуль как критический для начальной инициализации кластера. Критические модули запускаются в процессе начальной загрузки кластера, до того как кластер считается полностью готовым к работе. Некритические (функциональные) модули запускаются только после завершения начальной загрузки. По умолчанию — `false`.
