...
#### Валидации x-deckhouse-validations
...
|---|---|---|
| `namespace` | Строка | Неймспейс, в котором будут развернуты компоненты модуля |
...
| `accessibility.editions.enabledInBundles` | Массив строк | Список наборов модулей, в которых модуль должен быть включен по умолчанию |
