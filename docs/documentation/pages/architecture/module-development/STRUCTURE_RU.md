...
В репозитории [шаблона модуля](https://github.com/deckhouse/modules-template/) можно найти примеры хуков на Python. Примеры хуков на Go можно найти в [SDK](https://github.com/deckhouse/module-sdk/tree/main/examples).
