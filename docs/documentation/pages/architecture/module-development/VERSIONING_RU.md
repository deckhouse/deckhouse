...
lang: ru
description: Семантическое версионирование, каналы обновлений и версионирование API для модулей Deckhouse Platform, включая этапы жизненного цикла модуля.
---

В Deckhouse Platform (DP) используется принцип [семантического версионирования](https://semver.org/lang/ru/) для модулей.
...
Модули в DP используют кастомные ресурсы для взаимодействия с пользователями. Параметр `apiVersion` с версией API этих ресурсов обновляется в соответствии со следующими правилами:
