...
Deckhouse Kubernetes Platform (DKP) supports both built-in modules and modules that can be fetched from a [module source](/reference/api/cr.html#modulesource). This section details what the DKP module is and how it works.
