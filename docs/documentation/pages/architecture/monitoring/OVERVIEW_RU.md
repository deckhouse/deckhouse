...
| **prometheus-longterm**     | Дополнительный Prometheus, хрнящий выборку разреженных данных из основного prometheus-main                                                                                                                                                                                                      |
...
| **trickster**               | Кэширующий прокси, снижающий нагрузку на Prometheus. В ближайшем времени будет depecated.                                                                                                                                                                                                       |
