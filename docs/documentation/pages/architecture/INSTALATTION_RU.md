---
title: "Установка"
permalink: ru/architecture/installation.html
lang: ru
---
...
По умолчанию функциональность приоритетов может быть включена или выключена в разных наборах (например, Default, Managed, Minimal).

Включить или отключить приоритеты можно двумя способами:
