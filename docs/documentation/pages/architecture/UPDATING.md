...
<div class="tabs-block">
   <ul class="tabs__container tabs__container--title">
      <li class="tabs__item tabs__item--title" data-index="1">Alpha</li>
      <li class="tabs__item tabs__item--title" data-index="2">Beta</li>
      <li class="tabs__item tabs__item--title" data-index="3">Early Access</li>
      <li class="tabs__item tabs__item--title" data-index="4">Stable</li>
      <li class="tabs__item tabs__item--title" data-index="5">Rock Solid</li>
   </ul>

   <ul class="tabs__container tabs__container--descr">
    <li class="tabs__item tabs__item--descr" data-index="1">
