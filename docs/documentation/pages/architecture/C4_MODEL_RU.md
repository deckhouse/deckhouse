...
* **Разработчик** - использует платформу для установки и тестирования разработываемых приложений.
...
{% alert level="info" %}
Чтобы расссмотреть диаграммы в увеличенном масштабе, кликните по нужному изображению правой кнопкой мыши и выберите `Открыть изображение в новой вкладке` или `Сохранить изображение как`.
{% endalert %}
