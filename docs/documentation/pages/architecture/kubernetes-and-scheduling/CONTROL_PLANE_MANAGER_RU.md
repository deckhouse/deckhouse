...
{% alert level="info" %}
1. Чтобы рассмотреть диаграммы в увеличенном масштабе, кликните по нужному изображению правой кнопкой мыши и выберите `Открыть изображение в новой вкладке` или `Сохранить изображение как`.
