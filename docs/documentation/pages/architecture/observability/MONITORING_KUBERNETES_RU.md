...
Подробнее с возможностями и настройками модуля можно ознакомиться [в разделе документации модуля](/modules/monitoring-kubernetes/configuration.html).
...
![Архитектура модуля monitoring-kubernetes](../../images/architecture/observability/c4-l2-monitoring-kubernetes.ru.svg)
