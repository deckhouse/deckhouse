...
lang: ru
search: кеширование DNS, DNS в кластере, оптимизация DNS
description: Особенности использования кеширующего DNS-сервера в Deckhouse Platform для устранения сетевых задержек.
---
...
В Deckhouse Platform это реализуется с помощью модуля [`node-local-dns`](/modules/node-local-dns/).
