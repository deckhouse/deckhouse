...
lang: ru
search: архитектура приложения, istio
description: Архитектура прикладного сервиса с включенным Istio в Deckhouse Kubernetes Platform.
---
...
* **Sidecar-proxy**:
  Каждый под прикладного сервиса получает дополнительный контейнер — sidecar-proxy, содержащий два приложения:
