...
* [**Системные требования**](system-requirements/) — описание требований, необходимых для функционирования платформы.
 ...
 * Cобственно, сам "ванильный" кластер Kubernetes.
 * Контроллер Deckhouse и управляемые им модули.
 * Bashible - агент, работающий как служба на узлах кластера, запускающий bash-скрипты для управления узлами. 
