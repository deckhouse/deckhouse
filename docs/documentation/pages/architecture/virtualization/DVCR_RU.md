...
![Архитектура компонента DVCR модуля virtualization](../../images/architecture/virtualization/c4-l2-virtualization-dvcr.ru.svg)
...
1. **Prometheus-main** — сбор метрик компонента dvcr.
