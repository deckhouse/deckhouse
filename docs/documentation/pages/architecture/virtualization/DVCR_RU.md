...
1. **Dvcr-importer** — *временный* под, состоящий из одного контейнера, запускаемый virtualization-controller для реализации различных сценариев импорта образов и дисков виртуальных машин, таких как:
   ...
   - импорт образа ВМ из ресурса VirtualImage/ClusterVirtualImage, VirtualDisk или VirtualDiskSnapshot в хранилище DVCR.
...
1. **Kube-apiserver** — выполняет get/list/watch запросы ресурсов VirtualImages/ClusterVirtualImage и VirtualDisks для очистки неиспользуемых образов и координации.
