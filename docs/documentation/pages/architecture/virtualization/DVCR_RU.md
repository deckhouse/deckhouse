...
1. **Dvcr-uploader** — *постоянный* под, состоящий из одного контейнера, запускаемый virtualization-controller для реализации следующих сценариев загрузки *пользователем* образов и дисков виртуальных машин:
...
1. **Cdi-importer** — использует хранящиеся в DVCR образы в качестве источника для ресурсов DataVolume.
