...
<div class="channel__list">
   ...
   <ul class="channel__container channel__container--descr">
      <li class="channel__item channel__item--descr" data-index="1">
         Наименее стабильный канал обновлений с наиболее частым появлением новых версий. Ориентирован на кластеры разработки с небольшим количеством разработчиков. Версии появляются сразу после выхода релиза.
      </li>
      <li class="channel__item channel__item--descr" data-index="2">
         Ориентирован на кластеры разработки, как и канал обновлений Alpha. Получает версии, предварительно опробованные на канале обновлений Alpha.
      </li>
      <li class="channel__item channel__item--descr" data-index="3">
         Рекомендуемый канал обновлений, если вы не уверены в выборе. Подойдет для активно развивающихся кластеров (запускаются, дорабатываются новые приложения и т. п.). Обновления публикуются не ранее чем через 7 дней после выхода релиза.
      </li>
      <li class="channel__item channel__item--descr" data-index="4">
         Стабильный канал для кластеров в эксплуатации. Обновления публикуются не ранее чем через 14 дней после выхода релиза.
      </li>
      <li class="channel__item channel__item--descr" data-index="5">
         Наиболее стабильный канал обновлений. Подойдет для кластеров, которым необходимо обеспечить повышенный уровень стабильности. Обновления публикуются не ранее чем через 30 дней после выхода релиза.
      </li>
   </ul>
</div>
