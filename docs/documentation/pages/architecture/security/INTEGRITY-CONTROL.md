...
Runtime security auditing in DKP includes analyzing Linux kernel events and Kubernetes API audit events.
...
For more details on configuring runtime security audit, refer to [Runtime security audit](../../admin/configuration/security/events/runtime-audit.html).
