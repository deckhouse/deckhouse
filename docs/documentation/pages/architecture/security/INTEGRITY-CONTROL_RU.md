...
Аудит безопасности рантайма в DKP включает в себя анализ событий ядра Linux и аудита событий API Kubernetes. Это позволяет отслеживать, что приложения в подах работают в неизменном виде, соответствуют ожидаемому состоянию и не были модифицированы.
...
Подробнее о настройках аудита безопасности рантайма можно почитать в разделе [«Аудит безопасности рантайма»](../../admin/configuration/security/events/runtime-audit.html).
