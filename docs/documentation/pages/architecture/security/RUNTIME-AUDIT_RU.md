...
Подробнее с архитектурой модуля [`runtime-audit-engine`](/modules/runtime-audit-engine/), реализующего аудит событий безопасности DKP, можно ознакомиться [в разделе с описанием архитектуры модуля](./runtime-audit-engine.html).
