...
Рекомендуемая последовательность публикации версии модуля [в каналах обновлений](/products/kubernetes-platform/documentation/v1/architecture/updating.html/#каналы-обновлений):
