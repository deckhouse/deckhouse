...
Модуль [`chrony`](/modules/chrony/) обеспечивает синхронизацию времени на всех узлах кластера Deckhouse Kubernetes Platform (DKP) с использованием [chrony](https://chrony.tuxfamily.org/).
