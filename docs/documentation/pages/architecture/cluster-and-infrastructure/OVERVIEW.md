...
description: Architecture of the Cluster & Infrastructure subsystem in Deckhouse Platform.
extractedLinksOnlyMax: 0
extractedLinksMax: 0
---

This section describes the architecture of the Cluster & Infrastructure subsystem of the Deckhouse Platform (DP).
...
* The mechanisms for managing all node types used in DP, as well as [hybrid node groups and clusters](node-management/hybrid-nodegroups-and-clusters.html).
...
* Modules for cloud providers supported by DP:
