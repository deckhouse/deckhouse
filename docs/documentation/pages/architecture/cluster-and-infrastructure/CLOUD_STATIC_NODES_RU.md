...
permalink: ru/architecture/cluster-and-infrastructure/cloud-static-nodes.html
lang: ru
...
![Архитектура модуля node-manager для CloudStatic-узлов](../../../images/architecture/cluster-and-infrastructure/c4-l2-cloud-static-nodes.png)
