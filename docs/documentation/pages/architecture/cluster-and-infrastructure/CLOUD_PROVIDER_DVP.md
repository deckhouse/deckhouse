...
The Level 2 C4 architecture of the [`cloud-provider-dvp`](/modules/cloud-provider-dvp/) нmodule and its interactions with other components of Deckhouse Kubernetes Platform (DKP) are shown in the following diagram:
