...
permalink: ru/architecture/cluster-and-infrastructure/terraform-manager.html
lang: ru
...
![Архитектура модуля terraform-manager](../../../images/architecture/cluster-and-infrastructure/c4-l2-terraform-manager.png)
