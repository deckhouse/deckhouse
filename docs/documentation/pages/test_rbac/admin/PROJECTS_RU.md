...
Платформа Deckhouse позволяет создавать собственные шаблоны проектов. Встроенные шаблоны проектов охватывают базовые сценарии использования и служат образцом для разработки собственных шаблонов.
