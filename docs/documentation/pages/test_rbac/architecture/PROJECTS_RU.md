...
- `default` — шаблон для базовых сценариев использования проектов. Особенности шаблона:
  ...
  * настройка оповещений и сбора логов;
...
Платформа Deckhouse позволяет настраивать доступ пользователей к различным платформам на уровне проектов и проектных пространств имён.

Для каждого проекта можно задать, к каким именно платформам он предоставляет доступ: только к Deckhouse Kubernetes Platform, только к Deckhouse Virtualization Platform или ко всем сразу. Пользователям и группам, добавленным в проект или пространство имён, назначаются роли, которые определяют уровень доступа к выбранным платформам.

Таким образом, проекты и проектные пространства имён позволяют гибко разграничивать, кто и как может использовать возможности разных платформ, обеспечивая как безопасность, так и удобство при совместной работе над инфраструктурой.
