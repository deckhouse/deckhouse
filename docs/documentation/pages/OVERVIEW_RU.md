...
## тест переиспользования

<script type="application/x-module-include">
{
  "module": "operator-trivy",
  "artifact": "feature-test1.html",
  "channel": "alpha",
  "onError": "fallback",
  "fallback": "Для отображения документации по настройке локального хранилища необходимо включить модуль [local-path-provisioner](/modules/local-path-provisioner/)"
}
</script>

## КОНЕЦ теста переиспользования
