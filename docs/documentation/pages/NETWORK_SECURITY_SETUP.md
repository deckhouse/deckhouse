...
If the infrastructure where Deckhouse Platform Certified Security Edition is running has requirements to limit network communication, the following conditions must be met:
