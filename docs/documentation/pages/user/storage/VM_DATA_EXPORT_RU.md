...
permalink: ru/user/storage/vm-data-export.html
...
> Чтобы импортировать скачанный диск обратно в кластер, загрузите его как [образ](../virtualization/images.html#загрузка-образа-из-командной-строки) или как [диск](vm-disks.html#загрузка-диска-из-командной-строки).
