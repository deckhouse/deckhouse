...
Гостевой агент QEMU в такую ОС поставить можно, из архивного выпуска virtio-win, и ВМ действительно покажет `AgentReady`, но его версия слишком старая для Deckhouse Platform (DP). У ВМ появляется условие `AgentVersionNotSupported`, сведения о гостевой ОС не собираются, а обновить агента не на что.
