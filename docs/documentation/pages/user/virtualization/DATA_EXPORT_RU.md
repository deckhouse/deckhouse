...
Экспортировать диски и снимки дисков виртуальных машин (ВМ) можно с помощью утилиты `d8` (версия 0.20.7 и выше). Для работы этой функции должен быть включён модуль [`storage-volume-data-manager`](/modules/storage-volume-data-manager/).
