...
Снимки позволяют зафиксировать текущее состояние ресурса для последующего восстановления или [клонирования](vm-cloning.html). Снимок диска сохраняет только данные выбранного диска, а снимок виртуальной машины включает в себя параметры ВМ и состояние всех её дисков.
