...
{% alert level="info" %}
Когда вы меняете правила размещения у работающей машины, а её текущий узел новым требованиям больше не отвечает, в коммерческих редакциях Deckhouse Platform (DP) переносит машину живой миграцией, а в DP Open изменения применяются только после перезагрузки. Машина, которая новым требованиям и так отвечает, остаётся на месте.
{% endalert %}
