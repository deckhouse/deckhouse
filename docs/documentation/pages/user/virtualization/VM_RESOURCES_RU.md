...
![Схема влияния coreFraction на гарантированную долю процессорного времени](../../images/virtualization/vm-corefraction.ru.png)

### Автоматический coreFraction (Auto)

Долю процессорного времени DP может подбирать сам, следя за тем, сколько машина потребляет.
