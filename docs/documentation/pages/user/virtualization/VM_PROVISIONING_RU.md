...
При первом запуске виртуальной машины (ВМ) гостевая система настраивается сценарием начальной инициализации, а дальше DP общается с ней через агента гостевой ОС.
