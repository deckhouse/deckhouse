...
Обзор инструментов безопасности платформы подробно разобран в курсе [«Инструменты безопасности в Deckhouse Kubernetes Platform»](https://deckhouse.ru/courses/security-tools-in-dkp/) в [Deckhouse Академии](https://deckhouse.ru/academy/).
...
Для каждого контейнера в многоконтейнерной нагрузке [operator-trivy](/modules/operator-trivy/) создаёт отдельный ресурс VulnerabilityReport в пространстве имён соответствующей нагрузки.  
...
Для каждого контейнера в многоконтейнерной рабочей нагрузке [operator-trivy](/modules/operator-trivy/) создаёт отдельный ExposedSecretReport в пространстве имён рабочей нагрузки. Связь с ресурсом Kubernetes осуществляется через `ownerReference`.
...
Для многоконтейнерной рабочей нагрузки [operator-trivy](/modules/operator-trivy/) создаёт отдельный ресурс SbomReport для каждого контейнера.  
