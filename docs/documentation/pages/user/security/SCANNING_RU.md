...
Для просмотра результатов сканирования вашего приложения воспользуйтесь интерфейсом Deckhouse Console (раздел `Система / Управление системой / Безопасность / Уязвимости / По рабочим нагрузкам`).
