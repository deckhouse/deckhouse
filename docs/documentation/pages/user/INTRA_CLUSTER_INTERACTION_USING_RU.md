...
Они обеспечивают балансировку нагрузки между подами, стабильность сетевого взаимодействия, поддержку различных сценариев доступа, интеграции с DNS для удобного обнаружения сервисов, изоляции и безопасность сетевого взаимодействия.

При этом вы можете пользоваться стандартным балансировщиком на базе сервисов или расширенным.
...
## Использование расширенного балансировщика

В Deckhouse Kubernetes Platform для обеспечения отказоустойчивости сервисов и контроля их состояния можно использовать модуль service-withHealth-check.
...
### Возможности расширенного балансировщика
...
Настроить данный способ балансировки можно при помощи ресурса [ServiceWithHealthchecks](../reference/cr/servicewithhealthchecks/):
...
[Примеры использования](#использование-расширенного-балансировщика).

### Внутреннее устройство расширенного балансировщика
