...
Имя Application (`metadata.name`) должно быть **не более 32 символов** — Application с более длинным именем будет отклонён при создании. По возможности не превышайте 24 символа: все поды получают префикс из имени экземпляра, и 24 символа имени экземпляра + 24 символа имени ресурса + 15 символов суффикса Deployment укладываются в ограничение Kubernetes на имя пода в 63 символа.
