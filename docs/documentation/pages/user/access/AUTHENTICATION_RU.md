...
- пароль не соответствует [политике сложности](../../admin/configuration/access/authentication/local.html#настройка-парольной-политики);
- истёк срок действия пароля согласно [политике ротации](../../admin/configuration/access/authentication/local.html#настройка-парольной-политики);
- администратор инициировал принудительную смену пароля.

На форме нужно указать текущий пароль, новый пароль и подтверждение. Новый пароль должен соответствовать парольной политики кластера.
