...
Если в кластере настроена [локальная аутентификация](../../admin/configuration/access/authentication/local.html), пользователь может сменить или сбросить пароль самостоятельно.
