...
description: "Configuring request retries for HTTP requests using Istio in Deckhouse Platform. VirtualService configuration with retry parameters, attempts, perTryTimeout."
