...
description: "Настройка Network Load Balancer в Deckhouse Platform. Балансировка TCP/UDP трафика с использованием Service LoadBalancer. Примеры настройки общего IP-адреса и портов для сервисов."
