...
description: "Организация внутрикластерного взаимодействия в Deckhouse Platform через Service. Стандартная балансировка нагрузки и расширенная балансировка с модулем service-with-healthchecks."
permalink: ru/user/network/intra-cluster.html
lang: ru
---

Для организации внутрикластерного взаимодействия в Deckhouse Platform рекомендуется использовать сервисы вместо обращения напрямую к подам.
