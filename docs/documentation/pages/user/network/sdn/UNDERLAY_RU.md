...
Подробнее о возможностях и особенностях работы с Underlay-сетями в DP — в разделе [«Настройка и подключение underlay-сетей для проброса аппаратных устройств»](../../../admin/configuration/network/sdn/configure.html#настройка-и-подключение-underlay-сетей-для-проброса-аппаратных-устройств).
