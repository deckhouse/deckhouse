...
Подробнее о возможностях и особенностях работы с Underlay-сетями в DKP — в разделе [«Настройка и подключение underlay-сетей для проброса аппаратных устройств»](../../../admin/configuration/network/sdn/configure.html#настройка-и-подключение-underlay-сетей-для-проброса-аппаратных-устройств).
...
1. Убедиться, что администратор добавил на ваш неймспейс [лейбл для использования Underlay-сетей](../../../admin/configuration/network/sdn/configure.html#подготовка-неймспейса-для-использования-underlaynetwork).
