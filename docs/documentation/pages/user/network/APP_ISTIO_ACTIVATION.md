...
description: "Enabling Istio for applications in Deckhouse Platform. Adding sidecar containers via sidecar injector. Using istio-injection labels and annotations for traffic management."
