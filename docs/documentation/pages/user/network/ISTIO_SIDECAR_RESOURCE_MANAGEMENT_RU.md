...
description: "Управление ресурсами istio-proxy сайдкаров в Deckhouse Platform. Настройка CPU и memory limits через аннотации sidecar.istio.io для отдельных рабочих нагрузок."
