---
title: "Настройка Circuit Breaker"
description: "Настройка Circuit Breaker с использованием Istio в Deckhouse Platform. Управление ограничениями TCP-соединений, таймаутами запросов и исключением проблемных эндпоинтов через DestinationRule."
permalink: ru/user/network/circuit-breaker.html
lang: ru
---

В Deckhouse Platform механизм Circuit Breaker реализуется средствами Istio (модуль [istio](/modules/istio/)) и обеспечивает следующие возможности:
