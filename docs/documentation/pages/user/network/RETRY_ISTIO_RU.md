...
description: "Настройка повторных попыток (retry) для HTTP запросов с использованием Istio в Deckhouse Platform. Конфигурация VirtualService с параметрами retries, attempts, perTryTimeout."
