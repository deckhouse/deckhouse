...
В Deckhouse Kubernetes Platform Canary deployment может быть реализован средствами [ingress-nginx](../../modules/ingress-nginx/) или [istio](../../modules/istio/) (рекомендованный способ).
