...
description: "Веб-интерфейс Hubble для визуализации сетевых взаимодействий в Deckhouse Platform. Анализ трафика между подами и сервисами, выявление сетевых проблем, работа с модулем cilium-hubble."
...
- временный лейбл потока (столбец «Timestamp»).
