...
description: "Web interface for downloading Deckhouse CLI (d8) in Deckhouse Platform. Centralized access to Deckhouse CLI executable files for Linux, macOS, Windows with update notifications."
