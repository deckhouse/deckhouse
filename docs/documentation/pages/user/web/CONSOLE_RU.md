...
В правом верхнем углу по нажанию кнопка «Создать» доступно создание новых групп узлов.
...
Предназначен для управления локальными томами. Содержит четыре подраздела для управления пулами, группами томов, логческими томами и блочными устройствами.
