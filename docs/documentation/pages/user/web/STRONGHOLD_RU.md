...
Веб-интерфейс модуля `stronghold` предназначен для управления механизмами секретов, аутентификацией и контролем доступа в кластере.
...
1. Для сохранения механизма нажмите «Enable Engine».
   Для отмены и возврата нажмите «Back».
...
1. Для сохранения метода нажмите «Enable Method».
   Для отмены и возврата к выбору метода нажмите «Back».
...
1. Для сохранения группы нажмите «Create».
   Для отмены и возврата к списку групп нажмите «Back».
