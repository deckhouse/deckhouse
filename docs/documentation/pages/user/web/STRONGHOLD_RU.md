...
![Authentication Methods](../../images/stronghold/authentication-methods.png)
...
![List of method](../../images/stronghold/list-method.png)
...
![Info method](../../images/stronghold/info-method.png)

Чтобы добавить метод аутентификации:

![Method](../../images/stronghold/method.png)
...
1. Выберите необходимый метод из списка и нажмите «Next».
    ...
    ![Choice method](../../images/stronghold/choice-method.png)
...
![Add method](../../images/stronghold/add-method.png)

#### Работа с группами пользователей

Для работы с группами пользователей откройте раздел **«Groups»** в меню слева.

![Groups](../../images/stronghold/groups.png)
...
![Create group](../../images/stronghold/create-group.png)
...
![ACL policies](../../images/stronghold/acl-policies.png)
