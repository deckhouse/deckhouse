...
description: "Веб-интерфейс для загрузки Deckhouse CLI (d8) в Deckhouse Platform. Централизованный доступ к исполняемым файлам Deckhouse CLI для Linux, macOS, Windows с уведомлениями об обновлениях."
