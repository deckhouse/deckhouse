...
description: "Настройка мультитенантности в Deckhouse Kubernetes Platform. Создание изолированных проектов с квотами ресурсов, политиками безопасности и сетевой изоляцией. Использование ProjectTemplate для управления окружениями."
