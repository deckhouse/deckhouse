...
Подробнее с шаблонами проектов и порядком их создания можно ознакомиться [в разделе «Администрирование»](../../admin/multitenancy.html).
...
Если при создании или изменении ресурса появляется сообщение вида `resource <RESOURCE_NAME> is not available to project <PROJECT_NAME>`, указанный cluster-wide-ресурс недоступен проекту. Выберите доступный ресурс из соответствующего AvailableClusterResource или попросите администратора кластера добавить его.
