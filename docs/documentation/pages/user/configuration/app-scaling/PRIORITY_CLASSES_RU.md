...
Подробнее о механизмах защиты от вытеснения смотрите [в разделе «Защита пода от вытеснения»](/products/kubernetes-platform/documentation/v1/admin/configuration/app-scaling/pod-eviction/priority-classes.html#защита-пода-от-вытеснения). В подразделе «Демонстрация защиты Stateful-приложения» показан практический сценарий, в котором эти механизмы работают вместе.
