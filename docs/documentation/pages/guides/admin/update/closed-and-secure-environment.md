...
7. Выйдите из запущенного контейнера.
...
ФСТЭК своя редакция и свой сценарий.
...
### Загрузка образов в изолированный репозитрий образов контейнеров
...
{% alert level="warning" %}
Релизный циклы модулей и платфомы не совпадают - модуль может обновляться чаще, чем версия платформы.
{% endalert %}
