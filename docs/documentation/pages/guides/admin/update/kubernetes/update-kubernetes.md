...
* `Automatic` – тогда DKP будет обновлять версию Kubernetes на узлах в соответствии с версией Kubernetes в релизе DKP. Посмотреть поддерживающиеся версии можно на [странице](https://deckhouse.io/documentation/v1/supported_versions.html).
