...
Deckhouse CLI — это интерфейс командной строки для работы с кластерами Deckhouse Kubernetes Platform (DKP). Начиная с релиза 1.59, он автоматически устанавливается на все узлы кластера вместе с платформой.

Утилиту можно также [установить](#как-установить-deckhouse-cli) на любую машину и использовать для работы с любыми кластерами.
...
* `d8 v` — команды, отвечающие за работу с виртуальными машинами, созданными Deckhouse Virtualization Platform (https://deckhouse.ru/modules/virtualization/stable/).  
