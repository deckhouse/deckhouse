...
Deckhouse управляется с помощью глобальных настроек, настроек модулей и различных кастомных ресурсов.
...
После сохранения изменений DKP приведёт конфигурацию кластера в соответствие с указанными параметрами. В зависимости от размеров кластера это может занять некоторое время.
