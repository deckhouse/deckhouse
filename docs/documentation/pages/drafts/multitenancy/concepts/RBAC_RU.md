...
Эффективные права в конкретном пространстве имён рассчитываются как пересечение роли пользователя и возможностей проекта/пространства имён. Это позволяет скрывать ресурсы, не относящиеся к активным возможностям проекта.
