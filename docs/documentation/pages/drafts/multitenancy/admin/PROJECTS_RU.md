...
DKP поддерживает совместимость с Kubernetes, расширяя механизм неймспейса при использовании [проектов](concepts.html#проект), и позволяет автоматически мигрировать существующие неймспейсы в проекты.
...
DKP может автоматически создавать новые [проекты](../concepts/glossary.html#проект) из существующих [неймспейсов](../concepts/glossary.html#пространство-имён). Для этого пометьте необходимые неймспейсы аннотацией `projects.deckhouse.io/adopt`. Например:
