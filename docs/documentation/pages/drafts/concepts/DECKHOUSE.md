...
permalink: en/architecture/overview.html
---
...
Deckhouse Platform automatically configures and manages both the [cluster nodes](/modules/node-manager/) and the  [control plane](/modules/control-plane-manager/) components, keeping their configuration up-to-date (using Terraform tools).
