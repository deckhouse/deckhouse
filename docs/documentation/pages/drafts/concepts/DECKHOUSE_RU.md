---
title: Обзор
permalink: ru/architecture/overview.html
lang: ru
...
Для этого Deckhouse Platform автоматически настраивает и управляет как [узлами кластера](/modules/node-manager/), так и его компонентами [control plane](/modules/control-plane-manager/), постоянно поддерживая их актуальную конфигурацию (используя инструменты Terraform).
