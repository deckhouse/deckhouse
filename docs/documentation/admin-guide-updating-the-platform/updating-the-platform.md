...
- Поддержка версий Kubernetes
    Обновление кластеров Kubernetes - порядок обновлений компонентов, разброс по версиям, надо ли?
    Обновление Kubernetes в кластере DKP - какие еще есть автоматизации? какие есть автотесты, которые может использовать администратор?
