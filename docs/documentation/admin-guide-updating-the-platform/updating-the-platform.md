...
Поддержка версий Kubernetes
  Обновление кластеров Kubernetes - надо?
  Поддержка инструментов разработчика при обновлении - надо?
  Обновление Kubernetes в кластере DKP - есть ли еще атоматизации кроме обновления Кубера?
Мониторинг обновлений - автотесты, может добавим?

Оглавление. Переосмысление:
- [readme][search info] Гарантия совместимости при обновлении - мы гарантируем такие обновления
- [readme][search info] Единые обновления и ""фундамента"" и ""узлов"" и ""решений" - автоматизация DKP по всем фронтам обновлений
...
- [search info] Полностью автоматический процесс обновления (и четкий контракт с разработчиками) - работа с разработчиком-пользователем
