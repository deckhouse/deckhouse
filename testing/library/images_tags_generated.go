...
var DefaultImagesDigests = map[string]interface{}{
	...
	"cloudProviderOpenstack": map[string]interface{}{
		"capiOpenstackController":   "imageHash-cloudProviderOpenstack-capiOpenstackController",
	...
	"cloudProviderOvirt": map[string]interface{}{
		"capiOvirtController": "imageHash-cloudProviderOvirt-capiOvirtController",
	},
