...
var DefaultImagesDigests = map[string]interface{}{
	...
	"cniCilium": map[string]interface{}{
		...
		"conTestsAlpineCurlAlpineCurl": "imageHash-cniCilium-conTestsAlpineCurlAlpineCurl",
		"conTestsDisruptionDisruption": "imageHash-cniCilium-conTestsDisruptionDisruption",
		"conTestsJsonMockJsonMock":     "imageHash-cniCilium-conTestsJsonMockJsonMock",
