...
require (
	...
	github.com/flant/addon-operator v1.0.0-beta.5.0.20200311062949-13467bf778ef // branch: master
	github.com/flant/shell-operator v1.0.0-beta.8.0.20200311062449-51fe78fb661c // branch: master
