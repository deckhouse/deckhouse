...
func (hec *HookExecutionConfig) RunHook() {
	...
	Expect(values_validation.ValidateValues(hec.ValuesValidator, moduleName, hec.values.Values)).To(Succeed())
	By("Validating initial config values")
	Expect(values_validation.ValidateValues(hec.ValuesValidator, moduleName, hec.configValues.Values)).To(Succeed())
