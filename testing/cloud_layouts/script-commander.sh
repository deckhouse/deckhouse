...
function wait_alerts_resolve() {
  ...
  "D8NodeContainerdV2NotSupported" # This is normal for e2e tests for <1.35 clusters
  "D8NodeCgroupV2NotSupported" # This is normal for e2e tests for <1.35 clusters
  )
