...
const PublicDomainTemplateCheckName preflight.CheckName = "public-domain-template"

func (PublicDomainTemplateCheck) Description() string {
	return "publicDomainTemplate does not match clusterDomain"
}

func (PublicDomainTemplateCheck) Phase() preflight.Phase {
	return preflight.PhasePreInfra
}

func (PublicDomainTemplateCheck) RetryPolicy() preflight.RetryPolicy {
...
func PublicDomainTemplate(meta *config.MetaConfig) preflight.Check {
