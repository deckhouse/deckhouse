...
const CloudPrefixCheckName preflight.CheckName = "cloud-prefix"

func (CloudPrefixCheck) Description() string {
	return "validate cluster prefix for cloud provider"
}

func (CloudPrefixCheck) Phase() preflight.Phase {
	return preflight.PhasePreInfra
}

func (CloudPrefixCheck) RetryPolicy() preflight.RetryPolicy {
...
func CloudPrefix(metaConfig *config.MetaConfig) preflight.Check {
