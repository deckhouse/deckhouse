...
const CidrIntersectionStaticCheckName preflight.CheckName = "static-cidr-intersection"

func (CidrIntersectionStaticCheck) Description() string {
	return "cluster CIDRs do not intersect with static internal networks"
}

func (CidrIntersectionStaticCheck) Phase() preflight.Phase {
	return preflight.PhasePreInfra
}

func (CidrIntersectionStaticCheck) RetryPolicy() preflight.RetryPolicy {
...
func CidrIntersectionStatic(meta *config.MetaConfig) preflight.Check {
