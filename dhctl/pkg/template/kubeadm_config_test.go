...
func TestKubeadmConfigRendering(t *testing.T) {
	...
	t.Run("Feature Gates Full", testFeatureGatesFull)
	t.Run("API Server Configuration", testAPIServerConfiguration)
	t.Run("API Server Configuration Full", testAPIServerConfigurationFull)
	t.Run("Cluster Types", testClusterTypes)
	t.Run("Cluster Types Full", testClusterTypesFull)
	t.Run("Run Types", testRunTypes)
	t.Run("Run Types Full", testRunTypesFull)
	t.Run("Service Account Configuration", testServiceAccountConfiguration)
	t.Run("Service Account Configuration Full", testServiceAccountConfigurationFull)
	t.Run("ETCD Configuration", testETCDConfiguration)
	t.Run("ETCD Configuration Full", testETCDConfigurationFull)
	t.Run("Optional Arguments", testOptionalArguments)
	t.Run("Optional Arguments Full", testOptionalArgumentsFull)
	t.Run("Patches Rendering", testPatchesRendering)
	t.Run("Edge Cases", testEdgeCases)
	t.Run("Edge Cases Full", testEdgeCasesFull)
	t.Run("Missing Coverage", testMissingCoverage)
	t.Run("Missing Coverage Full", testMissingCoverageFull)
...
func testAPIServerConfigurationFull(t *testing.T) {
	tests := []struct {
		name       string
		k8sVersion string
	}{
...
func testClusterTypesFull(t *testing.T) {
	tests := []struct {
		name        string
		clusterType string
		expectCloud bool
...
func testRunTypesFull(t *testing.T) {
	tests := []struct {
		name                   string
		runType                string
...
func testServiceAccountConfigurationFull(t *testing.T) {
	versions := []string{"1.31", "1.32"}
...
func testETCDConfigurationFull(t *testing.T) {
	versions := []string{"1.31", "1.32"}
...
func testOptionalArgumentsFull(t *testing.T) {
	versions := []string{"1.31", "1.32"}
...
func testEdgeCasesFull(t *testing.T) {
	versions := []string{"1.31", "1.32"}
...
func testMissingCoverageFull(t *testing.T) {
	versions := []string{"1.31", "1.32"}
...
func testMissingCoverage(t *testing.T) {
	...
	t.Run("Feature Gates Version Boundaries", func(t *testing.T) {
		...
		// Should NOT include legacy feature gates for 1.31
		featureGatesRegex := regexp.MustCompile(`- name: feature-gates\s+value:\s*"([^"]+)"`)
		matches := featureGatesRegex.FindStringSubmatch(result)
		if len(matches) >= 2 {
			featureGates := matches[1]
			if strings.Contains(featureGates, "ValidatingAdmissionPolicy=true") {
				t.Error("Unexpected legacy feature gate found for Kubernetes 1.31")
			}
		}
	})
