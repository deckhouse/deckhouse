...
type AbortStart struct {
	...
	Options                       *AbortStartOptions `protobuf:"bytes,9,opt,name=options,proto3" json:"options,omitempty"`
}
...
var file_abort_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x64, 0x68, 0x63, 0x74, 0x6c,
