...
func SaveMasterNodeTerraformState(ctx context.Context, kubeCl *client.KubernetesClient, nodeName string, tfState []byte, dataDevices terraform.DataDevices) error {
	if len(tfState) == 0 {
		return ErrNoTerraformState
	}
