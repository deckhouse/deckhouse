...
func LoadConfigFromFile(paths []string, preparatorProvider MetaConfigPreparatorProvider, opts ...ValidateOption) (*MetaConfig, error) {
	metaConfig, err := ParseConfig(fs.RevealWildcardPaths(paths), preparatorProvider, opts...)
	if err != nil {
		return nil, err
	}
...
func ParseConfig(paths []string, preparatorProvider MetaConfigPreparatorProvider, opts ...ValidateOption) (*MetaConfig, error) {
	content := ""
	...
	return ParseConfigFromData(content, preparatorProvider, opts...)
}
...
func parseConfigFromCluster(ctx context.Context, kubeCl *client.KubernetesClient, preparatorProvider MetaConfigPreparatorProvider) (*MetaConfig, error) {
	...
	return metaConfig.Prepare(preparatorProvider)
}
...
func ParseConfigFromData(configData string, preparatorProvider MetaConfigPreparatorProvider, opts ...ValidateOption) (*MetaConfig, error) {
	schemaStore := NewSchemaStore()
