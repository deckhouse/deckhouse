...
masterNodeGroup:
  replicas: 1`,
			schema:      testSchemaStore(t),
			errContains: `ChangesValidationFailed: validation rule failed: can't reduce the number of master nodegroup replicas to 1, refer to instructions: https://deckhouse.io/documentation/v1/modules/040-control-plane-manager/faq.html#how-do-i-reduce-the-number-of-master-nodes-in-a-cloud-cluster-multi-master-to-single-master`,
		},
...
masterNodeGroup:
  ...
  instanceClass:
    imageID: bar`,
			schema:      testSchemaStore(t),
			errContains: `ChangesValidationFailed: validation rule failed: can't update .masterNodeGroup.imageID in multi master cluster, refer to instructions: https://deckhouse.io/documentation/v1/modules/040-control-plane-manager/faq.html#how-do-i-switch-to-a-different-os-image-in-a-multi-master-cluster`,
		},
...
masterNodeGroup:
  ...
  instanceClass:
    urn: bar`,
			schema:      testSchemaStore(t),
			errContains: `ChangesValidationFailed: validation rule failed: can't update .masterNodeGroup.urn in single master cluster, refer to instructions: https://deckhouse.io/documentation/v1/modules/040-control-plane-manager/faq.html#how-do-i-switch-to-a-different-os-image-in-a-single-master-cluster`,
		},
