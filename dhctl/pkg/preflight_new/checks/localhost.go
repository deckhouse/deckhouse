...
const LocalhostDomainCheckName preflightnew.CheckName = "resolve-localhost"

func (LocalhostDomainCheck) Description() string {
	return "resolve the localhost domain"
}

func (LocalhostDomainCheck) Phase() preflightnew.Phase {
	return preflightnew.PhasePostInfra
}

func (LocalhostDomainCheck) RetryPolicy() preflightnew.RetryPolicy {
	return preflightnew.DefaultRetryPolicy
}

func (LocalhostDomainCheck) Enabled() bool {
	return true
}
...
func LocalhostDomain(nodeInterface node.Interface) preflightnew.Check {
