...
const CloudSystemRequirementsCheckName preflightnew.CheckName = "cloud-master-system-requirements"

func (CloudSystemRequirementsCheck) Description() string {
	return "cloud master node system requirements are met"
}

func (CloudSystemRequirementsCheck) Phase() preflightnew.Phase {
	return preflightnew.PhasePreInfra
}

func (CloudSystemRequirementsCheck) RetryPolicy() preflightnew.RetryPolicy {
...
func CloudSystemRequirements(installConfig *config.DeckhouseInstaller) preflightnew.Check {
