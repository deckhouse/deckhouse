...
const StaticInstancesIPDuplicationCheckName preflightnew.CheckName = "static-instances-ip-duplication"

func (StaticInstancesIPDuplicationCheck) Description() string {
	return "static instances have unique addresses"
}

func (StaticInstancesIPDuplicationCheck) Phase() preflightnew.Phase {
	return preflightnew.PhasePreInfra
}

func (StaticInstancesIPDuplicationCheck) RetryPolicy() preflightnew.RetryPolicy {
...
func StaticInstancesIPDuplication(meta *config.MetaConfig) preflightnew.Check {
