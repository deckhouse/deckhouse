...
var (
	bashibleTemplateOpenAPI = os.Getenv("DECKHOUSE_ROOT") + "/deckhouse/candi/bashible/openapi.yaml"
	kubeadmTemplateOpenAPI  = os.Getenv("DECKHOUSE_ROOT") + "/deckhouse/candi/control-plane-kubeadm/openapi.yaml"
)
