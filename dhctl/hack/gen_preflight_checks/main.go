...
//go:generate go run ./main.go -out ../../pkg/app/options/preflight_known_checks.gen.go
...
func render(names []string) string {
	...
	fmt.Fprintln(&b, "package options")
	fmt.Fprintln(&b)
	...
	fmt.Fprintln(&b, "}")
	fmt.Fprintln(&b)
	fmt.Fprintln(&b, "// GeneratedChecks returns a copy of the auto-generated preflight check names.")
