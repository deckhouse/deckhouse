...
Please, refer to the project's [Getting started](https://deckhouse.io/gs/) to begin your journey with Deckhouse Platform. Choose the appropriate option for your infrastructure and follow the relevant step-by-step instructions to deploy your first Deckhouse Kubernetes cluster.

Also, check the [documentation](https://deckhouse.io/documentation/v1/deckhouse-overview.html) and the [guides](https://deckhouse.io/guides/production.html) section for details.
