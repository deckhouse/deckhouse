...
// TestChannels covers picking the channel tags out of a repository that also
// holds concrete versions. The result is ordered least stable first, whatever
// order the registry lists its tags in.
func TestChannels(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, []string{"alpha", "stable", "lts"}, channels)
}
