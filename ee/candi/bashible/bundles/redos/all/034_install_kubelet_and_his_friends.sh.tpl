...
bb-rp-install "kubernetes-cni:{{ index .images.registrypackages (printf "kubernetesCniRedos%s" $kubernetesCniVersion) | toString }}" "kubectl:{{ index .images.registrypackages (printf "kubectlRedos%s" $kubernetesVersion) | toString }}"
...
bb-rp-install "kubelet:{{ index .images.registrypackages (printf "kubeletRedos%s" $kubernetesVersion) | toString }}"
