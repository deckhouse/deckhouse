...
{% alert %}
Deckhouse использует `ens192`, как интерфейс по умолчанию для виртуальных машин в vSphere, поэтому при использовании статических IP-адресов в `mainNetwork` вы должны создать `ens192`, как стандартный в образе ОС.
{% endalert %}
