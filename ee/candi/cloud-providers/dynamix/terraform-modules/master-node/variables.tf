...
locals{
  ...
  account_id = lookup(var.providerClusterConfiguration, "accountId", null)
  os_image_id = lookup(var.providerClusterConfiguration, "osImageId", null)
  ...
  pool = lookup(var.providerClusterConfiguration, "pool", null)
  extnet_id = lookup(var.providerClusterConfiguration, "externalNetworkId", null)
  vins_id = lookup(var.providerClusterConfiguration, "vinsNetworkId", null)
  driver = "KVM_X86"
  net_type_vins = "VINS"
