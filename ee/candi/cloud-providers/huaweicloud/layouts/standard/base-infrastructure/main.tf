...
resource "huaweicloud_vpc_subnet" "subnet" {
  ...
  dhcp_enable       = true
  dns_list          = length(var.providerClusterConfiguration.standard.internalNetworkDNSServers) > 0 ? var.providerClusterConfiguration.standard.internalNetworkDNSServers : []
}
