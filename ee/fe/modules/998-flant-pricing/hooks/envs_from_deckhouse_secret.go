	...
	Kubernetes: []go_hook.KubernetesConfig{
		{
			...
			NameSelector:      &types.NameSelector{MatchNames: []string{"d8-deckhouse-flant-pricing"}},
...
func deckhouseSecret(input *go_hook.HookInput) error {
	...
	input.Values.Set("flantPricing.internal.bundle", string(ds.Bundle))
	input.Values.Set("flantPricing.internal.releaseChannel", string(ds.ReleaseChannel))
