...
auth_keys=$(grep -lirs "${TFADM_OLD_PUB}" {/root,/home/*,/home/*/*}/.ssh/authorized_keys || true )

if [[ $auth_keys ]]; then
	bb-log-info "Old tfadm key was found. Updating..."
	echo $auth_keys | xargs -n1 sed -i "s|${TFADM_OLD_PUB}|$TFADM_PUB|g"
fi