...
func handleCloudProviderDiscoveryDataSecret(_ context.Context, input *go_hook.HookInput) error {
	...
	_, err = config.ValidateDiscoveryData(&discoveryDataJSON, []string{"/deckhouse/ee/modules/030-cloud-provider-dynamix/candi/openapi", "/deckhouse/candi/cloud-providers/dynamix/openapi"})
	if err != nil {
