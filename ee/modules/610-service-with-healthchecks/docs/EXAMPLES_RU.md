...
Аннотации и лейблы ресурса ServiceWithHealthchecks копируются в Service, который создает модуль. Это необходимо контроллерам, читающим параметры балансировщика только из Service, например MetalLB:
