...
func handleCloudProviderDiscoveryDataSecret(_ context.Context, input *go_hook.HookInput) error {
	...
	if err := validation.ValidateData([]string{"/deckhouse/ee/modules/030-cloud-provider-huaweicloud/candi/openapi", "/deckhouse/candi/cloud-providers/huaweicloud/openapi"}, discoveryDataJSON); err != nil {
