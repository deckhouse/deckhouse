...
func allianceDeprecatedSubdomainBaseValues() string {
	return `{
  "global":{
...
var _ = Describe("Istio EE hooks :: alliance_metadata_endpoint_deprecated_subdomain :: alliance disabled", func() {
	f := HookExecutionConfigInit(allianceDeprecatedSubdomainBaseValues(), "")
...
var _ = Describe("Istio EE hooks :: alliance_metadata_endpoint_deprecated_subdomain :: multicluster deprecated subdomain", func() {
	f := HookExecutionConfigInit(allianceDeprecatedSubdomainBaseValues(), "")
	f.RegisterCRD("deckhouse.io", "v1alpha1", "IstioFederation", false)
	f.RegisterCRD("deckhouse.io", "v1alpha1", "IstioMulticluster", false)
...
`))
	...
	It("sets deprecated subdomain metric", func() {
		...
		Expect(m[0].Action).To(Equal(operation.ActionExpireMetrics))
		Expect(m[1].Name).To(Equal(DeprecatedSubdomainMetricName))
...
var _ = Describe("Istio EE hooks :: alliance_metadata_endpoint_deprecated_subdomain :: multicluster new host", func() {
	f := HookExecutionConfigInit(allianceDeprecatedSubdomainBaseValues(), "")
	f.RegisterCRD("deckhouse.io", "v1alpha1", "IstioFederation", false)
	f.RegisterCRD("deckhouse.io", "v1alpha1", "IstioMulticluster", false)
...
var _ = Describe("Istio EE hooks :: alliance_metadata_endpoint_deprecated_subdomain :: multicluster deprecated subdomain unrelated domain", func() {
	f := HookExecutionConfigInit(allianceDeprecatedSubdomainBaseValues(), "")
	f.RegisterCRD("deckhouse.io", "v1alpha1", "IstioFederation", false)
	f.RegisterCRD("deckhouse.io", "v1alpha1", "IstioMulticluster", false)
...
`))
	...
	It("detects deprecated subdomain by first DNS label, not publicDomainTemplate", func() {
		...
		Expect(m).To(HaveLen(2))
		Expect(m[1].Name).To(Equal(DeprecatedSubdomainMetricName))
		Expect(m[1].Labels["name"]).To(Equal("mc-deprecated-remote-tld"))
	})
})

var _ = Describe("Istio EE hooks :: alliance_metadata_endpoint_deprecated_subdomain :: federation deprecated subdomain", func() {
	f := HookExecutionConfigInit(allianceDeprecatedSubdomainBaseValues(), "")
	f.RegisterCRD("deckhouse.io", "v1alpha1", "IstioFederation", false)
	f.RegisterCRD("deckhouse.io", "v1alpha1", "IstioMulticluster", false)
