...
Также существует возможность добавить sidecar к индивидуальному поду в namespace без установленных лейблов `istio-injection=renabled` или `istio.io/rev=vXxYZ`, путем установки лейбла `sidecar.istio.io/inject: true`
