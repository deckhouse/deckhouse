...
* Mutual TLS:
  * Сервисы автоматически и достоверно аутентифицируют друг друга при помощи индивидуальных клиентских и серверных сертификатов.
...
* Circuit Breaker:
  ...
  * Исключение endpoint сервиса из балансировки если превышен лимит ошибок.
  * Настройка лимитов на количество TCP-соединений и количество запросов на endpoint сервиса.
* Sticky Sessions:
