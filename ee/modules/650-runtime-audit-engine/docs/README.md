...
* The minimum required Linux kernel version is 5.8.
* enabled [eBPF](https://www.kernel.org/doc/html/v5.8/bpf/btf.html). check `ls -lah /sys/kernel/btf/vmlinux` or in the kernel build parameters `CONFIG_DEBUG_INFO_BTF=y`.
