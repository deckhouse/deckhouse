...
* Enabled [eBPF](https://www.kernel.org/doc/html/v5.8/bpf/btf.html). Check with the command `ls -lah /sys/kernel/btf/vmlinux`, or find `grep "CONFIG_DEBUG_INFO_BTF=y" /boot/config-*` in the list of kernel build parameters.
