...
- правило, статично размещенное в контейнере `falco`, по пути `/etc/falco/k8s_audit_rules.yaml` — правила для аудита Kubernetes.
- правило, размещенное в формате custom resource [FalcoAuditRules](cr.html#falcoauditrules), `fstec` - правила аудита удовлетворяющие требованиям приказа ФСТЭК России №118 от 4 июля 2022г. (Требования по безопасности информации к средствам контейнеризации)
