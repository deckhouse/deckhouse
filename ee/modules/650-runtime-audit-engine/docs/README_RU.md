...
* Ядро Linux >= 5.8.
* Включённый [eBPF](https://www.kernel.org/doc/html/v5.8/bpf/btf.html). Проверьте командой `ls -lah /sys/kernel/btf/vmlinux`, либо найдите `grep "CONFIG_DEBUG_INFO_BTF=y" /boot/config-*` в списке параметров сборки ядра.
