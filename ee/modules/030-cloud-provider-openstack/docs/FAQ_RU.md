...
> При создании CloudEphemeral нод в Selectel стоит учесть, что для создания ноды в зоне отличной от зоны A, необходимо заранее создать flavor с диском необходимого размера, а параметр rootDiskSize указывать не нужно. Например, `openstack flavor create c4m8d50 --ram 8192 --disk 50 --vcpus 4 --private`.
