      ...
      providerClusterConfiguration:
        ...
        masterNodeGroup:
          instanceClass:
			...
			template: flant-df-lab_DC1/Ubuntu 22.04 Server (20231027)
          replicas: 1
`
...
var _ = Describe("Module :: cloud-provider-vcd :: helm template ::", func() {
	...
	BeforeSuite(func() {
		...
		err = os.Symlink("/deckhouse/ee/candi/cloud-providers/vsphere", "/deckhouse/ee/modules/030-cloud-provider-vcd/candi")
		Expect(err).ShouldNot(HaveOccurred())
	})
	...
	AfterSuite(func() {
		err := os.Remove("/deckhouse/ee/modules/030-cloud-provider-vcd/candi")
		Expect(err).ShouldNot(HaveOccurred())
		err = os.Symlink("/deckhouse/candi/cloud-providers/vsphere", "/deckhouse/ee/modules/030-cloud-provider-vcd/candi")
		Expect(err).ShouldNot(HaveOccurred())
	})
