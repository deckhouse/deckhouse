...
func handleCloudProviderDiscoveryDataSecret(_ context.Context, input *go_hook.HookInput) error {
	...
	_, err = config.ValidateDiscoveryData(&discoveryDataJSON, []string{"/deckhouse/ee/modules/030-cloud-provider-vcd/candi/openapi", "/deckhouse/candi/cloud-providers/vcd/openapi"})
	if err != nil {
