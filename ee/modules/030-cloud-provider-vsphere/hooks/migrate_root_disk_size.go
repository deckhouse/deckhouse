...
/*
Set rootDiskSize field for master nodegroup instance class and for all instance classes of another nodegroup
...
func needMigrateNodeGroupsInstanceClass(rawConfig map[string]interface{}) (bool, error) {
	...
	fieldForNG := []string{"instanceClass", "rootDiskSize"}
...
func needMigrateMasterInstanceClass(rawConfig map[string]interface{}) (bool, error) {
	fieldForMaster := []string{"masterNodeGroup", "instanceClass", "rootDiskSize"}
