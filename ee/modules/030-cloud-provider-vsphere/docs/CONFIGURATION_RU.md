...
<table>
  <thead>
    <tr>
        <th>Необходимые привилегии в vSphere API</th>
        <th>Описание</th>
    </tr>
  </thead>
  <tbody>
    <tr>
        ...
        <td>Для выделения дисков при создании виртуальных машин и заказе <code>PersistentVolumes</code> в кластере.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Для группировки кластера Deckhouse Kubernetes Platform в одном <code>Folder</code> в vSphere Inventory.</td>
    </tr>
    <tr>
        ...
        <td>Для управления жизненным циклом виртуальных машин кластера Deckhouse Kubernetes Platform.</td>
    </tr>
  </tbody>
</table>
