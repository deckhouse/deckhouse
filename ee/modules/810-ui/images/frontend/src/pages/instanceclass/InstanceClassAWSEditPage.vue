<template>
  ...
  <GridBlock>
    <CardBlock notice-placement="top">
      ...
      <template #content>
        <SelectButton v-model="mode" :options="modeOptions" optionLabel="name" optionValue="value" class="mb-10" />
        ...
        <div class="flex flex-wrap items-start -mx-24 -my-6">
          <div class="mx-24 my-6">
            ...
            <template v-if="mode == 'user'">
              ...
              <FieldGroupTitle
                title="Ресурсы"
                help="Укажите ресурсы для этого типа машин, чтобы cluster-autoscaler мог масштабировать группы узлов с нулевого размера (minPerZone=0)"
              />
      ...
      <template #notice> Используется в 3 группах узлов: <b>big-node-group, redis, oopyachka-node</b> </template>
    </CardBlock>
  </GridBlock>
