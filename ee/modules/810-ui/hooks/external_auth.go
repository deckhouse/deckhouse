...
var _ = external_auth.RegisterHook(external_auth.Settings{
	ExternalAuthPath:            "ui.auth.externalAuthentication",
	DexAuthenticatorEnabledPath: "ui.internal.deployDexAuthenticator",
	DexExternalAuth: external_auth.ExternalAuth{
		AuthURL:         "https://ui-dex-authenticator.d8-ui.svc.%CLUSTER_DOMAIN%/dex-authenticator/auth",
