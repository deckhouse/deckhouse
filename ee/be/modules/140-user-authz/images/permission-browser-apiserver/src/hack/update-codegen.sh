...
# Create symlink for code-generator to find the source files
# Code generator expects files at output-base/module-name/pkg/apis
# but our files are in src/pkg/apis, so we create a symlink
SYMLINK_PATH="${SCRIPT_ROOT}/../permission-browser-apiserver"
...
kube::codegen::gen_helpers \
    --input-pkg-root permission-browser-apiserver/pkg/apis \
    --output-base "${SCRIPT_ROOT}/.." \
    --boilerplate "${SCRIPT_ROOT}"/hack/boilerplate.go.txt

kube::codegen::gen_openapi \
    --input-pkg-root permission-browser-apiserver/pkg/apis \
    --output-pkg-root permission-browser-apiserver/pkg/generated \
    --output-base "${SCRIPT_ROOT}/.." \
