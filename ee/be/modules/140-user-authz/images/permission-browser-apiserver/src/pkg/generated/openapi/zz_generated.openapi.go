...
func schema_pkg_apis_authorization_v1alpha1_AccessibleNamespace(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AccessibleNamespace represents a namespace that the requesting user has access to. This is a read-only, computed resource similar to OpenShift Projects.\n\nLIMITATIONS: - Watch is NOT supported - clients must poll for updates - resourceVersion is always empty (\"\") - do not rely on it for caching - The list is computed at request time based on RBAC and multi-tenancy rules",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_authorization_v1alpha1_AccessibleNamespaceList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AccessibleNamespaceList is a list of accessible namespaces for the requesting user",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is the list of accessible namespaces",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("permission-browser-apiserver/pkg/apis/authorization/v1alpha1.AccessibleNamespace"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "permission-browser-apiserver/pkg/apis/authorization/v1alpha1.AccessibleNamespace"},
	}
}

func schema_pkg_apis_authorization_v1alpha1_BulkSubjectAccessReview(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BulkSubjectAccessReview checks whether a user or group can perform a set of actions. This resource is ephemeral - it is not stored, only created.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("permission-browser-apiserver/pkg/apis/authorization/v1alpha1.BulkSubjectAccessReviewSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "Status is filled in by the server and indicates whether the requests are allowed or not",
							Default:     map[string]interface{}{},
							Ref:         ref("permission-browser-apiserver/pkg/apis/authorization/v1alpha1.BulkSubjectAccessReviewStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "permission-browser-apiserver/pkg/apis/authorization/v1alpha1.BulkSubjectAccessReviewSpec", "permission-browser-apiserver/pkg/apis/authorization/v1alpha1.BulkSubjectAccessReviewStatus"},
	}
}

func schema_pkg_apis_authorization_v1alpha1_BulkSubjectAccessReviewSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BulkSubjectAccessReviewSpec is the specification for a bulk access review request",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"user": {
						SchemaProps: spec.SchemaProps{
					...
					"extra": {
						SchemaProps: spec.SchemaProps{
							Description: "Extra corresponds to the user.Info.GetExtra() method from the authenticator.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
					...
					"requests": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Requests is the list of resource access requests to check",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("permission-browser-apiserver/pkg/apis/authorization/v1alpha1.SubjectAccessReviewRequest"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"permission-browser-apiserver/pkg/apis/authorization/v1alpha1.SubjectAccessReviewRequest"},
	}
}

func schema_pkg_apis_authorization_v1alpha1_BulkSubjectAccessReviewStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BulkSubjectAccessReviewStatus contains the results of the access review",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"results": {
						VendorExtensible: spec.VendorExtensible{
						...
						SchemaProps: spec.SchemaProps{
							Description: "Results contains the authorization check results for each request, in the same order as spec.requests",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("permission-browser-apiserver/pkg/apis/authorization/v1alpha1.SubjectAccessReviewResult"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"permission-browser-apiserver/pkg/apis/authorization/v1alpha1.SubjectAccessReviewResult"},
	}
}
...
func schema_pkg_apis_authorization_v1alpha1_NonResourceAttributes(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NonResourceAttributes includes the authorization attributes for non-resource requests",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"path": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_authorization_v1alpha1_ResourceAttributes(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ResourceAttributes includes the authorization attributes available for resource requests",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"namespace": {
						SchemaProps: spec.SchemaProps{
							Description: "Namespace is the namespace of the action being requested.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"verb": {
						SchemaProps: spec.SchemaProps{
							Description: "Verb is a kubernetes resource API verb, like: get, list, watch, create, update, delete, proxy.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "Name is the name of the resource being requested for a \"get\" or deleted for a \"delete\".",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_authorization_v1alpha1_SubjectAccessReviewRequest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SubjectAccessReviewRequest contains the resource attributes for a single access check",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"resourceAttributes": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_authorization_v1alpha1_SubjectAccessReviewResult(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SubjectAccessReviewResult contains the result of a single authorization check",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"allowed": {
						SchemaProps: spec.SchemaProps{
							Description: "Allowed is true if the action would be allowed, false otherwise.",
							Default:     false,
							Type:        []string{"boolean"},
							Format:      "",
						},
					...
					"denied": {
						SchemaProps: spec.SchemaProps{
							Description: "Denied is true if the action is explicitly denied, false otherwise. A request might be denied even if not explicitly denied (e.g., no matching RBAC rules).",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					"reason": {
						SchemaProps: spec.SchemaProps{
							Description: "Reason is optional and indicates why a request was allowed or denied.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"evaluationError": {
						SchemaProps: spec.SchemaProps{
							Description: "EvaluationError contains any error that occurred during authorization check.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
