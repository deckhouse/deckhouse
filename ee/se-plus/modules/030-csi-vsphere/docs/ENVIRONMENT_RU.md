...
Предлагаемая ниже роль включает права, достаточные для всех компонентов DP. Детальный перечень привилегий описан в документации модуля [`cloud-provider-vsphere`](/modules/cloud-provider-vsphere/environment.html#список-необходимых-привилегий).
{% endalert %}
