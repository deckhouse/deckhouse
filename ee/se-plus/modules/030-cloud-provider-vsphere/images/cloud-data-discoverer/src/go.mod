...
require (
	...
	github.com/deckhouse/deckhouse/go_lib/dependency/vsphere v0.0.0
...
replace github.com/deckhouse/deckhouse/go_lib/dependency/vsphere => /deckhouse/go_lib/dependency/vsphere
