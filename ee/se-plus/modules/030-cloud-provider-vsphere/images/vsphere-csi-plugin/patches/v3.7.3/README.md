...
Bump go.mod dependencies to fix known CVEs and use the patched `github.com/akutz/gofsutil` (`replace` to `../gofsutil`):
- GO-2026-6061, GO-2026-6348, GO-2026-6441, GO-2026-6443: google.golang.org/grpc -> v1.83.2
- GO-2026-5158: go.opentelemetry.io/otel -> v1.44.0
