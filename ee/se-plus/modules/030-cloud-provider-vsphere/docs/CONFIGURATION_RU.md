...
Как добавлять и удалять узлы кластера, описано в документации модуля [`node-manager`](/modules/node-manager/faq.html), пример группы узлов для vSphere приведён в разделе [«Создание группы узлов»](examples.html#создание-группы-узлов).
