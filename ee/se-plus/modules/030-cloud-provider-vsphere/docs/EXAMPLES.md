...
To direct a service to a different address pool, describe a load balancer class in the [`nsxt.loadBalancerClass`](configuration.html#parameters-nsxt-loadbalancerclass) parameter and set it in the `loadbalancer.vmware.io/class` annotation of the service.
