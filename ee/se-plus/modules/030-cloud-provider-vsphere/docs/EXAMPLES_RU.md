...
Чтобы направить сервис в другой пул адресов, опишите класс балансировщика в параметре [`nsxt.loadBalancerClass`](configuration.html#parameters-nsxt-loadbalancerclass) и укажите его в аннотации `loadbalancer.vmware.io/class` сервиса.
