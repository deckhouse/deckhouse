module dhctl-provider-zvirt

go 1.25.11

require (
	github.com/deckhouse/deckhouse/ee/se-plus/modules/030-cloud-provider-zvirt/pkg v0.0.0-00010101000000-000000000000
...
replace (
	github.com/deckhouse/deckhouse/ee/se-plus/modules/030-cloud-provider-zvirt/pkg => /deckhouse/ee/se-plus/modules/030-cloud-provider-zvirt/pkg
