...
// CredentialSecretValues is the shape of one entry of internal.credentialSecrets, the map the
// templates read the zVirt login and password from. It matches the schema in openapi/values.yaml.
type CredentialSecretValues struct {
