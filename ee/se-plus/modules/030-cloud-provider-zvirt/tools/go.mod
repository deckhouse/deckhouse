...
require (
	github.com/deckhouse/deckhouse/ee/se-plus/modules/030-cloud-provider-zvirt/pkg v0.0.0
	openapigen v0.0.0
)
...
replace (
	github.com/deckhouse/deckhouse/ee/se-plus/modules/030-cloud-provider-zvirt/pkg => ../pkg
