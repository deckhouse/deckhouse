...
По умолчанию web-интерфейс документации доступен по адресу 'deckhouse.', согласно значению глобального параметра [publicDomainTemplate]({{ site.baseurl }}/documentation.html#параметры).
