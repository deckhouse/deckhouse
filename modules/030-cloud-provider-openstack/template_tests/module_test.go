...
var _ = Describe("Module :: cloud-provider-openstack :: helm template ::", func() {
	...
	Context("Openstack", func() {
		...
		It("Everything must render properly", func() {
			...
			cinderNodePluginSA := f.KubernetesResource("ServiceAccount", "d8-cloud-provider-openstack", "csi-cinder-node-plugin")
			cinderNodePluginDS := f.KubernetesResource("DaemonSet", "d8-cloud-provider-openstack", "csi-cinder-node-plugin")
			cinterControllerPluginSA := f.KubernetesResource("ServiceAccount", "d8-cloud-provider-openstack", "csi-cinder-controller-plugin")
			cinderCongrollerPluginSS := f.KubernetesResource("StatefulSet", "d8-cloud-provider-openstack", "csi-cinder-controller-plugin")
			cinderNodePluginCR := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-openstack:csi-nodeplugin-role")
			cinderNodePluginCRB := f.KubernetesGlobalResource("ClusterRoleBinding", "d8-cloud-provider-openstack:csi-nodeplugin-binding")
			cinderAttacherCR := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-openstack:csi-attacher-role")
			cinderAttacherCRB := f.KubernetesGlobalResource("ClusterRoleBinding", "d8-cloud-provider-openstack:csi-attacher-binding")
			cinderProvisionerCR := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-openstack:csi-provisioner-role")
			cinderProvisionerCRB := f.KubernetesGlobalResource("ClusterRoleBinding", "d8-cloud-provider-openstack:csi-provisioner-binding")
			cinderSnapshotterCR := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-openstack:csi-snapshotter-role")
			cinderSnapshotterCRB := f.KubernetesGlobalResource("ClusterRoleBinding", "d8-cloud-provider-openstack:csi-snapshotter-binding")
			cinderResizerCR := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-openstack:csi-resizer-role")
			cinderResizerCRB := f.KubernetesGlobalResource("ClusterRoleBinding", "d8-cloud-provider-openstack:csi-resizer-binding")
			cinderResizerR := f.KubernetesResource("Role", "d8-cloud-provider-openstack", "external-resizer-cfg")
			cinderResizerRB := f.KubernetesResource("RoleBinding", "d8-cloud-provider-openstack", "csi-resizer-role-cfg")
			...
			userAuthzUser := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-openstack:user-authz:user")
			userAuthzClusterAdmin := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-openstack:user-authz:cluster-admin")
