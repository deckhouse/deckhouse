...
- **Periodic etcd defragmentation**. In clusters with three or more etcd members, this feature is enabled by default. For more details, see the description of the [`defrag`](configuration.html#parameters-etcd-defrag) parameter.
