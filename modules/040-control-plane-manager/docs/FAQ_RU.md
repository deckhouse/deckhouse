...
Может возникнуть ситуация, когда мастер-узлы кластера находятся в выключенном состоянии долгое время. За это время сертификаты компонентов control plane могут истечь. После включения нод, сертификаты не обновятся автоматически, поэтому это необходимо сделать вручную.
