...
Способ замены ОС зависит от типа кластера: в облачном кластере узлы заменяются через `dhctl converge`, в статическом — вручную, по одному узлу.

### В облачном кластере

Чтобы заменить образ ОС master-узлов в облачном мультимастерном кластере, выполните следующие шаги.
...
Чтобы заменить ОС вручную добавленного master-узла, выполните следующие шаги:
...
1. Обновите master-узлы в соответствии с [инструкцией](#в-облачном-кластере).
...
1. Обновите master-узлы в соответствии с [инструкцией](#в-статическом-кластере).
