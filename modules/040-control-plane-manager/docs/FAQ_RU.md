...
## Как настроить HA c двумя master-узлами и arbiter-узлом?

В Deckhouse Kubernetes Platform возможна настройка HA c двумя master-узлами и arbiter-узлом. Такой подход позволяет обеспечить требования по HA в условиях ограниченных ресурсов.
...
Чтобы настроить HA c двумя master-узлами и arbiter-узлом в облачном кластере, необходимо удалить из кластера один master-узел и добавить один arbiter-узел.
...
Чтобы настроить HA c двумя master-узлами и arbiter-узлом в статическом кластере, выполните следующие действия:
