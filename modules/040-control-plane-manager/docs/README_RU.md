...
Обновление **patch-версии** компонентов control plane (т.е. в рамках минорной версии, например с 1.24.3 на 1.24.8) происходит автоматически вместе с обновлением версии Deckhouse. Управлять обновлением patch-версий нельзя.
...
- При upgrade:
  ...
  - Обновление на каждом этапе происходит максимум на одну версию выше, чем минимальная версия kubelet на узлах.
- При downgrade:
