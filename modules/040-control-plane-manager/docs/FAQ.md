...
You can see [documentation](https://github.com/deckhouse/deckhouse/blob/main/modules/control-plane-manager/docs/internal/ETCD_RECOVERY.md) for learn about etcd disaster recovery procedures from snapshots.
