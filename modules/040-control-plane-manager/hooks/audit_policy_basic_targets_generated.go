...
var auditPolicyBasicServiceAccounts = []string{
	...
	"system:serviceaccount:d8-cloud-provider-vcd:node-feature-discovery-gc",
	"system:serviceaccount:d8-cloud-provider-vcd:node-feature-discovery-master",
	"system:serviceaccount:d8-cloud-provider-vcd:node-feature-discovery-worker",
	"system:serviceaccount:d8-cloud-provider-vcd:nvidia-device-plugin",
	"system:serviceaccount:d8-cloud-provider-vcd:nvidia-gpu-feature-discovery",
	"system:serviceaccount:d8-cloud-provider-vcd:nvidia-mig-manager",
	...
	"system:serviceaccount:d8-cloud-provider-zvirt:deckhouse",
	"system:serviceaccount:d8-cloud-provider-zvirt:webhook-handler",
