...
var auditPolicyBasicServiceAccounts = []string{
	...
	"system:serviceaccount:d8-nvidia-gpu:node-feature-discovery-gc",
	"system:serviceaccount:d8-nvidia-gpu:node-feature-discovery-master",
	"system:serviceaccount:d8-nvidia-gpu:node-feature-discovery-worker",
	"system:serviceaccount:d8-nvidia-gpu:nvidia-device-plugin",
