...
var auditPolicyBasicServiceAccounts = []string{
	...
	"system:serviceaccount:d8-cloud-provider-vsphere:alliance-ingressgateway",
	...
	"system:serviceaccount:d8-linstor:linstor-affinity-controller",
	"system:serviceaccount:d8-linstor:linstor-controller",
	"system:serviceaccount:d8-linstor:linstor-node",
	"system:serviceaccount:d8-linstor:linstor-pools-importer",
	"system:serviceaccount:d8-linstor:linstor-scheduler",
	"system:serviceaccount:d8-linstor:linstor-scheduler-admission",
	"system:serviceaccount:d8-linstor:piraeus-operator",
