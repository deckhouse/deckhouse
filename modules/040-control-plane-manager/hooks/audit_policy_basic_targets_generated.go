...
var auditPolicyBasicServiceAccounts = []string{
	...
	"system:serviceaccount:d8-cloud-provider-sample:capsa-controller-manager",
	"system:serviceaccount:d8-cloud-provider-sample:cloud-controller-manager",
	"system:serviceaccount:d8-cloud-provider-sample:cloud-data-discoverer",
