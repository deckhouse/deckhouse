...
var _ = Describe("Module :: cloud-provider-aws :: helm template ::", func() {
	...
	Context("AWS", func() {
		...
		It("Everything must render properly", func() {
			...
			ebsRegistrarCR := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-aws:csi-driver-registrar")
			ebsRegistrarCRB := f.KubernetesGlobalResource("ClusterRoleBinding", "d8-cloud-provider-aws:csi-driver-registrar")
			ebsProvisionerCR := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-aws:csi-external-provisioner")
			ebsProvisionerCRB := f.KubernetesGlobalResource("ClusterRoleBinding", "d8-cloud-provider-aws:csi-external-provisioner")
			ebsAttacherCR := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-aws:csi-external-attacher")
			ebsAttacherCRB := f.KubernetesGlobalResource("ClusterRoleBinding", "d8-cloud-provider-aws:csi-external-attacher")
			ebsResizerCR := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-aws:csi-external-resizer")
			ebsResizerCRB := f.KubernetesGlobalResource("ClusterRoleBinding", "d8-cloud-provider-aws:csi-external-resizer")
			ebsSnapshotterCR := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-aws:csi-external-snapshotter")
			ebsSnapshotterCRB := f.KubernetesGlobalResource("ClusterRoleBinding", "d8-cloud-provider-aws:csi-external-snapshotter")
