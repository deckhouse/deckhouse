...
var (
	...
	helmNamespace = "d8-neuvector"
	// controller service account
	serviceAccount = "system:serviceaccount:d8-neuvector:neuvector"
...
func main() {
	...
	logger.Info(fmt.Sprintf("start neuvector with %v allow orphan namespaces option", allowOrphanNamespaces))
