...
ENV APP_PATH_FROM=./modules/038-registry/images/nodeservices-manager/app \
    APP_PATH_TO=/deckhouse/modules/038-registry/images/nodeservices-manager/app \
...
ENV APP_PATH_FROM=./modules/038-registry/images/nodeservices-manager
