...
func startRegistry(t *testing.T) Registry {
	...
	return Registry{Address: parsed.Host, Insecure: true, Scope: "system/deckhouse"}
}

func push(t *testing.T, target Registry, reference string) {
	t.Helper()
...
func exists(t *testing.T, target Registry, reference string) bool {
	t.Helper()
...
func newCollector(t *testing.T, target Registry, releases Releases, sweeper Sweeper) *Collector {
	t.Helper()
