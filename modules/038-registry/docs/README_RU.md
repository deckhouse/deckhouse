...
description: "Управление конфигурацией registry компонентов Deckhouse Platform Certified Security Edition и организация внутреннего хранилища образов контейнеров (container registry, registry)."
---
...
Bootstrap кластера Deckhouse Platform Certified Security Edition поддерживается только в неконфигурируемом `Unmanaged` режиме. Настройки registry во время bootstrap задаются через [initConfiguration](/products/kubernetes-platform/documentation/v1/reference/api/cr.html#initconfiguration-deckhouse-imagesrepo).
