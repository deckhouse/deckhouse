...
нуля — см. [как освободить это место](faq.html#как-удалить-с-узла-оставшиеся-данные-кэша),
...
уже есть. См.
[как освободить это место](faq.html#как-удалить-с-узла-оставшиеся-данные-кэша).
...
[как устроена миграция](faq.html#как-устроена-миграция-на-модуль-registry).
