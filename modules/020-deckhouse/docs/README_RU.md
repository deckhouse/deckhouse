...
- **Сервис валидирования custom resource'ов**
  ...
  Сервис валидирования предотвращает создание custom resource'ов с некорректными данными или внесение в существующие custom resource'ы некорректных данных. Сервис валидирования custom resource'ов отслеживает только custom resource'ы, находящиеся под управлением модулей Deckhouse.
