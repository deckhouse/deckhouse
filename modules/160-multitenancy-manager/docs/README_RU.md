...
1. Из шаблона создаются ресурсы проекта:
   ...
   - для устаревших шаблонов выполняется рендеринг [шаблона ресурсов](./cr.html#projecttemplate-v1alpha2-spec-resourcestemplate) с помощью [Helm](https://helm.sh/docs/); значения берутся из параметра [`parameters`](./cr.html#project-v1alpha3-spec-parameters) ресурса [Project](./cr.html#project);
