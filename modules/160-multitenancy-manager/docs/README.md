...
1. The project resources are created from the template:
   ...
   - in legacy templates the [resources template](./cr.html#projecttemplate-v1alpha2-spec-resourcestemplate) is rendered using [Helm](https://helm.sh/docs/); values are taken from the [`parameters`](./cr.html#project-v1alpha3-spec-parameters) field of the [Project](./cr.html#project) resource;
