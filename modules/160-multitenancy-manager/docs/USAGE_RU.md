...
- дальше источником истины становится проект и редактируется он как любой другой. Удаление неймспейса больше не удаляет проект — проект создаст неймспейс заново. Чтобы убрать окружение, удалите Project: `d8 k delete project <имя>` удалит вместе с ним и неймспейс и, как раньше `kubectl delete ns`, вернёт управление только после того, как неймспейс исчезнет.
