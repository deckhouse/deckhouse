...
- Дополнительное пространство имён автоматически получает настройки шаблона проекта (профиль безопасности подов, сетевые политики, сбор логов и т. п.) и весь выданный на проект доступ ([ProjectRoleBinding](cr.html#projectrolebinding), [ClusterProjectRoleBinding](cr.html#clusterprojectrolebinding), администраторы проекта). Квота проекта действует в основном пространстве имён.
