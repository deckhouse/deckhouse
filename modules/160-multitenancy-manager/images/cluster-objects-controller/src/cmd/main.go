...
func main() {
	...
	grantValidatorWebhook := webhooks.NewClusterResourceGrantValidator(
		baseLogger.WithValues("component", "ClusterResourceGrantValidator"),
		mgr.GetClient(),
	)
	...
	if err := mgr.AddReadyzCheck("readyz", readyz.ProbeWithInformerCacheStatus(mgr.GetCache())); err != nil {
