...
type ClusterObjectsGrantSpec struct {
	...
	// foo is an example field of ClusterObjectsGrant. Edit clusterobjectsgrant_types.go to remove/update
	// +optional
...
type ClusterObjectsGrantStatus struct {
	...
	// conditions represent the current state of the ClusterObjectsGrant resource.
