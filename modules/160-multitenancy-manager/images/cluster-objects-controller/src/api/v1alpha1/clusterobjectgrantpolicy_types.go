...
type GrantedResourceUsageReference struct {
	// APIVersion is the kubernetes API group/version that holds resources to be covered under this policy.
	// +required
...
// ObjectPolicyStatusFields holds additional fields from controlled resources that users might want to see.
type ObjectPolicyStatusFields map[string]ObjectPolicyStatusField

// ObjectPolicyStatusField describes a field from controlled resource that users might want to see.
type ObjectPolicyStatusField struct {
	// FieldPath is a JSONPath reference to a field to be exported into the status of ClusterObjectGrantPolicy.
	// +required
	FieldPath string `json:"fieldPath"`
...
// ObjectStatusFieldDescription holds a set of human readable descriptions of a field in diffirent languages.
type ObjectStatusFieldDescription struct {
...
type ClusterObjectGrantPolicySpec struct {
	...
	// ObjectPolicyStatusFields contains additional fields from resources under control that users might want to see.
	// +optional
