...
description: "Автоматическое управление аннотациями и лейблами на неймспейсах в Deckhouse Platform."
---
...
* игнорируются пространства имён с лейблами `heritage` с одним из значений `upmeter`, `deckhouse` или `multitenancy-manager`;
