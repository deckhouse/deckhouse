...
- модуль предназначен для хранения логов в течение короткого времени. Для долгосрочного хранения или архивирования рекомендуется использовать внешние системы, поддерживаемые через [log-shipper](/modules/log-shipper/).
