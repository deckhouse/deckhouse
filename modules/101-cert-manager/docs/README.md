...
This module installs the reliable and highly available cert-manager v{{ cert_manager_version }}[release](https://github.com/jetstack/cert-manager/tree/{{ cert_manager_version }}).
