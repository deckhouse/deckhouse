...
Создан для управления дашбордами в Графане. У пода с Графаной работает sidecar с shell-operator, у которого есть хук, который следит за данным ресурсом. При соответствующем событии, хук создаёт/удаляет/правит соответствующую дашборду через специальный механизм.
...
<details>
<summary>Объяснение деталей и причин
</summary>
  <ul dir="auto">
