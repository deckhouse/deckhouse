...
Возможности системы мониторинга Deckhouse Platform Certified Security Edition могут быть расширены за счёт использования [модуля Observability](/modules/observability/stable/). С его помощью реализуется:
