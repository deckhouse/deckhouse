...
| **aggregating-proxy**       | An aggregating and caching proxy  that reduces the load on Prometheus and aggregates data from both main instances into a single datasource.                                                                                                                                                         |
