...
var _ = cluster_configuration.RegisterHook(func(input *go_hook.HookInput, metaCfg *config.MetaConfig, providerDiscoveryData *unstructured.Unstructured, secretFound bool) error {
	...
	input.Values.Set("cloudProviderAzure.internal.providerClusterConfiguration", metaCfg.ProviderClusterConfig)
	input.Values.Set("cloudProviderAzure.internal.providerDiscoveryData", providerDiscoveryData.Object)
