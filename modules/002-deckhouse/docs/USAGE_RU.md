...
В режиме `Template` резервируются не только имена хостов, используемые DKP, но и другие имена, соответствующие шаблону. Если приложению необходимо такое имя, его можно исключить из резервирования одним из следующих способов:
