...
* Если вам необходимо хранить логи более 7 дней, используйте отдельное хранилище для логов. Это позволит избежать потенциальных проблем с производительностью и обеспечит сохранность данных.
