...
Обратите внимание, что по умолчанию в Deckhouse установлен срок хранения логов в 7 дней. Однако, в соответствии с требованиями безопасности указанными в kube-bench, логи должны храниться не менее 30 дней.
