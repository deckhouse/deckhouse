...
- [ClusterObservabilityMetricsRulesGroup](/modules/observability/cr.html#clusterobservabilitymetricsrulesgroup): For Prometheus rules.
- [ClusterObservabilityDashboard](/modules/observability/cr.html#clusterobservabilitydashboard): For Grafana dashboards.

This enables centralized monitoring resource management via the `observability` module interfaces.
