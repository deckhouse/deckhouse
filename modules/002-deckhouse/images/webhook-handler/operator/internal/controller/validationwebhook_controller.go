...
// +kubebuilder:rbac:groups=deckhouse.io.deckhouse.io,resources=validationwebhooks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=deckhouse.io.deckhouse.io,resources=validationwebhooks/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=deckhouse.io.deckhouse.io,resources=validationwebhooks/finalizers,verbs=update
