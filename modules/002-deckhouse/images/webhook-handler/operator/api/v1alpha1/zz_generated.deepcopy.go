...
func (in *ConversionWebhook) DeepCopyInto(out *ConversionWebhook) {
	*out = *in
	...
	if in.KubernetesCustomResourceConversion != nil {
		in, out := &in.KubernetesCustomResourceConversion, &out.KubernetesCustomResourceConversion
		*out = make([]KubernetesConversionConfigV1, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubernetesConversionConfigV1) DeepCopyInto(out *KubernetesConversionConfigV1) {
	*out = *in
	if in.IncludeSnapshotsFrom != nil {
		in, out := &in.IncludeSnapshotsFrom, &out.IncludeSnapshotsFrom
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesConversionConfigV1.
func (in *KubernetesConversionConfigV1) DeepCopy() *KubernetesConversionConfigV1 {
	if in == nil {
		return nil
	}
	out := new(KubernetesConversionConfigV1)
	in.DeepCopyInto(out)
	return out
}
