...
var _ = Describe("Module :: cilium-hubble :: config values conversions :: version 1", func() {
	f := SetupConverter(``)
...
var _ = Describe("Module :: cilium-hubble :: config values conversions :: to latest", func() {
	f := SetupConverter(``)
