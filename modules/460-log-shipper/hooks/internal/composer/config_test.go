	...
	tests := []struct {
	...
	}{
		{
			...
			buildFile: func() (apis.LogSource, apis.LogDestination) {
				...
				dest := destination.NewLoki("testoutput", spec, v1alpha1.SourceKubernetesPods)
				return src, dest
			},
		},
		{
			...
			buildFile: func() (apis.LogSource, apis.LogDestination) {
				...
				dest := destination.NewLogstash("testoutput", spec, v1alpha1.SourceKubernetesPods)
				return src, dest
			},
		},
		{
			...
			buildFile: func() (apis.LogSource, apis.LogDestination) {
				...
				dest := destination.NewElasticsearch("testoutput", spec, v1alpha1.SourceFile)
				return src, dest
			},
		},
		{
			...
			buildFile: func() (apis.LogSource, apis.LogDestination) {
				...
				dest := destination.NewVector("testoutput", spec, v1alpha1.SourceKubernetesPods)
				return src, dest
			},
		},
	}
