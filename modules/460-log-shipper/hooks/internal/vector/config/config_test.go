...
func TestConfig_1(t *testing.T) {
	src := model.NewKubernetesLogSource("testsource", v1alpha1.KubernetesPodsSpec{
	...
	dest := model.NewLokiDestination("testoutput", spec)
	...
	compareMock(t, conf, "config_1.json")
}
...
func TestConfig_2(t *testing.T) {
	...
	dest := model.NewLogstashDestination("testoutput", spec)
	...
	compareMock(t, conf, "config_2.json")
}

func TestConfig_3(t *testing.T) {
	src := model.NewFileLogSource("testfile", v1alpha1.FileSpec{
	...
	dest := model.NewElasticsearchDestination("testoutput", spec)
