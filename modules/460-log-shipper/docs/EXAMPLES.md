...
To send logs to the loki cluster module, specify `d8-loki` in the ClusterLoggingConfig [destinationRefs](/modules/log-shipper/cr.html#clusterloggingconfig-v1alpha2-spec-destinationrefs) field. More examples read [in the documentation](/modules/loki/examples.html).
