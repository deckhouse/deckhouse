...
If you need to send logs to the loki cluster module, change the ClusterLogDestination parameter to d8-loki in the kind parameter, and see additional examples in the [documentation](/modules/loki/examples.html)
