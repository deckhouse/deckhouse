...
description: "Расширенная конфигурация модуля log-shipper Deckhouse Platform Certified Security Edition, включающая отладку логов, исследование каналов передачи данных и добавление новых источников/приемников."
---
---
...
* Выставьте его в публичный сервис, чтобы получить изображение.
