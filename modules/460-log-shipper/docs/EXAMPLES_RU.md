...
Данный пример показывает, как настроить интеграцию с Graylog. Убедитесь, что в Graylog настроен входящий поток для приема сообщений по протоколу TCP на указанном порту:
