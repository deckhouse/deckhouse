...
description: "Examples of the configuration of the openvpn Deckhouse Platform module for various scenarios, including bare metal clusters, AWS, Google Cloud, and public IP addresses on an external load balancer."
---
