...
description: Description of the Deckhouse Platform terraform-manager module. Ensures that the objects in the cluster correspond to the Terraform state.
---
...
The implementation is based on Terraform and is used in the Deckhouse Platform for interaction with supported cloud providers.
