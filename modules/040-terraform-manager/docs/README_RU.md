...
description: Описание модуля terraform-manager Deckhouse Platform. Модуль следит за приведением объектов в кластере к состоянию, описанному в Terraform state.   
---

Модуль отвечает за отслеживание и синхронизацию состояния базовой инфраструктуры и постоянных узлов в облачной среде.
Реализация основана на Terraform и применяется в Deckhouse Platform для взаимодействия с поддерживаемыми облачными провайдерами.
