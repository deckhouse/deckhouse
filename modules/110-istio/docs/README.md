...
1. Using the `istioctl` utility from the DKP debug container ([debugging Istio with istioctl from the debug container](examples.html#debugging-istio-with-istioctl-from-the-debug-container)):
