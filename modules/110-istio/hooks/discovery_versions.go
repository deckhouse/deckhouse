...
func imageToIstioVersion(img string) (*IstioVersion, error) {
	...
	// Native ambient multicluster is available starting with version 1.29
	ambientMulticlusterMinVersion := semver.MustParse("1.29.0")
	supportsAmbientMulticluster := versionSemver.GreaterThanEqual(ambientMulticlusterMinVersion)
	...
	return &IstioVersion{
		...
		info: istio_versions.IstioVersionInfo{
			...
			SupportsAmbientMulticluster: supportsAmbientMulticluster,
