...
var _ = Describe("Istio hooks :: ca ::", func() {
	...
	Context("Secret is in cluster; values aren't set", func() {
		BeforeEach(func() {
			f.BindingContexts.Set(f.KubeStateSet(`
apiVersion: v1
kind: Secret
...
`))
	...
	Context("Secret is in cluster; values are set", func() {
		BeforeEach(func() {
...
`))
	...
	Context("Secret is in cluster; values are not fully set", func() {
		BeforeEach(func() {
			f.ValuesSetFromYaml("istio.ca", []byte(`
cert: xxx
key: yyy
