...
description: Управление сетевыми политиками в кластере Deckhouse Platform.
---
...
Подробное описание модели NetworkPolicy и типовые примеры — в разделе документации [Сетевые политики](/products/kubernetes-platform/documentation/v1/admin/configuration/network/policy/configuration.html). Дополнительные [примеры использования](https://github.com/ahmetb/kubernetes-network-policy-recipes) доступны во внешнем репозитории.
