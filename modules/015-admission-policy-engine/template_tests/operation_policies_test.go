...
var _ = Describe("Module :: admissionPolicyEngine :: helm template :: operation policies", func() {
	f := SetupHelmConfig(`{global: {discovery: {kubernetesVersion: "1.27.3"}},admissionPolicyEngine: {denyVulnerableImages: {}, verifyImageSignatures: {}, podSecurityStandards: {}, internal: {"bootstrapped": true, "ratify": {"webhook": {"key": "YjY0ZW5jX3N0cmluZwo=", "crt": "YjY0ZW5jX3N0cmluZwo=" , "ca": "YjY0ZW5jX3N0cmluZwo="}}, "podSecurityStandards": {"enforcementActions": ["deny"]}, "operationPolicies": [
{
