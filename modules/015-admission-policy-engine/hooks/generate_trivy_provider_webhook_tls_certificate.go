...
var _ = tls_certificate.RegisterInternalTLSHook(tls_certificate.GenSelfSignedTLSHookConf{
	SANs: tls_certificate.DefaultSANs([]string{
		"trivy-provider.d8-admission-policy-engine",
		"trivy-provider.d8-admission-policy-engine.svc",
		tls_certificate.ClusterDomainSAN("trivy-provider.d8-admission-policy-engine.svc"),
	}),

	CN: "trivy-provider.d8-admission-policy-engine",
