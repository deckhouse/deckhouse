...
Moreover, operation policies can be specified at the namespace level:
...
Similarly to operation policies, security policies can be specified at the namespace level:
