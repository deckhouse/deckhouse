...
Политика, приведённая в примере, рекомендована для использования командой Deckhouse. Аналогичным образом вы можете создать собственную политику с необходимыми настройками.
...
Более подробную информацию о использовании селекторов вы можете прочитать в [документации](/modules/015-admission-policy-engine/docs/faq.html#как-настроить-селекторы-политик).
