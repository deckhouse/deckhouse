...
Операционные политики — это правила, направленные на достижение лучших практик безопасности приложений, но **не относящихся** напрямую к валидации классических параметров, связанных с безопасностью (например, список допустимых префиксов для образов контейнеров, политика скачивания образов, список необходимых проб для контейнеров и т.д.).
