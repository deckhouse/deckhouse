...
Помимо подов, политики валидируют контроллеры, создающие поды, при операциях CREATE и UPDATE. Это обеспечивает ранний отклик при создании или обновлении рабочей нагрузки, до запуска подов.

Перехватываются следующие типы объектов:

| API-группа | Тип                                | Операции       |
| ---------- | ---------------------------------- | -------------- |
