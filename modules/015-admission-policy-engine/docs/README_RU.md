...
{% alert level="warning" %}
Webhook работает с `failurePolicy: Fail`.
...
после того как LimitRange добавит `resources` по умолчанию, а мутирующий webhook — `securityContext`.
