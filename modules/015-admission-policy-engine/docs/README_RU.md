...
Помимо политик, которые запрещают использование параметров отличных от разрешенных, существуют ресурсы отвечающие за реализацию точечных исключений из  политик - [`security-policy-exception`](#securitypolicyexception). С помощью данных ресурсов можно переопределить проверки для некоторых подов, без изменения всех политик накладываемых на неймспейс.
