...
# Regression: object_labels must fall back to object's own metadata.labels
...
# Regression: effective_labels must fall back to object's own metadata.labels
...
# Regression: object_labels for unknown kind with no labels returns empty
...
# Regression: pod_spec must fall back to object.spec for unknown kinds
