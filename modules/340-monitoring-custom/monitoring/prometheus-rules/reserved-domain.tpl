  ...
  - alert: D8ReservedNodeLabelOrTaintFound
    ...
    annotations:
      ...
      description: |-
        ...
        For instructions on how to fix this issue, refer to the [node allocation guide](https://deckhouse.io/products/kubernetes-platform/documentation/v1/modules/node-manager/faq.html#how-do-i-allocate-nodes-to-specific-loads).
