...
episodes=$(cat <<EOF
[{"probeRef":{"group":"control-plane","probe":"access"},"ts": ${ts},
  "fail":25,"success":5,"unknown":0,"NoData":0},
 {"probeRef":{"group":"control-plane","probe":"namespace"},"ts":${ts},
  "fail":15,"success":15,"unknown":0,"NoData":0},
 {"probeRef":{"group":"synthetic","probe":"dns"},"ts":${ts},
  "fail":20,"success":10,"unknown":0,"NoData":0}
]
EOF
)
