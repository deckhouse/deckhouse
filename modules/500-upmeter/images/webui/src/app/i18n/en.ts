    ...
    probe: {
        "control-plane": {
            ...
            "namespace": {
                ...
                reasonUnknown: "error during create or delete operations, kube-apiserver is not available or operations are slow",
                reasonNodata: REASON_AGENTS_STOPPED,
            },
            "scheduler": {
                title: "Scheduler",
                ...
                reasonUnknown: "error during create or delete operations, kube-apiserver is not available or probe execution is skipped because previous probe was not yet finished",
                reasonNodata: REASON_AGENTS_STOPPED,
            },
        },
        "monitoring-and-autoscaling": {
            ...
            "metrics-sources": {
                ...
                reasonUp: "all pods of node-exporter, and at least one Pod of kube-state-metrics is in <code>Ready</code> state",
                reasonDown: "at least one Pod of node-exporter, or all pods of kube-state-metrics are not in <code>Ready</code> state",
                reasonUnknown: REASON_APISERVER_UNAVAILABLE,
                reasonNodata: REASON_AGENTS_STOPPED,
            },
            ...
            "horizontal-pod-autoscaler": {
                ...
                reasonUnknown: "at least one of probes of Prometheus Metrics Adapter or Controller Manager has unknown result but none of them failed",
                reasonNodata: REASON_AGENTS_STOPPED,
            },
        },
        synthetic: {
            "access": {
                ...SYNTHETIC_REASONS,
                title: "Access",
                description: "Every 5 seconds resolve sample application IPs and request <code>/</code> endpoint until first success",
            },
            "dns": {
                ...SYNTHETIC_REASONS,
                title: "DNS",
                description: "Every 5 seconds resolve sample application IPs and request <code>/dns</code> endpoint until first success",
            },
            "neighbor": {
                ...SYNTHETIC_REASONS,
                title: "Neighbor",
                description: "Every 5 seconds resolve sample application IPs and request <code>/neighbor</code> endpoint until first success",
            },
