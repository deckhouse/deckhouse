...
<ul>
<li><b>Up</b>: all probes are Up.</li>
<li><b>Down</b>: at least one probe is Down.</li>
<li><b>Unknown</b>: uncertain result, see probe results for clues.</li>
<li><b>Nodata</b>: all agents were stopped.</li>
</ul>`,
...
<ul>
<li><b>Up</b>: <code>/version</code> returns 200 OK.</li>
<li><b>Down</b>: <code>/version</code> returns other codes or there is no connection to API server.</li>
<li><b>Unknown</b>: connection to API server is slow.</li>
<li><b>Nodata</b>: when agents were stopped.</li>
</ul>
        `,
...
<ul>
<li><b>Up</b>: <code>ConfigMap</code> successfully created and deleted.</li>
<li><b>Down</b>: error during create or delete operations.</li>
<li><b>Unknown</b>: API server is not available or probe execution is skipped because previous probe was not yet finished.</li>
<li><b>Nodata</b>: when agents were stopped.</li>
</ul>`,
      "control-plane-manager": `<p><b>kube-controller-manager is working</b></p>
<p>Every 1 minute a Deployment is created and deleted.</p>
<ul>
<li><b>Up</b>: <code>Deployment</code> successfully created and <code>Pod</code> become <code>Pending</code>. Deployment successfully deleted.</li>
<li><b>Down</b>: created <code>Pod</code> is not become <code>Pending</code> after 10 seconds.</li>
<li><b>Unknown</b>: error during create or delete operations, API server is not available or probe execution is skipped because previous probe was not yet finished.</li>
<li><b>Nodata</b>: when agents were stopped.</li>
</ul>`,
      "namespace": `<p><b>Namespace can be created and deleted</b></p>
<p>Every 1 minute a Namespace is created and deleted.</p>
<ul>
<li><b>Up</b>: <code>Namespace</code> successfully created and deleted.</li>
<li><b>Down</b>: created <code>Namespace</code> is not deleted after 60 seconds.</li>
<li><b>Unknown</b>:  error during create or delete operations, API server is not available or operations are slow.</li>
<li><b>Nodata</b>: when agents were stopped.</li>
</ul>`,
...
<ul>
<li><b>Up</b>: <code>Pod</code> successfully created and scheduled to the <code>Node</code>.</li>
<li><b>Down</b>: created <code>Pod</code> is not scheduled within 20 seconds.</li>
<li><b>Unknown</b>:  error during create or delete operations, API server is not available or probe execution is skipped because previous probe was not yet finished.</li>
<li><b>Nodata</b>: when agents were stopped.</li>
</ul>`
    },
...
<ul>
<li><b>Up</b>: resolve is successful and all IPs are responded with 200OK.</li>
<li><b>Down</b>: some IP responded with other code.</li>
<li><b>Unknown</b>:  error during resolve or application is responded slow.</li>
<li><b>Nodata</b>: when agents were stopped.</li>
</ul>`,
...
<ul>
<li><b>Up</b>: resolve is successful and all IPs are responded with 200OK.</li>
<li><b>Down</b>: some IP resonded with other code.</li>
<li><b>Unknown</b>:  error during resolve or application is responded slow.</li>
<li><b>Nodata</b>: when agents were stopped.</li>
</ul>`,
