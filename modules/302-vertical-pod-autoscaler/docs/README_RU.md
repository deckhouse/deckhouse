...
- При использовании режимов, допускающих пересоздание подов, VPA пересоздаёт под, если обновить `resource requests` без перезапуска невозможно. Новый под может быть запланирован на другом узле.
