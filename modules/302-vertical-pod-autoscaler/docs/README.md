...
search: autoscaler
description: "Automatic calculation and setting of resource request parameters for pods in the Deckhouse Platform cluster."
---
...
{% alert level="warning" %}
The `Auto` mode is deprecated. It will no longer be supported in future DP versions. Switch to one of the supported operating modes.
{% endalert %}
