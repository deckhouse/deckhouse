...
Для настройки kubectl сгенерируйте kubeconfig в [веб-интерфейсе Deckhouse](/products/kubernetes-platform/documentation/v1/user/web/ui.html) и скопируйте полученные команды к себе в консоль.
