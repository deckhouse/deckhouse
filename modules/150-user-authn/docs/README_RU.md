...
- [dex](https://github.com/dexidp/dex) — провайдер с федеративным функциями, поддерживающий работу со статичными пользователями и возможностью подключения к различным внешним провайдерам аутентификации (среди прочих SAML, Gitlab, Github).
...
### Веб-интерфейс для генерации готовых kubeconfig
