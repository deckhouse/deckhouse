...
Ресурсы, у которых аннотация уже установлена, это не затрагивает: их владелец может продолжать их изменять, в том числе удалить аннотацию. Ограничено только появление гранта.
{% endalert %}
