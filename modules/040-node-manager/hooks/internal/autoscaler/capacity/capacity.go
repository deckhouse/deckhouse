...
type sampleInstanceClass struct {
	Cores  int `json:"cores"`
	Memory int `json:"memory"`
}

func (d sampleInstanceClass) ExtractCapacity(_ *InstanceTypesCatalog) (*v1alpha1.InstanceType, error) {
...
func CalculateNodeTemplateCapacity(instanceClassName string, instanceClassSpec interface{}, catalog *InstanceTypesCatalog) (*v1alpha1.InstanceType, error) {
	...
	case "SampleInstanceClass":
		var spec sampleInstanceClass
		extractor = &spec
