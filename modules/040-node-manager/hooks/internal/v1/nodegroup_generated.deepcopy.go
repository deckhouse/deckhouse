...
func (in *Kubelet) DeepCopyInto(out *Kubelet) {
	*out = *in
	...
	in.ResourceReservation.DeepCopyInto(&out.ResourceReservation)
	return
}
...
func (in *KubeletResourceReservation) DeepCopyInto(out *KubeletResourceReservation) {
	*out = *in
	if in.Static != nil {
		...
		*out = new(KubeletStaticResourceReservation)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
func (in *KubeletResourceReservation) DeepCopy() *KubeletResourceReservation {
	...
	out := new(KubeletResourceReservation)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TimeSlicing) DeepCopyInto(out *TimeSlicing) {
	*out = *in
	if in.GpuPartitionCount != nil {
		in, out := &in.GpuPartitionCount, &out.GpuPartitionCount
		*out = new(int32)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TimeSlicing.
func (in *TimeSlicing) DeepCopy() *TimeSlicing {
	if in == nil {
		return nil
	}
	out := new(TimeSlicing)
...
func (in *Mig) DeepCopyInto(out *Mig) {
	*out = *in
	if in.PartedConfig != nil {
		in, out := &in.PartedConfig, &out.PartedConfig
		*out = new(string)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MigSliceSpec) DeepCopyInto(out *MigSliceSpec) {
	*out = *in
	if in.Count != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MigSliceSpec.
func (in *MigSliceSpec) DeepCopy() *MigSliceSpec {
	if in == nil {
		return nil
	}
	out := new(MigSliceSpec)
	in.DeepCopyInto(out)
	return out
}
