...
`
	...
	f := HookExecutionConfigInit(`{"global":{"discovery":{"kubernetesVersion": "1.33.5", "kubernetesVersions":["1.33.5"], "clusterUUID":"aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"},},"nodeManager":{"internal": {}}}`, `{}`)
