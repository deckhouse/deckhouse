  ...
  template:
    ...
    spec:
      ...
      infrastructureRef:
        ...
        name: {{ $template_name }}
  {{- if $ng.nodeDrainTimeoutSec }}
      drainTimeout: {{$ng.nodeDrainTimeoutSec}}s
      nodeDrainTimeout: {{$ng.nodeDrainTimeoutSec}}s
      nodeDeletionTimeout: {{$ng.nodeDrainTimeoutSec}}s
      nodeVolumeDetachTimeout: {{$ng.nodeDrainTimeoutSec}}s
  {{- else }}
      nodeDrainTimeout: 5m
