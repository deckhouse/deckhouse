...
{{ tpl ($context.Files.Get (list "cloud-providers" $context.Values.nodeManager.internal.cloudProvider.type "config-for-machine-controller-manager.yaml" | join "/")) $tpl_context | indent 2 }}
{{- end }}
