...
Для новых узлов, добавляемых в кластер, можно автоматически проставить кастомные лейблы. Для этого в каталоге `/var/lib/node_labels` добавляемого узла нужно создать файлы, содержащие нужные лейблы в формате `key=value`. Названия файлов могут быть любыми, вложенность каталогов с файлами не ограничена.
