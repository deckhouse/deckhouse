...
3. Установка/обновление и настройка ПО узла (docker, kubelet и др.), подключение узла в кластер:
    * Поддержка Ubuntu `Ubuntu 18.04`, `Ubuntu 20.04`, `Ubuntu 22.04`, `Centos 7`, `Centos 8`, `Debian 9`, `Debian 10`, `Debian 11` вне зависимости от типа используемой инфраструктуры (на любом облаке или любом железе).
