...
1. Проверьте установку на узле, используя команду:
   ...
   Для выделенных GPU-узлов рекомендуется использовать серверную ОС без графического окружения или отключить графическую сессию/display manager средствами ОС.
   {% endalert %}
