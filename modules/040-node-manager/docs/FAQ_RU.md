...
Ресурс Instance представляет собой ресурс эфемерной машины, независимый от реализации, например, машины созданные MachineControllerManager или Cluster API Provider Static будут иметь соотвествующий ресурс Instance.
