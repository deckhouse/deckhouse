...
1. GPU не используется процессами ОС или пользовательскими приложениями. Если на узле запущено графическое окружение, display manager или другие процессы, использующие GPU, применение MIG-конфигурации может завершиться ошибкой или не примениться до освобождения GPU. Проверьте это командой:
