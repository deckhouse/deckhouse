...
> **Внимание!** Если на зачищаемом узле есть пулы хранения LINSTOR, то Вам необходимо предварительно выполнить эвакуацию ресурсов и удаление этого узла из LINSTOR, следуя [этой инструкции](https://deckhouse.ru/documentation/v1/modules/041-linstor/faq.html#как-выгнать-ресурсы-с-узла).
