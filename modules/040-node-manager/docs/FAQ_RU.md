...
1. Для [CloudStatic-узлов](../040-node-manager/cr.html#nodegroup-v1-spec-nodetype), выполните шаги, описанные в документации cloud-провайдера:
   - [AWS](../030-cloud-provider-aws/faq.html#добавление-cloudstatic-узлов-в-кластер)
   - [GCP](../030-cloud-provider-gcp/faq.html#добавление-cloudstatic-узлов-в-кластер)
