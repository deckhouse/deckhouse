...
Пример добавления CA в пользовательский registry (**старый** способ конфигурации):
...
Пример добавления TLS skip verify (**старый** способ конфигурации):
...
Пример добавления CA в пользовательский registry (**новый** способ конфигурации):
...
Пример добавления TLS skip verify (**новый** способ конфигурации):
