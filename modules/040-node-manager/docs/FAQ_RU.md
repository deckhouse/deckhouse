...
##### Как настроить зеркало для к публичным реестрам образов (устаревший способ)?

Пример настройки зеркала к публичным реестрам образов при использовании **устаревшего** способа конфигурации:
