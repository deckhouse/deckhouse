...
1. Модель GPU: MIG поддерживают H100/A100/A30, **не** поддерживает V100/T4. См. таблицы профилей в руководстве [NVIDIA MIG](https://docs.nvidia.com/datacenter/tesla/mig-user-guide/contents.html). Проверьте, что GPU не используется процессами ОС или пользовательскими приложениями. Если на узле запущено графическое окружение, display manager или другие процессы, использующие GPU, применение MIG-конфигурации может завершиться ошибкой или не примениться до освобождения GPU. Проверьте это командой:
