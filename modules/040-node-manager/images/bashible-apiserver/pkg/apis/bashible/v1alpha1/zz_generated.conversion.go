...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*KubernetesBundle)(nil), (*bashible.KubernetesBundle)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_KubernetesBundle_To_bashible_KubernetesBundle(a.(*KubernetesBundle), b.(*bashible.KubernetesBundle), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*bashible.KubernetesBundle)(nil), (*KubernetesBundle)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_bashible_KubernetesBundle_To_v1alpha1_KubernetesBundle(a.(*bashible.KubernetesBundle), b.(*KubernetesBundle), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*KubernetesBundleList)(nil), (*bashible.KubernetesBundleList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_KubernetesBundleList_To_bashible_KubernetesBundleList(a.(*KubernetesBundleList), b.(*bashible.KubernetesBundleList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*bashible.KubernetesBundleList)(nil), (*KubernetesBundleList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_bashible_KubernetesBundleList_To_v1alpha1_KubernetesBundleList(a.(*bashible.KubernetesBundleList), b.(*KubernetesBundleList), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_KubernetesBundle_To_bashible_KubernetesBundle(in *KubernetesBundle, out *bashible.KubernetesBundle, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.Data = *(*map[string]string)(unsafe.Pointer(&in.Data))
	return nil
}

// Convert_v1alpha1_KubernetesBundle_To_bashible_KubernetesBundle is an autogenerated conversion function.
func Convert_v1alpha1_KubernetesBundle_To_bashible_KubernetesBundle(in *KubernetesBundle, out *bashible.KubernetesBundle, s conversion.Scope) error {
	return autoConvert_v1alpha1_KubernetesBundle_To_bashible_KubernetesBundle(in, out, s)
}

func autoConvert_bashible_KubernetesBundle_To_v1alpha1_KubernetesBundle(in *bashible.KubernetesBundle, out *KubernetesBundle, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.Data = *(*map[string]string)(unsafe.Pointer(&in.Data))
	return nil
}

// Convert_bashible_KubernetesBundle_To_v1alpha1_KubernetesBundle is an autogenerated conversion function.
func Convert_bashible_KubernetesBundle_To_v1alpha1_KubernetesBundle(in *bashible.KubernetesBundle, out *KubernetesBundle, s conversion.Scope) error {
	return autoConvert_bashible_KubernetesBundle_To_v1alpha1_KubernetesBundle(in, out, s)
}

func autoConvert_v1alpha1_KubernetesBundleList_To_bashible_KubernetesBundleList(in *KubernetesBundleList, out *bashible.KubernetesBundleList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]bashible.KubernetesBundle)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1alpha1_KubernetesBundleList_To_bashible_KubernetesBundleList is an autogenerated conversion function.
func Convert_v1alpha1_KubernetesBundleList_To_bashible_KubernetesBundleList(in *KubernetesBundleList, out *bashible.KubernetesBundleList, s conversion.Scope) error {
	return autoConvert_v1alpha1_KubernetesBundleList_To_bashible_KubernetesBundleList(in, out, s)
}

func autoConvert_bashible_KubernetesBundleList_To_v1alpha1_KubernetesBundleList(in *bashible.KubernetesBundleList, out *KubernetesBundleList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]KubernetesBundle)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_bashible_KubernetesBundleList_To_v1alpha1_KubernetesBundleList is an autogenerated conversion function.
func Convert_bashible_KubernetesBundleList_To_v1alpha1_KubernetesBundleList(in *bashible.KubernetesBundleList, out *KubernetesBundleList, s conversion.Scope) error {
	return autoConvert_bashible_KubernetesBundleList_To_v1alpha1_KubernetesBundleList(in, out, s)
}
