...
import (
	...
	"d8.io/bashible/generated/clientset/versioned/scheme"
	"net/http"
...
// BashibleV1alpha1Client is used to interact with features provided by the bashible.deckhouse.io group.
type BashibleV1alpha1Client struct {
	restClient rest.Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*BashibleV1alpha1Client, error) {
	...
	return &BashibleV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new BashibleV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *BashibleV1alpha1Client {
...
// New creates a new BashibleV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *BashibleV1alpha1Client {
	return &BashibleV1alpha1Client{c}
}
...
func (c *BashibleV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
