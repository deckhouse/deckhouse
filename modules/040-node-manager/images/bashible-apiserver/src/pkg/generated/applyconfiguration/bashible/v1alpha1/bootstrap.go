...
// BootstrapApplyConfiguration represents an declarative configuration of the Bootstrap type for use
// with apply.
...
// Bootstrap constructs an declarative configuration of the Bootstrap type for use with
// apply.
func Bootstrap(name string) *BootstrapApplyConfiguration {
...
func (b *BootstrapApplyConfiguration) WithBootstrap(value string) *BootstrapApplyConfiguration {
	b.Bootstrap = &value
	return b
}
