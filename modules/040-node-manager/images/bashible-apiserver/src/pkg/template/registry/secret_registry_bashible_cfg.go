...
var (
	_ validation.Validatable = &registryBashibleConfig{}
	_ validation.Validatable = &registryBashibleConfigHostsObject{}
	_ validation.Validatable = &registryBashibleConfigMirrorHostObject{}
)
