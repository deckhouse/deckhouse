...
// NodeType defines the type of nodes in the group (v1alpha1 uses Cloud/Static/Hybrid)
...
// NodeGroup defines a group of nodes (v1alpha1 version)
...
// NodeGroupSpec defines the desired state of NodeGroup (v1alpha1)
type NodeGroupSpec struct {
	// NodeType defines the type of nodes (Cloud, Static, Hybrid)
	// +kubebuilder:validation:Required
	NodeType NodeType `json:"nodeType"`

	// KubernetesVersion is the desired minor version of Kubernetes
	// +optional
	...
	// Static defines static node parameters
	// +optional
	...
	// Docker defines docker settings (deprecated)
	// +optional
...
// StaticSpec defines static node parameters
type StaticSpec struct {
	// InternalNetworkCIDRs defines subnet CIDRs
	// +optional
