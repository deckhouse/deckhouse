...
// +kubebuilder:webhook:path=/mutate-infrastructure-cluster-x-k8s-io-v1beta2-staticmachinetemplate,mutating=true,failurePolicy=fail,sideEffects=None,groups=infrastructure.cluster.x-k8s.io,resources=staticmachinetemplates,verbs=create;update,versions=v1beta2,name=mstaticmachinetemplate.deckhouse.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-infrastructure-cluster-x-k8s-io-v1beta2-staticmachinetemplate,mutating=false,failurePolicy=fail,sideEffects=None,groups=infrastructure.cluster.x-k8s.io,resources=staticmachinetemplates,verbs=update,versions=v1beta2,name=vstaticmachinetemplate.deckhouse.io,admissionReviewVersions=v1
