...
// +kubebuilder:webhook:path=/mutate-infrastructure-cluster-x-k8s-io-v1beta2-staticmachine,mutating=true,failurePolicy=fail,sideEffects=None,groups=infrastructure.cluster.x-k8s.io,resources=staticmachines,verbs=create;update,versions=v1beta2,name=mstaticmachine.deckhouse.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-infrastructure-cluster-x-k8s-io-v1beta2-staticmachine,mutating=false,failurePolicy=fail,sideEffects=None,groups=infrastructure.cluster.x-k8s.io,resources=staticmachines,verbs=update,versions=v1beta2,name=vstaticmachine.deckhouse.io,admissionReviewVersions=v1
