...
//+kubebuilder:webhook:path=/validate-deckhouse-io-v1alpha1-staticinstance,mutating=false,failurePolicy=fail,sideEffects=None,groups=deckhouse.io,resources=staticinstances,verbs=update,versions=v1alpha1,name=vstaticinstance.deckhouse.io,admissionReviewVersions=v1
