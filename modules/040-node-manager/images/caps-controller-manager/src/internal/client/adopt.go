...
func (c *Client) adoptStaticInstance(instanceScope *scope.InstanceScope) (bool, error) {
	...
	c.recorder.SendNormalEvent(instanceScope.Instance, instanceScope.MachineScope.StaticMachine.Labels["node-group"], "AdoptScriptSucceeded", "Adopt script executed successfully")
