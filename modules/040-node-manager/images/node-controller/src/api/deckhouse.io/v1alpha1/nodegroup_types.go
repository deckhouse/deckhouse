...
// NodeType defines the type of nodes in the group (v1alpha1 version)
...
type NodeGroupSpec struct {
	...
	// Static specifies static node settings (v1alpha1 specific)
	// +optional
	...
	// Docker specifies docker settings (v1alpha1 specific, deprecated)
	// +optional
	...
	// KubernetesVersion specifies the kubernetes version (v1alpha1 specific)
	// +optional
	KubernetesVersion string `json:"kubernetesVersion,omitempty"`
}

// CRISpec defines container runtime settings (v1alpha1 version)
type CRISpec struct {
...
// StaticSpec defines static node settings (v1alpha1 specific)
type StaticSpec struct {
	// InternalNetworkCIDRs specifies internal network CIDRs
	// +optional
...
// NodeGroup is the Schema for the nodegroups API (v1alpha1 version)
