...
func NewManager(ctx context.Context, cfg *rest.Config, scheme *runtime.Scheme) (manager.Manager, error) {
	return newManager(ctx, cfg, scheme, nil)
}
...
func NewManagerWithWebhooks(ctx context.Context, cfg *rest.Config, scheme *runtime.Scheme, webhookOpts *envtest.WebhookInstallOptions) (manager.Manager, error) {
	return newManager(ctx, cfg, scheme, webhookOpts)
}
...
func newManager(ctx context.Context, cfg *rest.Config, scheme *runtime.Scheme, webhookOpts *envtest.WebhookInstallOptions) (manager.Manager, error) {
