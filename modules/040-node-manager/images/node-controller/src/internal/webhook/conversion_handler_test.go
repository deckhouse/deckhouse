...
func TestAlpha2ToV1_CloudToCloudEphemeral(t *testing.T) {
	...
	result, err := h.convertObject(context.Background(), raw, "deckhouse.io/v1", cfg)
	if err != nil {
...
func TestV1ToAlpha2_CloudEphemeralToCloud(t *testing.T) {
	...
	result, err := h.convertObject(context.Background(), raw, "deckhouse.io/v1alpha2", cfg)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestV1ToAlpha1_CloudEphemeralToCloud(t *testing.T) {
	...
	result, err := h.convertObject(context.Background(), raw, "deckhouse.io/v1alpha1", cfg)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestConvertObject_SameVersion(t *testing.T) {
	...
	result, err := h.convertObject(context.Background(), raw, "deckhouse.io/v1", &ProviderClusterConfiguration{})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestConvertObject_UnsupportedSourceVersion(t *testing.T) {
	...
	_, err := h.convertObject(context.Background(), raw, "deckhouse.io/v1", &ProviderClusterConfiguration{})
	if err == nil {
...
func TestConvertObject_UnsupportedDesiredVersion(t *testing.T) {
	...
	_, err := h.convertObject(context.Background(), raw, "deckhouse.io/v999", &ProviderClusterConfiguration{})
	if err == nil {
...
func TestRoundTrip_V1Alpha2_V1_V1Alpha2(t *testing.T) {
	...
	// Convert to v1
	v1Result, err := h.convertObject(context.Background(), original, "deckhouse.io/v1", cfg)
	if err != nil {
	...
	v1a2Result, err := h.convertObject(context.Background(), v1Result, "deckhouse.io/v1alpha2", cfg)
	if err != nil {
...
func TestRoundTrip_V1_V1Alpha2_V1(t *testing.T) {
	...
	// Convert to v1alpha2
	v1a2Result, err := h.convertObject(context.Background(), original, "deckhouse.io/v1alpha2", cfg)
	if err != nil {
		t.Fatalf("v1 -> v1alpha2 failed: %v", err)
	}
	ngV1A2 := extractV1Alpha2NodeGroup(t, v1a2Result)
	...
	// Convert back to v1
	v1Result, err := h.convertObject(context.Background(), v1a2Result, "deckhouse.io/v1", cfg)
	if err != nil {
		t.Fatalf("v1alpha2 -> v1 failed: %v", err)
	}
	ngV1 := extractV1NodeGroup(t, v1Result)
