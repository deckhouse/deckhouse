...
func (h *ConversionHandler) convertToHub(raw []byte, srcVersion, name string, providerConfig *ProviderClusterConfiguration) (*v1.NodeGroup, error) {
	switch srcVersion {
...
func (h *ConversionHandler) convertFromHub(hub *v1.NodeGroup, desiredVersion string) ([]byte, error) {
