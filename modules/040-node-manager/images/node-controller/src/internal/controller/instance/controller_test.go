...
func newTestInstanceController(
	...
	controller := &InstanceController{
		Base:           dynctrl.Base{Client: controllerClient},
		machineFactory: machine.NewMachineFactory(),
		capiService:    capi.NewCAPIMachineService(),
		mcmService:     mcm.NewMCMMachineService(),
		instanceSvc:    instancepkg.NewInstanceService(controllerClient),
	}
	controller.initOnce.Do(func() {})
