...
// ClusterProviderMock implements mm_ports.ClusterProvider
type ClusterProviderMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcGetNodes          func(ctx context.Context) (na1 []domain.Node, err error)
	funcGetNodesOrigin    string
	inspectFuncGetNodes   func(ctx context.Context)
	afterGetNodesCounter  uint64
	beforeGetNodesCounter uint64
	GetNodesMock          mClusterProviderMockGetNodes
...
// NewClusterProviderMock returns a mock for mm_ports.ClusterProvider
func NewClusterProviderMock(t minimock.Tester) *ClusterProviderMock {
	...
	m.GetNodesMock = mClusterProviderMockGetNodes{mock: m}
	m.GetNodesMock.callArgs = []*ClusterProviderMockGetNodesParams{}
...
type mClusterProviderMockGetNodes struct {
	optional           bool
	mock               *ClusterProviderMock
	defaultExpectation *ClusterProviderMockGetNodesExpectation
	expectations       []*ClusterProviderMockGetNodesExpectation

	callArgs []*ClusterProviderMockGetNodesParams
	mutex    sync.RWMutex
...
// ClusterProviderMockGetNodesExpectation specifies expectation struct of the ClusterProvider.GetNodes
type ClusterProviderMockGetNodesExpectation struct {
	mock               *ClusterProviderMock
	params             *ClusterProviderMockGetNodesParams
	paramPtrs          *ClusterProviderMockGetNodesParamPtrs
	expectationOrigins ClusterProviderMockGetNodesExpectationOrigins
	results            *ClusterProviderMockGetNodesResults
	returnOrigin       string
	Counter            uint64
}

// ClusterProviderMockGetNodesParams contains parameters of the ClusterProvider.GetNodes
type ClusterProviderMockGetNodesParams struct {
	ctx context.Context
}

// ClusterProviderMockGetNodesParamPtrs contains pointers to parameters of the ClusterProvider.GetNodes
type ClusterProviderMockGetNodesParamPtrs struct {
	ctx *context.Context
}

// ClusterProviderMockGetNodesResults contains results of the ClusterProvider.GetNodes
type ClusterProviderMockGetNodesResults struct {
	na1 []domain.Node
	err error
}

// ClusterProviderMockGetNodesOrigins contains origins of expectations of the ClusterProvider.GetNodes
type ClusterProviderMockGetNodesExpectationOrigins struct {
	origin    string
	originCtx string
}
...
func (mmGetNodes *mClusterProviderMockGetNodes) Optional() *mClusterProviderMockGetNodes {
	mmGetNodes.optional = true
	return mmGetNodes
}

// Expect sets up expected params for ClusterProvider.GetNodes
func (mmGetNodes *mClusterProviderMockGetNodes) Expect(ctx context.Context) *mClusterProviderMockGetNodes {
	if mmGetNodes.mock.funcGetNodes != nil {
		mmGetNodes.mock.t.Fatalf("ClusterProviderMock.GetNodes mock is already set by Set")
	}

	if mmGetNodes.defaultExpectation == nil {
		mmGetNodes.defaultExpectation = &ClusterProviderMockGetNodesExpectation{}
	}

	if mmGetNodes.defaultExpectation.paramPtrs != nil {
		mmGetNodes.mock.t.Fatalf("ClusterProviderMock.GetNodes mock is already set by ExpectParams functions")
	}

	mmGetNodes.defaultExpectation.params = &ClusterProviderMockGetNodesParams{ctx}
	mmGetNodes.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
	for _, e := range mmGetNodes.expectations {
		if minimock.Equal(e.params, mmGetNodes.defaultExpectation.params) {
			mmGetNodes.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmGetNodes.defaultExpectation.params)
		}
	}
...
// ExpectCtxParam1 sets up expected param ctx for ClusterProvider.GetNodes
func (mmGetNodes *mClusterProviderMockGetNodes) ExpectCtxParam1(ctx context.Context) *mClusterProviderMockGetNodes {
	if mmGetNodes.mock.funcGetNodes != nil {
		mmGetNodes.mock.t.Fatalf("ClusterProviderMock.GetNodes mock is already set by Set")
	}
	...
	if mmGetNodes.defaultExpectation.params != nil {
		mmGetNodes.mock.t.Fatalf("ClusterProviderMock.GetNodes mock is already set by Expect")
	}

	if mmGetNodes.defaultExpectation.paramPtrs == nil {
		mmGetNodes.defaultExpectation.paramPtrs = &ClusterProviderMockGetNodesParamPtrs{}
	}
	mmGetNodes.defaultExpectation.paramPtrs.ctx = &ctx
	mmGetNodes.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)

	return mmGetNodes
}

// Inspect accepts an inspector function that has same arguments as the ClusterProvider.GetNodes
func (mmGetNodes *mClusterProviderMockGetNodes) Inspect(f func(ctx context.Context)) *mClusterProviderMockGetNodes {
	if mmGetNodes.mock.inspectFuncGetNodes != nil {
		mmGetNodes.mock.t.Fatalf("Inspect function is already set for ClusterProviderMock.GetNodes")
	}

	mmGetNodes.mock.inspectFuncGetNodes = f

	return mmGetNodes
}

// Return sets up results that will be returned by ClusterProvider.GetNodes
func (mmGetNodes *mClusterProviderMockGetNodes) Return(na1 []domain.Node, err error) *ClusterProviderMock {
	if mmGetNodes.mock.funcGetNodes != nil {
		mmGetNodes.mock.t.Fatalf("ClusterProviderMock.GetNodes mock is already set by Set")
	}

	if mmGetNodes.defaultExpectation == nil {
		mmGetNodes.defaultExpectation = &ClusterProviderMockGetNodesExpectation{mock: mmGetNodes.mock}
	}
	mmGetNodes.defaultExpectation.results = &ClusterProviderMockGetNodesResults{na1, err}
	mmGetNodes.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmGetNodes.mock
}

// Set uses given function f to mock the ClusterProvider.GetNodes method
func (mmGetNodes *mClusterProviderMockGetNodes) Set(f func(ctx context.Context) (na1 []domain.Node, err error)) *ClusterProviderMock {
	if mmGetNodes.defaultExpectation != nil {
		mmGetNodes.mock.t.Fatalf("Default expectation is already set for the ClusterProvider.GetNodes method")
	}

	if len(mmGetNodes.expectations) > 0 {
		mmGetNodes.mock.t.Fatalf("Some expectations are already set for the ClusterProvider.GetNodes method")
	}

	mmGetNodes.mock.funcGetNodes = f
	mmGetNodes.mock.funcGetNodesOrigin = minimock.CallerInfo(1)
	return mmGetNodes.mock
}

// When sets expectation for the ClusterProvider.GetNodes which will trigger the result defined by the following
// Then helper
func (mmGetNodes *mClusterProviderMockGetNodes) When(ctx context.Context) *ClusterProviderMockGetNodesExpectation {
	if mmGetNodes.mock.funcGetNodes != nil {
		mmGetNodes.mock.t.Fatalf("ClusterProviderMock.GetNodes mock is already set by Set")
	}

	expectation := &ClusterProviderMockGetNodesExpectation{
		mock:               mmGetNodes.mock,
		params:             &ClusterProviderMockGetNodesParams{ctx},
		expectationOrigins: ClusterProviderMockGetNodesExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	mmGetNodes.expectations = append(mmGetNodes.expectations, expectation)
	return expectation
}

// Then sets up ClusterProvider.GetNodes return parameters for the expectation previously defined by the When method
func (e *ClusterProviderMockGetNodesExpectation) Then(na1 []domain.Node, err error) *ClusterProviderMock {
	e.results = &ClusterProviderMockGetNodesResults{na1, err}
	return e.mock
}

// Times sets number of times ClusterProvider.GetNodes should be invoked
func (mmGetNodes *mClusterProviderMockGetNodes) Times(n uint64) *mClusterProviderMockGetNodes {
	if n == 0 {
		mmGetNodes.mock.t.Fatalf("Times of ClusterProviderMock.GetNodes mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmGetNodes.expectedInvocations, n)
	mmGetNodes.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGetNodes
}

func (mmGetNodes *mClusterProviderMockGetNodes) invocationsDone() bool {
	if len(mmGetNodes.expectations) == 0 && mmGetNodes.defaultExpectation == nil && mmGetNodes.mock.funcGetNodes == nil {
		return true
	}

	totalInvocations := mm_atomic.LoadUint64(&mmGetNodes.mock.afterGetNodesCounter)
	expectedInvocations := mm_atomic.LoadUint64(&mmGetNodes.expectedInvocations)

	return totalInvocations > 0 && (expectedInvocations == 0 || expectedInvocations == totalInvocations)
}

// GetNodes implements mm_ports.ClusterProvider
func (mmGetNodes *ClusterProviderMock) GetNodes(ctx context.Context) (na1 []domain.Node, err error) {
	mm_atomic.AddUint64(&mmGetNodes.beforeGetNodesCounter, 1)
	defer mm_atomic.AddUint64(&mmGetNodes.afterGetNodesCounter, 1)

	mmGetNodes.t.Helper()

	if mmGetNodes.inspectFuncGetNodes != nil {
		mmGetNodes.inspectFuncGetNodes(ctx)
	}

	mm_params := ClusterProviderMockGetNodesParams{ctx}

	// Record call args
	mmGetNodes.GetNodesMock.mutex.Lock()
	mmGetNodes.GetNodesMock.callArgs = append(mmGetNodes.GetNodesMock.callArgs, &mm_params)
	mmGetNodes.GetNodesMock.mutex.Unlock()

	for _, e := range mmGetNodes.GetNodesMock.expectations {
	...
	if mmGetNodes.GetNodesMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmGetNodes.GetNodesMock.defaultExpectation.Counter, 1)
		mm_want := mmGetNodes.GetNodesMock.defaultExpectation.params
		mm_want_ptrs := mmGetNodes.GetNodesMock.defaultExpectation.paramPtrs

		mm_got := ClusterProviderMockGetNodesParams{ctx}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGetNodes.t.Errorf("ClusterProviderMock.GetNodes got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetNodes.GetNodesMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetNodes.t.Errorf("ClusterProviderMock.GetNodes got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmGetNodes.GetNodesMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmGetNodes.GetNodesMock.defaultExpectation.results
		if mm_results == nil {
			mmGetNodes.t.Fatal("No results are set for the ClusterProviderMock.GetNodes")
		}
		return (*mm_results).na1, (*mm_results).err
	}
	if mmGetNodes.funcGetNodes != nil {
		return mmGetNodes.funcGetNodes(ctx)
	}
	mmGetNodes.t.Fatalf("Unexpected call to ClusterProviderMock.GetNodes. %v", ctx)
	return
}

// GetNodesAfterCounter returns a count of finished ClusterProviderMock.GetNodes invocations
func (mmGetNodes *ClusterProviderMock) GetNodesAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmGetNodes.afterGetNodesCounter)
}

// GetNodesBeforeCounter returns a count of ClusterProviderMock.GetNodes invocations
func (mmGetNodes *ClusterProviderMock) GetNodesBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmGetNodes.beforeGetNodesCounter)
}

// Calls returns a list of arguments used in each call to ClusterProviderMock.GetNodes.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmGetNodes *mClusterProviderMockGetNodes) Calls() []*ClusterProviderMockGetNodesParams {
	mmGetNodes.mutex.RLock()

	argCopy := make([]*ClusterProviderMockGetNodesParams, len(mmGetNodes.callArgs))
	copy(argCopy, mmGetNodes.callArgs)

	mmGetNodes.mutex.RUnlock()

	return argCopy
}

// MinimockGetNodesDone returns true if the count of the GetNodes invocations corresponds
// the number of defined expectations
func (m *ClusterProviderMock) MinimockGetNodesDone() bool {
	if m.GetNodesMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}

	for _, e := range m.GetNodesMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}

	return m.GetNodesMock.invocationsDone()
}

// MinimockGetNodesInspect logs each unmet expectation
func (m *ClusterProviderMock) MinimockGetNodesInspect() {
	for _, e := range m.GetNodesMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClusterProviderMock.GetNodes at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}

	afterGetNodesCounter := mm_atomic.LoadUint64(&m.afterGetNodesCounter)
	// if default expectation was set then invocations count should be greater than zero
	if m.GetNodesMock.defaultExpectation != nil && afterGetNodesCounter < 1 {
		if m.GetNodesMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ClusterProviderMock.GetNodes at\n%s", m.GetNodesMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ClusterProviderMock.GetNodes at\n%s with params: %#v", m.GetNodesMock.defaultExpectation.expectationOrigins.origin, *m.GetNodesMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetNodes != nil && afterGetNodesCounter < 1 {
		m.t.Errorf("Expected call to ClusterProviderMock.GetNodes at\n%s", m.funcGetNodesOrigin)
	}

	if !m.GetNodesMock.invocationsDone() && afterGetNodesCounter > 0 {
		m.t.Errorf("Expected %d calls to ClusterProviderMock.GetNodes at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.GetNodesMock.expectedInvocations), m.GetNodesMock.expectedInvocationsOrigin, afterGetNodesCounter)
	}
}
...
// IsAvailable implements mm_ports.ClusterProvider
...
// IsMaintenanceMode implements mm_ports.ClusterProvider
...
// RemoveNodeLabel implements mm_ports.ClusterProvider
...
// SetNodeLabel implements mm_ports.ClusterProvider
