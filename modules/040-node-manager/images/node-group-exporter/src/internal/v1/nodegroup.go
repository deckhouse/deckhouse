...
// Windows represents update windows
type Windows []Window

// Window represents a single update window
type Window struct {
...
// NodeTemplate represents default labels, annotations and taints for Nodes in NodeGroup
