...
const (
	apiserverCertificateSecretName = "permission-browser-apiserver"
)
...
var _ = tls_certificate.RegisterInternalTLSHook(tls_certificate.GenSelfSignedTLSHookConf{
	...
	SANs: tls_certificate.DefaultSANs([]string{
		...
		"permission-browser-apiserver.d8-user-authz",
		"permission-browser-apiserver.d8-user-authz.svc",
	}),
	CN: "permission-browser-apiserver",

	Namespace:            internal.Namespace,
	TLSSecretName:        apiserverCertificateSecretName,
	FullValuesPathPrefix: "userAuthz.internal.apiserverCertificate",
})
