...
Если требуется добавить прав для определенной [высокоуровневой роли](./#список-доступа-для-каждой-роли-модуля-по-умолчанию), достаточно создать ClusterRole с аннотацией `user-authz.deckhouse.io/access-level: <AccessLevel>`.
