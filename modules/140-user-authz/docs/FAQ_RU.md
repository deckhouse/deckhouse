...
Чтобы ограничить права пользователя конкретными неймспейсами в основной ролевой модели, используйте в RoleBinding [namespace-роль](./#namespace-роли) с соответствующим уровнем доступа. [Пример](usage.html#пример-назначения-административных-прав-пользователю-в-рамках-неймспейса).
...
```yaml
# Платформа: конфигурация модулей DKP, cluster-wide-ресурсы, системные неймспейсы.
