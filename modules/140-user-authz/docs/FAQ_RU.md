...
- `D8UserAuthzWebhookTargetDown` — какой-либо экземпляр не скрейпится 5 минут (именно любой, а не все сразу: на нескольких мастерах один замолчавший экземпляр и есть тот случай, о котором нужно знать);
