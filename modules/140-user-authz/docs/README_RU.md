...
- Область действия ролей из других подсистем — неймспейсы, в которой работают модули подсистемы (см. таблицу состава подсистем), а также все cluster-wide-объекты модулей подсистемы.
