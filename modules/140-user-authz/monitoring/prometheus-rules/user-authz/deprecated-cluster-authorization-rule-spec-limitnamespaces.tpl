- name: kubernetes.user-authz.deprecated-spec
  ...
  - alert: UserAuthzDeprecatedCARSpecLimitNamespaces
    ...
    annotations:
      description: |-
        There is a cluster authorization rule with [deprecated]({{ include "helm_lib_module_uri_scheme" . }}://{{ include "helm_lib_module_public_domain" (list . "deckhouse") }}/modules/140-user-authz/#implementation-nuances) '.spec.limitNamespaces' parameter.
