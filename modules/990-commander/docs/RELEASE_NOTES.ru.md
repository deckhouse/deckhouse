...
* В предустановленный шаблон `DKP on Deckhouse Virtualization Platform` добавлена отсутствующая конфигурация Реестра контейнеров, из-за чего была невозможна установка кластеров из этого шаблона.

### Прочее

* Исправлены обнаруженные уязвимости в компонентах модуля.
* Предустановленный шаблон `Deckhouse Virtualization Platform` переименован в `DKP on Deckhouse Virtualization Platform` (создание кластеров DKP в DVP).
...
* Добавлен новый предустановленный шаблон для DVP (создание кластеров DKP в DVP).
...
* Обновлен интерфейс DKP UI до версии 1.37.4 на вкладке «Администрирование» кластера.
