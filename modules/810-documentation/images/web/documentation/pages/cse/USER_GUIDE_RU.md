...
![Окно аутентификации веб-интерфейса Grafana](images/user-guide/image147.png)
...
![Главный экран Grafana с информацией о кластере](images/user-guide/image149.png)
...
![Левая верхняя часть главного экрана с версиями компонентов](images/user-guide/image148.png)
...
![Правая верхняя часть главного экрана с метриками кластера](images/user-guide/image151.png)
...
![Примеры всплывающих подсказок для метрик](images/user-guide/image150.png) ![Всплывающая подсказка с информацией о ресурсах](images/user-guide/image153.png) ![Всплывающая подсказка с дополнительной информацией](images/user-guide/image152.png)
...
![Ссылки на дашборды компонентов кластера](images/user-guide/image155.png)
...
![Ссылки на веб-интерфейсы и информация об обновлении кластера](images/user-guide/image154.png)
...
![Боковое меню Grafana с ссылками на элементы](images/user-guide/image158.png)
...
![Список доступных дашбордов сгруппированных по категориям](images/user-guide/image156.png)
...
![Пример дашборда с таблицами и графиками](images/user-guide/image157.png)
...
![Блок фильтров для настройки отображения данных](images/user-guide/image159.png)
...
![Применение фильтров для выбора узла кластера](images/user-guide/image160.png)
...
![Отображение информации после применения фильтров](images/user-guide/image161.png)
...
![Вывод графика в полный размер](images/user-guide/image162.png)

Рисунок 14 – Вывод графика

Выбранный график откроется на весь экран.

![Пример развёрнутого графика во весь экран](images/user-guide/image163.png)
...
![Сводная информация по модулю kube-state-metrics](images/user-guide/image164.png)
...
![Дашборд Network Policies](images/user-guide/image165.png)
...
![Дашборд Nodes](images/user-guide/image166.png)
...
![Дашборд Ingress Nginx Controllers List](images/user-guide/image137.png)
...
![Дашборд Loki Logs](images/user-guide/image138.png)
...
![Состояние модуля loki](images/user-guide/image139.png)
...
![Логи модуля loki](images/user-guide/image140.png)
...
![Дашборд Namespace Detail](images/user-guide/image141.png)
...
![Детализация компонентов в пространстве имен](images/user-guide/image142.png)
...
![Дашборд Namespaces с метриками Ingress](images/user-guide/image143.png)

Рисунок 25 – Дашборд «Namespaces»

В фильтрах можно выбрать конкретное пространство имен, виртуальные хосты и тип контента.

![Фильтры для дашборда Namespaces](images/user-guide/image144.png)
...
![Дашборд VHost Detail](images/user-guide/image145.png)
...
![Дашборд VHost](images/user-guide/image146.png)
...
![Дашборд aggregating-proxy cache](images/user-guide/image11.png)
...
![Дашборд Cilium Metrics](images/user-guide/image12.png)
...
![Дашборд Control Plane Status](images/user-guide/image13.png)
...
![Дашборд Deprecated APIs](images/user-guide/image14.png)
...
![Дашборд DNS (coredns)](images/user-guide/image15.png)
...
![Дашборд etcd3](images/user-guide/image16.png)
...
![Дашборд External ping](images/user-guide/image17.png)
...
![Дашборд Ingress Nginx Controller Detail](images/user-guide/image18.png)
...
![Дашборд Ingress Nginx Controllers](images/user-guide/image20.png)
...
![Дашборд Node](images/user-guide/image21.png)
...
![Окно редактирования ресурса](images/user-guide/image1.png)
...
![Подтверждение операции](images/user-guide/image2.png)
...
![Элемент интерфейса](images/user-guide/image3.png)
...
![Элемент интерфейса](images/user-guide/image4.png)
...
![Элемент интерфейса](images/user-guide/image5.png)
...
![Элемент интерфейса](images/user-guide/image6.png)
...
![Элемент интерфейса](images/user-guide/image7.png)
...
![Элемент интерфейса](images/user-guide/image8.png)
...
![Элемент интерфейса](images/user-guide/image9.png)
...
![Элемент интерфейса](images/user-guide/image10.png)
...
![Элемент интерфейса](images/user-guide/image43.png)
...
![Элемент интерфейса](images/user-guide/image44.png)
...
![Элемент интерфейса](images/user-guide/image45.png)
...
![Элемент интерфейса](images/user-guide/image46.png)
...
![Элемент интерфейса](images/user-guide/image47.png)
...
![Элемент интерфейса](images/user-guide/image48.png)
...
![Элемент интерфейса](images/user-guide/image49.png)

Рисунок 55 – Категории алертов

В раскрывшемся блоке будут отображаться все алерты группы.

![Элемент интерфейса](images/user-guide/image50.png)
...
![Элемент интерфейса](images/user-guide/image51.png)
...
![Элемент интерфейса](images/user-guide/image52.png)
...
![Элемент интерфейса](images/user-guide/image42.png)
...
![Элемент интерфейса](images/user-guide/image25.png)
...
![Элемент интерфейса](images/user-guide/image27.png)
...
![Элемент интерфейса](images/user-guide/image29.png)
...
![Элемент интерфейса](images/user-guide/image31.png)
...
![Элемент интерфейса](images/user-guide/image33.png)
...
![Элемент интерфейса](images/user-guide/image35.png)
...
![Элемент интерфейса](images/user-guide/image37.png)
...
![Элемент интерфейса](images/user-guide/image39.png)
...
![Элемент интерфейса](images/user-guide/image40.png)
...
![Дашборд Persistent Volumes](images/user-guide/image22.png)
...
![Элемент интерфейса](images/user-guide/image23.png)
...
![Элемент интерфейса](images/user-guide/image80.png)
...
![Элемент интерфейса](images/user-guide/image82.png)
...
![Элемент интерфейса](images/user-guide/image84.png)
...
![Элемент интерфейса](images/user-guide/image86.png)
...
![Элемент интерфейса](images/user-guide/image88.png)
...
![Элемент интерфейса](images/user-guide/image90.png)
...
![Элемент интерфейса](images/user-guide/image92.png)
...
![Элемент интерфейса](images/user-guide/image94.png)
...
![Элемент интерфейса](images/user-guide/image76.png)
...
![Элемент интерфейса](images/user-guide/image77.png)
...
![Элемент интерфейса](images/user-guide/image78.png)
...
![Элемент интерфейса](images/user-guide/image61.png)
...
![Элемент интерфейса](images/user-guide/image63.png)
...
![Элемент интерфейса](images/user-guide/image65.png)
...
![Элемент интерфейса](images/user-guide/image67.png)
...
![Элемент интерфейса](images/user-guide/image69.png)
...
![Элемент интерфейса](images/user-guide/image70.png)
...
![Элемент интерфейса](images/user-guide/image72.png)
...
![Элемент интерфейса](images/user-guide/image54.png)
...
![Элемент интерфейса](images/user-guide/image56.png)
...
![Элемент интерфейса](images/user-guide/image57.png)
...
![Элемент интерфейса](images/user-guide/image59.png)
...
![Элемент интерфейса](images/user-guide/image112.png)
...
![Элемент интерфейса](images/user-guide/image114.png)
...
![Элемент интерфейса](images/user-guide/image116.png)
...
![Элемент интерфейса](images/user-guide/image118.png)
...
![Элемент интерфейса](images/user-guide/image119.png)
...
![Элемент интерфейса](images/user-guide/image120.png)
...
![Элемент интерфейса](images/user-guide/image131.png)
...
![Элемент интерфейса](images/user-guide/image130.png)
...
![Элемент интерфейса](images/user-guide/image133.png)
...
![Элемент интерфейса](images/user-guide/image132.png)
...
![Элемент интерфейса](images/user-guide/image127.png)
...
![Элемент интерфейса](images/user-guide/image126.png)
...
![Элемент интерфейса](images/user-guide/image129.png)
...
![Элемент интерфейса](images/user-guide/image128.png)
...
![Элемент интерфейса](images/user-guide/image125.png)
...
![Элемент интерфейса](images/user-guide/image124.png)
...
![Элемент интерфейса](images/user-guide/image105.png)
...
![Элемент интерфейса](images/user-guide/image102.png)
...
![Элемент интерфейса](images/user-guide/image101.png)
...
![Элемент интерфейса](images/user-guide/image104.png)
...
![Элемент интерфейса](images/user-guide/image103.png)
...
![Элемент интерфейса](images/user-guide/image98.png)
...
![Элемент интерфейса](images/user-guide/image97.png)
...
![Элемент интерфейса](images/user-guide/image100.png)
...
![Элемент интерфейса](images/user-guide/image99.png)
...
![Элемент интерфейса](images/user-guide/image96.png)
...
![Элемент интерфейса](images/user-guide/image122.png)
...
![Элемент интерфейса](images/user-guide/image121.png)
...
![Элемент интерфейса](images/user-guide/image113.png)
...
![Элемент интерфейса](images/user-guide/image111.png)
...
![Элемент интерфейса](images/user-guide/image117.png)
...
![Элемент интерфейса](images/user-guide/image115.png)
...
![Элемент интерфейса](images/user-guide/image107.png)
...
![Элемент интерфейса](images/user-guide/image106.png)
...
![Элемент интерфейса](images/user-guide/image110.png)
...
![Элемент интерфейса](images/user-guide/image109.png)
...
![Элемент интерфейса](images/user-guide/image68.png)
...
![Элемент интерфейса](images/user-guide/image73.png)
...
![Элемент интерфейса](images/user-guide/image71.png)
...
![Элемент интерфейса](images/user-guide/image62.png)
...
![Элемент интерфейса](images/user-guide/image60.png)
...
![Элемент интерфейса](images/user-guide/image66.png)
...
![Элемент интерфейса](images/user-guide/image64.png)
...
![Элемент интерфейса](images/user-guide/image55.png)
...
![Элемент интерфейса](images/user-guide/image53.png)
...
![Элемент интерфейса](images/user-guide/image58.png)
...
![Элемент интерфейса](images/user-guide/image89.png)
...
![Элемент интерфейса](images/user-guide/image87.png)
...
![Элемент интерфейса](images/user-guide/image93.png)
...
![Элемент интерфейса](images/user-guide/image91.png)
...
![Элемент интерфейса](images/user-guide/image81.png)
...
![Элемент интерфейса](images/user-guide/image79.png)
...
![Элемент интерфейса](images/user-guide/image85.png)
...
![Элемент интерфейса](images/user-guide/image83.png)
...
![Элемент интерфейса](images/user-guide/image75.png)
...
![Элемент интерфейса](images/user-guide/image74.png)
...
![Элемент интерфейса](images/user-guide/image41.png)
...
![Элемент интерфейса](images/user-guide/image36.png)
...
![Элемент интерфейса](images/user-guide/image26.png)
...
![Элемент интерфейса](images/user-guide/image24.png)
...
![Элемент интерфейса](images/user-guide/image30.png)
...
![Элемент интерфейса](images/user-guide/image28.png)
...
![Элемент интерфейса](images/user-guide/image136.png)
...
![Элемент интерфейса](images/user-guide/image134.png)
...
![Элемент интерфейса](images/user-guide/image95.png)
...
![Элемент интерфейса](images/user-guide/image123.png)
...
![Элемент интерфейса](images/user-guide/image135.png)
...
![Элемент интерфейса](images/user-guide/image108.png)
...
| 6 | Регистрация событий безопасности в средстве контейнеризации | Kubernetes+Virtualization; Kubernetes |
| 7 | Управление доступом в средстве контейнеризации | Kubernetes+Virtualization; Kubernetes |
...
| 10 | Регистрация событий безопасности в средстве виртуализации | Kubernetes+Virtualization; Virtualization |
| 11 | Управление доступом в средстве виртуализации | Kubernetes+Virtualization; Virtualization |
| 12 | Резервное копирование виртуальных машин | Kubernetes+Virtualization; Virtualization |
| 13 | Управление потоками информации в средстве виртуализации | Kubernetes+Virtualization; Virtualization |
