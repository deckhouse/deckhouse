...
1. Find out in which cloud network the Deckhouse Kubernetes Platform cluster is running.
   ...
   The network name matches the `prefix` field of the [ClusterConfiguration](https://deckhouse.io/products/kubernetes-platform/documentation/v1/reference/api/cr.html#clusterconfiguration) resource. It can be retrieved using the following command:
