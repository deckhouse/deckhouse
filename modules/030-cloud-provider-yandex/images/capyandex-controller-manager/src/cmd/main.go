...
import (
	...
	"cluster-api-provider-yandex/internal/controller"
...
func main() {
	...
	ycClient, err := yc.NewClient(ctx, os.Getenv("YC_SA_KEY_JSON"))
	if err != nil {
		setupLog.Error(err, "unable to initialize YC client")
		os.Exit(1)
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c3fab72a.cluster.x-k8s.io",
	})
	if err != nil {
	...
	if err = (&controller.YandexClusterReconciler{
	...
	if err = (&controller.YandexMachineReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
		YC:     ycClient,
	}).SetupWithManager(mgr); err != nil {
