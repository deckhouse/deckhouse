module cloud-provider-yandex-validation-webhook
...
require (
	...
	github.com/deckhouse/deckhouse/pkg/log v0.0.0-00010101000000-000000000000 // indirect
...
replace (
	...
	github.com/deckhouse/deckhouse/modules/030-cloud-provider-yandex/pkg => /deckhouse/modules/030-cloud-provider-yandex/pkg
