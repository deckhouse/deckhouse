...
func NewCredentialSecretValidator(factory *ycval.AdmissionStateBuilderFactory, object runtime.Object) *CredentialSecretValidator {
...
func validateCredentialSecretTypeChange(oldObj, newObj runtime.Object) error {
	...
	if objectNamespace(oldSecret) != ycmeta.Namespace {
		return nil
	}
