...
func (v *YandexInstanceClassValidator) validate(
	...
	var deletedClass *ycicv1.YandexInstanceClass
	if operation == admissionv1.Delete {
		deletedClass, err = cpadmission.DecodeInstanceClassObject[*ycicv1.YandexInstanceClass](obj)
		if err != nil {
	...
	result := ycadmission.ValidateInstanceClass(state, operation, deletedClass)
