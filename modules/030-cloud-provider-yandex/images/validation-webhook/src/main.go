...
import (
	...
	"cloud-provider-yandex-validation-webhook/webhooks"
)
...
func main() {
	...
	rootCmd := &cobra.Command{
		...
		Short: "Admission webhook for cloud-provider-yandex",
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			utilruntime.Must(cpwebhook.RegisterUnstructuredGVKs(
				...
				nodeGroupGVK,
				moduleConfigGVK,
				ycicv1.GroupVersionKind,
				ycicv1alpha1.GroupVersionKind,
			))
			...
			factory := ycval.NewAdmissionStateBuilderFactory(
				server.Client(),
