...
const (
	migrationPendingMetricName  = "d8_cloud_provider_yandexcloud_migration_pending"
	migrationPendingMetricGroup = "D8CloudProviderYandexCloudMigration"
)

var _ = Describe("Modules :: cloud-provider-yandex :: hooks :: migration_pending_metric ::", func() {
	const (
		migrationMarkerCM = `
---
apiVersion: v1
