...
// TO DO: Don't migrate this hook to control-plane-manager, it already has 'internal.hasEtcdArbiterNode'.
...
var _ = sdk.RegisterFunc(&go_hook.HookConfig{
	Queue:        "/modules/monitoring-kubernetes-control-plane",
...
func handleCheckEtcdArbiterNode(_ context.Context, input *go_hook.HookInput) error {
	...
	input.Values.Set("monitoringKubernetesControlPlane.internal.hasEtcdArbiterNode", len(etcdArbiterNodes) == 1)
