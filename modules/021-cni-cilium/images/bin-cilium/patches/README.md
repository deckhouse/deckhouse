...
Add the opportunity to request a specific IP-address using annotation:

    cni.cilium.io/ipAddress: 10.10.10.10

or, with higher priority, a pre-provisioned `IPAddress` custom resource from module sdn via:

    network.deckhouse.io/networks-spec: '[{"type":"Main","ipAddressName":"my-ip"}]'
