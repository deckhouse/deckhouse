...
var _ = Describe("Module :: cloud-provider-vsphere :: helm template ::", func() {
	...
	Context("Vsphere", func() {
		...
		It("Everything must render properly", func() {
			...
			userAuthzUser := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-vsphere:user-authz:user")
			userAuthzClusterAdmin := f.KubernetesGlobalResource("ClusterRole", "d8-cloud-provider-vsphere:user-authz:cluster-admin")
