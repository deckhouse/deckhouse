...
Подсистема хранения по умолчанию использует CNS диски с возможностью изменения их размера на-лету. Но так же поддерживается работа и в legacy режиме, с использованием FCD дисков.
