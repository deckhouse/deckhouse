...
export LD_LIBRARY_PATH=/usr/lib64:/usr/local/lib:/usr/local/lib64:/usr/lib64/gcc/x86_64-alt-linux/11
...
sed -i 's|-lstdc++||g' CMakeFiles/jaegertracing_plugin.dir/link.txt

echo "Running make with full verbose output..."
make
make install
