...
Для этого примера [конфигурация модуля `metallb`](/modules/metallb/configuration.html) должна быть следующей:
...
{% alert level="warning" %}Доступно в следующих редакциях: SE, SE+, EE, CSE Lite, CSE Pro.{% endalert %}
