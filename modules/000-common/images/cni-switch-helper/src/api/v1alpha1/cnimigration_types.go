...
type CNIMigrationSpec struct {
	...
	// +kubebuilder:validation:Enum=Cilium;Flannel;Simple-bridge
	...
	// +kubebuilder:validation:Required
	// +kubebuilder:validation:Enum=Prepare;Migrate;Cleanup;Abort
...
//+kubebuilder:resource:path=cnimigrations,scope=Cluster
