...
- **Собирают метрики Deckhouse** — модуль скрейпит метрики из пода Deckhouse с использованием PodMonitor ресурсов, включая:
...
- **Определяют правила оповещений** — модуль предоставляет комплексные правила оповещений Prometheus, организованные по категориям:
  ...
  - **Неисправности Deckhouse** — обнаружение чрезмерных перезапусков, проблем доступа к container registry, зависших процессов.
