...
This module is a critical observability component that works in conjunction with the [`prometheus`](/modules/prometheus/) module to provide insights into DKP operational state.
