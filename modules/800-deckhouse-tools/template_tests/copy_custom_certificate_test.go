...
var _ = Describe("Module :: deckhouse-tools :: helm template :: custom-certificate", func() {
	f := SetupHelmConfig(``)

	Context("Default", func() {
		BeforeEach(func() {
			f.ValuesSetFromYaml("global", globalValues)
			f.ValuesSetFromYaml("deckhouseTools", customCertificatePresent)
			f.HelmRender()
		})
