...
const (
	webhookHandlerCertPath = "imageDigestCheck.internal.webhookCert.crt"
	webhookHandlerKeyPath  = "imageDigestCheck.internal.webhookCert.key"
	webhookHandlerCAPath   = "imageDigestCheck.internal.webhookCert.ca"
...
var _ = Describe("ImageDigestCheck hooks :: generate self-signed CA :: ", func() {
