...
Для того чтобы задать мастер-пароль, создайте секрет в неймспейсе `d8-system`:
...
> **Внимание**: подойдите ответсвенно к выбору мастер-пароля для LINSTOR. При его потере зашифрованные данные окажутся недоступными
