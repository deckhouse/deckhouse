...
type RegistryStorageStatus struct {
	...
	// +optional
	SafeToDropUpstream bool `json:"safeToDropUpstream,omitempty"`

	// AllReplicasFull means every replica holds the expected set, so losing the
	// leader costs nothing.
	// +optional
	AllReplicasFull bool `json:"allReplicasFull,omitempty"`
...
type FillProgress struct {
	...
	// +optional
	Filled int32 `json:"filled,omitempty"`

	// Total is the number of digests expected.
	// +optional
