...
type certTreeScheme = map[RootCertBaseName][]LeafCertBaseName
...
type certSpecTree map[RootCertBaseName]rootCertSpec
...
func createLeafCertIfNotExists(cfg config, spec certSpec[LeafCertBaseName], caCert *x509.Certificate, caKey crypto.Signer, rep *PKIApplyReport) error {
